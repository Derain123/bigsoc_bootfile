...
module TageBranchPredictorBank(
  ...
  MaxPeriodFibonacciLFSR_3 alloc_lfsr_prng (	// @[PRNG.scala:91:22]
    .clock    (clock),
    .reset    (reset),
  ...
  MaxPeriodFibonacciLFSR_3 alloc_lfsr_prng_1 (	// @[PRNG.scala:91:22]
    .clock    (clock),
    .reset    (reset),
  ...
  MaxPeriodFibonacciLFSR_3 alloc_lfsr_prng_2 (	// @[PRNG.scala:91:22]
    .clock    (clock),
    .reset    (reset),
  ...
  MaxPeriodFibonacciLFSR_3 alloc_lfsr_prng_3 (	// @[PRNG.scala:91:22]
    .clock    (clock),
    .reset    (reset),
