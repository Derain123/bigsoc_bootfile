...
module Queue_11(
  ...
  wire [104:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[31:18];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[39:32];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[103:40];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[104];	// @[Decoupled.scala:273:95]
endmodule
