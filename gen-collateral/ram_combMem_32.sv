...
module ram_combMem_32(	// @[Decoupled.scala:273:95]
  input          R0_addr,
                 ...
                 W0_clk,
  input  [174:0] W0_data,
  output [174:0] R0_data
);

  reg [174:0] Memory[0:1];	// @[Decoupled.scala:273:95]
    ...
    initial begin	// @[Decoupled.scala:273:95]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[Decoupled.scala:273:95]
        for (initvar = 0; initvar < 2; initvar = initvar + 1) begin
          ...
          Memory[initvar] = _RANDOM_MEM[174:0];
        end	// @[Decoupled.scala:273:95]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // not def SYNTHESIS
  assign R0_data = R0_en ? Memory[R0_addr] : 175'bx;	// @[Decoupled.scala:273:95]
endmodule
