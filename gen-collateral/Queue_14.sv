...
module Queue_14(
  ...
  wire [85:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[18:7];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_sink = _ram_ext_R0_data[19];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[20];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[84:21];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[85];	// @[Decoupled.scala:273:95]
endmodule
