...
module TilePRCIDomain(
  ...
  input  [3:0]   auto_tile_reset_domain_boom_tile_hartid_in,
  ...
  wire [15:0]  _buffer_auto_in_b_bits_mask;	// @[Buffer.scala:69:28]
  ...
  wire [3:0]   _buffer_auto_in_d_bits_sink;	// @[Buffer.scala:69:28]
  ...
  wire         _tile_reset_domain_boom_tile_auto_buffer_out_a_valid;	// @[HasTiles.scala:251:53]
  wire [2:0]   _tile_reset_domain_boom_tile_auto_buffer_out_a_bits_opcode;	// @[HasTiles.scala:251:53]
  wire [2:0]   _tile_reset_domain_boom_tile_auto_buffer_out_a_bits_param;	// @[HasTiles.scala:251:53]
  wire [3:0]   _tile_reset_domain_boom_tile_auto_buffer_out_a_bits_size;	// @[HasTiles.scala:251:53]
  wire [3:0]   _tile_reset_domain_boom_tile_auto_buffer_out_a_bits_source;	// @[HasTiles.scala:251:53]
  wire [31:0]  _tile_reset_domain_boom_tile_auto_buffer_out_a_bits_address;	// @[HasTiles.scala:251:53]
  wire [15:0]  _tile_reset_domain_boom_tile_auto_buffer_out_a_bits_mask;	// @[HasTiles.scala:251:53]
  wire [127:0] _tile_reset_domain_boom_tile_auto_buffer_out_a_bits_data;	// @[HasTiles.scala:251:53]
  wire         _tile_reset_domain_boom_tile_auto_buffer_out_a_bits_corrupt;	// @[HasTiles.scala:251:53]
  wire         _tile_reset_domain_boom_tile_auto_buffer_out_b_ready;	// @[HasTiles.scala:251:53]
  wire         _tile_reset_domain_boom_tile_auto_buffer_out_c_valid;	// @[HasTiles.scala:251:53]
  wire [2:0]   _tile_reset_domain_boom_tile_auto_buffer_out_c_bits_opcode;	// @[HasTiles.scala:251:53]
  wire [2:0]   _tile_reset_domain_boom_tile_auto_buffer_out_c_bits_param;	// @[HasTiles.scala:251:53]
  wire [3:0]   _tile_reset_domain_boom_tile_auto_buffer_out_c_bits_size;	// @[HasTiles.scala:251:53]
  wire [3:0]   _tile_reset_domain_boom_tile_auto_buffer_out_c_bits_source;	// @[HasTiles.scala:251:53]
  wire [31:0]  _tile_reset_domain_boom_tile_auto_buffer_out_c_bits_address;	// @[HasTiles.scala:251:53]
  wire [127:0] _tile_reset_domain_boom_tile_auto_buffer_out_c_bits_data;	// @[HasTiles.scala:251:53]
  wire         _tile_reset_domain_boom_tile_auto_buffer_out_c_bits_corrupt;	// @[HasTiles.scala:251:53]
  wire         _tile_reset_domain_boom_tile_auto_buffer_out_d_ready;	// @[HasTiles.scala:251:53]
  wire         _tile_reset_domain_boom_tile_auto_buffer_out_e_valid;	// @[HasTiles.scala:251:53]
  wire [3:0]   _tile_reset_domain_boom_tile_auto_buffer_out_e_bits_sink;	// @[HasTiles.scala:251:53]
  BoomTile tile_reset_domain_boom_tile (	// @[HasTiles.scala:251:53]
    ...
    .auto_buffer_out_a_bits_corrupt (_tile_reset_domain_boom_tile_auto_buffer_out_a_bits_corrupt),
    ...
    .auto_buffer_out_c_bits_corrupt (_tile_reset_domain_boom_tile_auto_buffer_out_c_bits_corrupt),
  ...
  TLBuffer_15 buffer (	// @[Buffer.scala:69:28]
    .clock                   (auto_tap_clock_in_clock),
    .reset                   (auto_tap_clock_in_reset),
    .auto_in_a_valid         (_tile_reset_domain_boom_tile_auto_buffer_out_a_valid),	// @[HasTiles.scala:251:53]
    .auto_in_a_bits_opcode   (_tile_reset_domain_boom_tile_auto_buffer_out_a_bits_opcode),	// @[HasTiles.scala:251:53]
    .auto_in_a_bits_param    (_tile_reset_domain_boom_tile_auto_buffer_out_a_bits_param),	// @[HasTiles.scala:251:53]
    .auto_in_a_bits_size     (_tile_reset_domain_boom_tile_auto_buffer_out_a_bits_size),	// @[HasTiles.scala:251:53]
    .auto_in_a_bits_source   (_tile_reset_domain_boom_tile_auto_buffer_out_a_bits_source),	// @[HasTiles.scala:251:53]
    .auto_in_a_bits_address  (_tile_reset_domain_boom_tile_auto_buffer_out_a_bits_address),	// @[HasTiles.scala:251:53]
    .auto_in_a_bits_mask     (_tile_reset_domain_boom_tile_auto_buffer_out_a_bits_mask),	// @[HasTiles.scala:251:53]
    .auto_in_a_bits_data     (_tile_reset_domain_boom_tile_auto_buffer_out_a_bits_data),	// @[HasTiles.scala:251:53]
    .auto_in_a_bits_corrupt  (_tile_reset_domain_boom_tile_auto_buffer_out_a_bits_corrupt),	// @[HasTiles.scala:251:53]
    .auto_in_b_ready         (_tile_reset_domain_boom_tile_auto_buffer_out_b_ready),	// @[HasTiles.scala:251:53]
    .auto_in_c_valid         (_tile_reset_domain_boom_tile_auto_buffer_out_c_valid),	// @[HasTiles.scala:251:53]
    .auto_in_c_bits_opcode   (_tile_reset_domain_boom_tile_auto_buffer_out_c_bits_opcode),	// @[HasTiles.scala:251:53]
    .auto_in_c_bits_param    (_tile_reset_domain_boom_tile_auto_buffer_out_c_bits_param),	// @[HasTiles.scala:251:53]
    .auto_in_c_bits_size     (_tile_reset_domain_boom_tile_auto_buffer_out_c_bits_size),	// @[HasTiles.scala:251:53]
    .auto_in_c_bits_source   (_tile_reset_domain_boom_tile_auto_buffer_out_c_bits_source),	// @[HasTiles.scala:251:53]
    .auto_in_c_bits_address  (_tile_reset_domain_boom_tile_auto_buffer_out_c_bits_address),	// @[HasTiles.scala:251:53]
    .auto_in_c_bits_data     (_tile_reset_domain_boom_tile_auto_buffer_out_c_bits_data),	// @[HasTiles.scala:251:53]
    .auto_in_c_bits_corrupt  (_tile_reset_domain_boom_tile_auto_buffer_out_c_bits_corrupt),	// @[HasTiles.scala:251:53]
    .auto_in_d_ready         (_tile_reset_domain_boom_tile_auto_buffer_out_d_ready),	// @[HasTiles.scala:251:53]
    .auto_in_e_valid         (_tile_reset_domain_boom_tile_auto_buffer_out_e_valid),	// @[HasTiles.scala:251:53]
    .auto_in_e_bits_sink     (_tile_reset_domain_boom_tile_auto_buffer_out_e_bits_sink),	// @[HasTiles.scala:251:53]
