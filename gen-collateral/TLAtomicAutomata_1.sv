...
module TLAtomicAutomata_1(
  ...
  reg  [7:0]      cam_a_0_bits_source;	// @[AtomicAutomata.scala:79:24]
  ...
  wire            a_isSupported = auto_in_a_bits_opcode == 3'h3 ? _a_canArithmetic_T_3 & (_GEN == 7'h0 | _GEN_0 == 7'h0 | _GEN_2 == 7'h0) : auto_in_a_bits_opcode != 3'h2 | _a_canArithmetic_T_3 & (_GEN == 7'h0 | _GEN_0 == 7'h0 | _GEN_2 == 7'h0);	// @[AtomicAutomata.scala:92:47, :93:47, :94:{32,63}, Mux.scala:81:61, Parameters.scala:92:42, :137:{45,65}, :671:54, :672:42]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cam_a_0_bits_source = _RANDOM_0[19:12];	// @[AtomicAutomata.scala:78:28, :79:24]
        cam_a_0_bits_address = {_RANDOM_0[31:20], _RANDOM_1[18:0]};	// @[AtomicAutomata.scala:78:28, :79:24]
        cam_a_0_bits_mask = _RANDOM_1[26:19];	// @[AtomicAutomata.scala:79:24]
        cam_a_0_bits_data = {_RANDOM_1[31:27], _RANDOM_2, _RANDOM_3[26:0]};	// @[AtomicAutomata.scala:79:24]
        cam_a_0_bits_corrupt = _RANDOM_3[27];	// @[AtomicAutomata.scala:79:24]
        cam_a_0_fifoId = _RANDOM_3[28];	// @[AtomicAutomata.scala:79:24]
        cam_a_0_lut = {_RANDOM_3[31:29], _RANDOM_4[0]};	// @[AtomicAutomata.scala:79:24]
        cam_d_0_data = {_RANDOM_4[31:1], _RANDOM_5, _RANDOM_6[0]};	// @[AtomicAutomata.scala:79:24, :80:24]
        cam_d_0_denied = _RANDOM_6[1];	// @[AtomicAutomata.scala:80:24]
        cam_d_0_corrupt = _RANDOM_6[2];	// @[AtomicAutomata.scala:80:24]
        beatsLeft = _RANDOM_6[11:3];	// @[Arbiter.scala:88:30, AtomicAutomata.scala:80:24]
        state_0 = _RANDOM_6[12];	// @[Arbiter.scala:117:26, AtomicAutomata.scala:80:24]
        state_1 = _RANDOM_6[13];	// @[Arbiter.scala:117:26, AtomicAutomata.scala:80:24]
        d_first_counter = _RANDOM_6[22:14];	// @[AtomicAutomata.scala:80:24, Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_out_a_bits_source = (muxStateEarly_0 ? cam_a_0_bits_source : 8'h0) | (muxStateEarly_1 ? auto_in_a_bits_source : 8'h0);	// @[Arbiter.scala:118:30, AtomicAutomata.scala:79:24, Bitwise.scala:77:12, Mux.scala:27:73]
