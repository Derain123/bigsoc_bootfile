...
module TLMonitor_104(
  ...
  wire [32782:0] _GEN = {32769'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:677:76, OneHot.scala:64:12]
  wire [4095:0]  _d_clr_T = 4096'h1 << io_in_d_bits_source;	// @[OneHot.scala:57:35]
  wire [4095:0]  _a_set_T = 4096'h1 << io_in_a_bits_source;	// @[OneHot.scala:57:35]
  wire [32782:0] _d_opcodes_clr_T_5 = 32783'hF << _GEN;	// @[Monitor.scala:677:76]
  ...
  wire [32782:0] _d_sizes_clr_T_5 = 32783'hF << _GEN;	// @[Monitor.scala:677:76, :678:74]
  ...
  `ifndef SYNTHESIS
    ...
    wire  [2:0]      _GEN_2 = io_in_a_bits_address[2:0] & ~(_is_aligned_mask_T_1[2:0]);	// @[Edges.scala:21:16, package.scala:235:{46,71,76}]
    ...
    wire             _GEN_4 = io_in_a_bits_source > 12'h80F;	// @[Parameters.scala:57:20]
    ...
    wire             _GEN_15 = io_in_d_bits_source > 12'h80F;	// @[Parameters.scala:57:20]
    ...
    wire  [8255:0]   _GEN_19 = {8242'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44, OneHot.scala:64:12]
    wire  [8255:0]   _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_19;	// @[Monitor.scala:613:35, :634:44]
    ...
    wire  [2063:0]   _GEN_20 = {2052'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    ...
    wire  [2063:0]   _T_618 = inflight >> _GEN_20;	// @[Monitor.scala:611:27, :682:25]
    wire  [8255:0]   _a_size_lookup_T_1 = inflight_sizes >> _GEN_19;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire  [2063:0]   _T_697 = 2064'h0 >> _GEN_20;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [8255:0]   _c_size_lookup_T_1 = 8256'h0 >> _GEN_19;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~(io_in_a_bits_source < 12'h810 & io_in_a_bits_address[30:12] == 19'h54000)) begin	// @[Monitor.scala:42:11, :114:53, :115:71, Parameters.scala:57:20, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(io_in_a_bits_source < 12'h810 & io_in_a_bits_address[30:12] == 19'h54000)) begin	// @[Monitor.scala:42:11, :122:56, :123:74, Parameters.scala:57:20, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inflight_opcodes =
          {_RANDOM_66[31:26],
           ...
           _RANDOM_322,
           _RANDOM_323,
           _RANDOM_324[25:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes =
          {_RANDOM_324[31:26],
           _RANDOM_325,
           _RANDOM_326,
           ...
           _RANDOM_580,
           _RANDOM_581,
           _RANDOM_582[25:0]};	// @[Monitor.scala:613:35, :615:33]
        watchdog = {_RANDOM_582[31:28], _RANDOM_583[27:0]};	// @[Monitor.scala:615:33, :706:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
