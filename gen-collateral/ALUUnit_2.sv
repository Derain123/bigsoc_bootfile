...
module ALUUnit_2(
  ...
  wire [63:0] _alu_io_adder_out;	// @[functional-unit.scala:317:19]
  wire        _alu_io_cmp_out;	// @[functional-unit.scala:317:19]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_uops_0_rob_idx = _RANDOM_7[6:0];	// @[functional-unit.scala:227:23]
        r_uops_0_pdst = _RANDOM_7[25:19];	// @[functional-unit.scala:227:23]
        r_uops_0_bypassable = _RANDOM_11[0];	// @[functional-unit.scala:227:23]
        r_uops_0_is_amo = _RANDOM_11[11];	// @[functional-unit.scala:227:23]
        r_uops_0_uses_stq = _RANDOM_11[13];	// @[functional-unit.scala:227:23]
        r_uops_0_dst_rtype = _RANDOM_12[12:11];	// @[functional-unit.scala:227:23]
        r_uops_1_br_mask = {_RANDOM_17[31:25], _RANDOM_18[8:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_rob_idx = {_RANDOM_19[31:26], _RANDOM_20[0]};	// @[functional-unit.scala:227:23]
        r_uops_1_pdst = _RANDOM_20[19:13];	// @[functional-unit.scala:227:23]
        r_uops_1_bypassable = _RANDOM_23[26];	// @[functional-unit.scala:227:23]
        r_uops_1_is_amo = _RANDOM_24[5];	// @[functional-unit.scala:227:23]
        r_uops_1_uses_stq = _RANDOM_24[7];	// @[functional-unit.scala:227:23]
        r_uops_1_dst_rtype = _RANDOM_25[6:5];	// @[functional-unit.scala:227:23]
        r_uops_2_br_mask = {_RANDOM_30[31:19], _RANDOM_31[2:0]};	// @[functional-unit.scala:227:23]
        r_uops_2_rob_idx = _RANDOM_32[26:20];	// @[functional-unit.scala:227:23]
        r_uops_2_pdst = _RANDOM_33[13:7];	// @[functional-unit.scala:227:23]
        r_uops_2_bypassable = _RANDOM_36[20];	// @[functional-unit.scala:227:23]
        r_uops_2_is_amo = _RANDOM_36[31];	// @[functional-unit.scala:227:23]
        r_uops_2_uses_stq = _RANDOM_37[1];	// @[functional-unit.scala:227:23]
        r_uops_2_dst_rtype = {_RANDOM_37[31], _RANDOM_38[0]};	// @[functional-unit.scala:227:23]
        r_val_0 = _RANDOM_38[17];	// @[functional-unit.scala:227:23, :436:23]
        r_val_1 = _RANDOM_38[18];	// @[functional-unit.scala:227:23, :436:23]
        r_data_0 = {_RANDOM_38[31:20], _RANDOM_39, _RANDOM_40[19:0]};	// @[functional-unit.scala:227:23, :437:19]
        r_data_1 = {_RANDOM_40[31:20], _RANDOM_41, _RANDOM_42[19:0]};	// @[functional-unit.scala:437:19]
        r_data_2 = {_RANDOM_42[31:20], _RANDOM_43, _RANDOM_44[19:0]};	// @[functional-unit.scala:437:19]
      `endif // RANDOMIZE_REG_INIT
    end // initial
