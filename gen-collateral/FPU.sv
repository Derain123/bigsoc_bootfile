...
module FPU(
  ...
  wire [2:0]  _fpiu_io_out_bits_in_rm;	// @[fpu.scala:213:20]
  wire [64:0] _fpiu_io_out_bits_in_in1;	// @[fpu.scala:213:20]
  wire [64:0] _fpiu_io_out_bits_in_in2;	// @[fpu.scala:213:20]
  wire        _fpiu_io_out_bits_lt;	// @[fpu.scala:213:20]
  wire [63:0] _fpiu_io_out_bits_store;	// @[fpu.scala:213:20]
  ...
  FPToInt fpiu (	// @[fpu.scala:213:20]
    ...
    .io_out_bits_store     (_fpiu_io_out_bits_store),
    .io_out_bits_toint     (_fpiu_io_out_bits_toint),
    .io_out_bits_exc       (_fpiu_io_out_bits_exc)
  );
  FMADecoder fpiu_io_in_bits_fma_decoder (	// @[fpu.scala:199:29]
    .io_uopc (io_req_bits_uop_uopc),
