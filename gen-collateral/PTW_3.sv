...
module PTW_3(
  ...
  wire            _GEN_8 = _T_140 & _T_141;	// @[Decoupled.scala:51:35, PTW.scala:240:30, :607:30]
  wire [7:0][2:0] _GEN_9 = {{3'h0}, {state}, {state}, {io_mem_s2_xcpt_ae_ld ? 3'h0 : 3'h5}, {state}, {3'h4}, {pte_cache_hit ? state : io_mem_req_ready ? 3'h2 : 3'h1}, {_T_141 ? {2'h0, _arb_io_out_bits_valid} : state}};	// @[Decoupled.scala:51:35, Mux.scala:47:70, PTW.scala:233:22, :236:19, :240:30, :379:24, :384:15, :389:24, :601:31, :605:18, :607:30, :615:{20,26}, :641:35, :647:34, :651:{20,26}, :656:18, :659:18, :661:35, :663:20, :668:18]
  wire [1:0]      _merged_pte_superpage_mask_T = stage2_final ? max_count : 2'h2;	// @[PTW.scala:284:25, :290:25, :682:45]
  wire            _r_pte_T_5 = _T_160 & pte_cache_hit;	// @[PTW.scala:379:24, :389:24, :692:50]
  wire            _r_pte_T_8 = ~traverse & r_req_vstage1 & stage2;	// @[PTW.scala:270:18, :283:19, :316:48, :696:{29,56}]
  wire            _GEN_10 = do_switch | ~mem_resp_valid;	// @[PTW.scala:293:31, :603:30, :694:8, :709:25, :712:21]
  ...
  wire            _T_176 = do_both_stages & ~stage2_final & success;	// @[PTW.scala:284:25, :289:38, :369:107, :719:41, :721:45]
  assign do_switch = mem_resp_valid & (traverse ? do_both_stages & ~stage2 : _T_176 & ~stage2);	// @[PTW.scala:283:19, :289:38, :293:31, :307:38, :316:48, :603:30, :605:18, :709:25, :712:21, :713:{28,40}, :721:{45,57}, :722:23, :726:24]
  wire            _GEN_11 = traverse | _T_176;	// @[PTW.scala:316:48, :410:26, :712:21, :721:{45,57}, :731:19]
  ...
  wire [1:0]      _count_T_2 = count + 2'h1;	// @[PTW.scala:259:18, :311:21, :648:24]
  ...
  wire            _T_150 = state == 3'h2;	// @[PTW.scala:233:22, :384:15, :605:18]
  wire            _T_151 = state == 3'h4;	// @[Mux.scala:47:70, PTW.scala:233:22, :605:18]
  wire            _GEN_16 = _T_160 | _T_150;	// @[PTW.scala:260:24, :389:24, :605:18]
  wire            _GEN_17 = _T_140 | _GEN_16;	// @[PTW.scala:240:30, :242:27, :260:24, :605:18]
  wire            _GEN_18 = _T_150 | _T_151 | ~((&state) & ~homogeneous);	// @[PTW.scala:233:22, :259:18, :571:36, :605:18, :670:{13,27}, :671:15]
  always @(posedge clock) begin
    ...
    resp_valid_0 <= mem_resp_valid & ~_GEN_11 & ~r_req_dest | ~_GEN_17 & (_T_151 ? io_mem_s2_xcpt_ae_ld & ~r_req_dest : (&state) & ~r_req_dest);	// @[PTW.scala:233:22, :242:27, :272:23, :293:31, :410:26, :605:18, :661:35, :664:32, :669:30, :703:30, :709:25, :712:21, :721:57, :731:19]
    resp_valid_1 <= mem_resp_valid & ~_GEN_11 & r_req_dest | ~_GEN_17 & (_T_151 ? io_mem_s2_xcpt_ae_ld & r_req_dest : (&state) & r_req_dest);	// @[PTW.scala:233:22, :242:27, :272:23, :293:31, :410:26, :605:18, :661:35, :664:32, :669:30, :703:30, :709:25, :712:21, :721:57, :731:19]
    ...
    if (do_switch) begin	// @[PTW.scala:603:30, :709:25, :712:21]
      ...
      if (traverse)	// @[PTW.scala:316:48]
        aux_count <= count + 2'h1;	// @[PTW.scala:259:18, :278:22, :311:21, :758:38]
      ...
      if (mem_resp_valid) begin	// @[PTW.scala:293:31]
        if (traverse)	// @[PTW.scala:316:48]
          count <= count + 2'h1;	// @[PTW.scala:259:18, :311:21, :714:22]
        else if (_T_176) begin	// @[PTW.scala:721:45]
          ...
          else if (_GEN_18) begin	// @[PTW.scala:259:18, :605:18]
          end
        ...
        count <= 2'h2;	// @[PTW.scala:259:18]
      if (_T_140 & _T_141) begin	// @[Decoupled.scala:51:35, PTW.scala:240:30, :605:18, :607:30]
    ...
    if (_T_140)	// @[PTW.scala:240:30]
      resp_ae_ptw <= ~_T_141 & resp_ae_ptw;	// @[Decoupled.scala:51:35, PTW.scala:260:24, :607:30, :623:21]
    else	// @[PTW.scala:240:30]
      resp_ae_ptw <= ~_GEN_16 & _T_151 & io_mem_s2_xcpt_ae_ld | resp_ae_ptw;	// @[PTW.scala:260:24, :605:18]
    if (~mem_resp_valid | _GEN_11) begin	// @[PTW.scala:293:31, :410:26, :605:18, :694:8, :709:25, :712:21, :721:57, :731:19]
    ...
    else begin	// @[PTW.scala:605:18, :709:25, :712:21]
    ...
    stage2 <= do_switch | (~mem_resp_valid | traverse | ~(_T_176 & stage2)) & (_GEN_8 ? _arb_io_out_bits_bits_stage2 : stage2);	// @[PTW.scala:236:19, :283:19, :293:31, :316:48, :603:30, :605:18, :607:30, :616:22, :694:8, :709:25, :712:21, :721:{45,57}, :722:23, :723:18, :757:20, :765:12]
    stage2_final <= mem_resp_valid & ~traverse & _T_176 & ~stage2 | (_GEN_8 ? _arb_io_out_bits_bits_stage2 & ~_arb_io_out_bits_bits_vstage1 : stage2_final);	// @[PTW.scala:236:19, :283:19, :284:25, :293:31, :316:48, :605:18, :607:30, :617:{22,53,56}, :709:25, :712:21, :721:{45,57}, :722:23, :726:24]
    ...
    l2_refill <= mem_resp_valid & ~_GEN_11 & success & _T_237 & ~r_req_need_gpa & (~r_req_vstage1 & ~r_req_stage2 | do_both_stages & aux_count == 2'h2 & aux_pte_pte_v & (mem_resp_data[1] | mem_resp_data[3] & ~(mem_resp_data[2])) & mem_resp_data[6] & mem_resp_data[2] & mem_resp_data[7] & mem_resp_data[4] & (mem_resp_data[1] | mem_resp_data[3] & ~(mem_resp_data[2])) & mem_resp_data[3]);	// @[PTW.scala:139:42, :141:{38,44}, :270:18, :278:22, :289:38, :293:31, :294:30, :305:37, :306:26, :308:36, :311:{106,114}, :370:65, :410:26, :588:{32,60}, :709:25, :712:21, :719:41, :721:57, :731:{19,61}, :732:{27,44}, :733:59, package.scala:33:86]
  end // always @(posedge)
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[PTW.scala:633:15]
      if (_GEN_8 & ~reset & ~(~_arb_io_out_bits_bits_need_gpa | _arb_io_out_bits_bits_stage2)) begin	// @[PTW.scala:236:19, :607:30, :633:{15,16,47}]
  ...
  Arbiter_75 arb (	// @[PTW.scala:236:19]
  ...
  OptimizationBarrier_41 state_barrier (	// @[package.scala:259:25]
    .io_x (io_mem_s2_nack ? 3'h1 : mem_resp_valid ? {2'h0, _GEN_11} : _GEN_9[state]),	// @[PTW.scala:233:22, :240:30, :293:31, :384:15, :389:24, :410:26, :601:31, :605:18, :607:30, :641:35, :656:18, :661:35, :668:18, :703:30, :709:25, :711:16, :712:21, :721:57, :731:19, :736:122, :752:25, :754:16]
    .io_y (_state_barrier_io_y)
  );
  OptimizationBarrier_42 r_pte_barrier (	// @[package.scala:259:25]
    .io_x_ppn (_r_pte_T_5 ? {24'h0, (hits[0] ? data_0 : 20'h0) | (hits[1] ? data_1 : 20'h0) | (hits[2] ? data_2 : 20'h0) | (hits[3] ? data_3 : 20'h0) | (hits[4] ? data_4 : 20'h0) | (hits[5] ? data_5 : 20'h0) | (hits[6] ? data_6 : 20'h0) | (hits[7] ? data_7 : 20'h0)} : do_switch ? {r_hgatp_ppn[43:2], 2'h0} : mem_resp_valid ? (_r_pte_T_8 ? {17'h0, _GEN_0 ? _T_15 : _leaf_T_5 ? {_T_15[26:9], aux_pte_ppn[8:0]} : {_T_15[26:18], aux_pte_ppn[17:0]}} & ((&_merged_pte_superpage_mask_T) | _merged_pte_superpage_mask_T == 2'h2 ? 44'hFFFFFFFFFFF : _merged_pte_superpage_mask_T == 2'h1 ? 44'hFFFFFFFFE00 : 44'hFFFFFFC0000) : {17'h0, _T_15}) : (&state) & ~homogeneous & count != 2'h2 ? (count[0] ? {r_pte_ppn[43:9], r_req_addr[8:0]} : {r_pte_ppn[43:18], r_req_addr[17:0]}) : _arb_io_out_ready_T_2 & _arb_io_out_valid ? (_arb_io_out_bits_bits_stage2 | _arb_io_out_bits_bits_vstage1 ? 44'h0 : io_dpath_ptbr_ppn) : r_pte_ppn),	// @[Cat.scala:33:92, Decoupled.scala:51:35, Mux.scala:27:73, :29:36, PTW.scala:233:22, :236:19, :240:43, :259:18, :270:18, :275:18, :276:20, :280:20, :291:16, :293:31, :307:{13,19}, :311:21, :313:93, :355:{49,79}, :367:19, :378:43, :571:36, :603:30, :682:45, :683:{64,125}, :685:24, :692:{8,50}, :694:8, :696:{8,28,56}, :698:{8,15,43,56,65}, :700:{8,29}, :709:25, :712:21, :789:13, :798:30, package.scala:32:47, :33:{76,86}]
    .io_x_d   (~_r_pte_T_5 & (_GEN_10 ? r_pte_d : _r_pte_T_8 ? aux_pte_d : mem_resp_data[7])),	// @[PTW.scala:275:18, :280:20, :294:30, :305:37, :692:{8,50}, :694:8, :696:{28,56}]
    .io_x_a   (~_r_pte_T_5 & (_GEN_10 ? r_pte_a : _r_pte_T_8 ? aux_pte_a : mem_resp_data[6])),	// @[PTW.scala:275:18, :280:20, :294:30, :305:37, :692:{8,50}, :694:8, :696:{28,56}]
    .io_x_g   (~_r_pte_T_5 & (_GEN_10 ? r_pte_g : _r_pte_T_8 ? aux_pte_g : mem_resp_data[5])),	// @[PTW.scala:275:18, :280:20, :294:30, :305:37, :692:{8,50}, :694:8, :696:{28,56}]
    .io_x_u   (~_r_pte_T_5 & (_GEN_10 ? r_pte_u : _r_pte_T_8 ? aux_pte_u : mem_resp_data[4])),	// @[PTW.scala:275:18, :280:20, :294:30, :305:37, :692:{8,50}, :694:8, :696:{28,56}]
    .io_x_x   (~_r_pte_T_5 & (_GEN_10 ? r_pte_x : _r_pte_T_8 ? aux_pte_x : mem_resp_data[3])),	// @[PTW.scala:275:18, :280:20, :294:30, :305:37, :692:{8,50}, :694:8, :696:{28,56}]
    .io_x_w   (~_r_pte_T_5 & (_GEN_10 ? r_pte_w : _r_pte_T_8 ? aux_pte_w : mem_resp_data[2])),	// @[PTW.scala:275:18, :280:20, :294:30, :305:37, :692:{8,50}, :694:8, :696:{28,56}]
    .io_x_r   (~_r_pte_T_5 & (_GEN_10 ? r_pte_r : _r_pte_T_8 ? aux_pte_r : mem_resp_data[1])),	// @[PTW.scala:275:18, :280:20, :294:30, :305:37, :692:{8,50}, :694:8, :696:{28,56}]
    .io_x_v   (~_r_pte_T_5 & (_GEN_10 ? r_pte_v : _r_pte_T_8 ? aux_pte_v : aux_pte_pte_v)),	// @[PTW.scala:275:18, :280:20, :306:26, :308:36, :311:{106,114}, :692:{8,50}, :694:8, :696:{28,56}]
  ...
  assign io_mem_req_valid = _T_160 | state == 3'h3;	// @[PTW.scala:233:22, :384:15, :389:24, :545:{39,48}]
  ...
  assign io_mem_s1_kill = state != 3'h2;	// @[PTW.scala:233:22, :384:15, :554:37]
endmodule
