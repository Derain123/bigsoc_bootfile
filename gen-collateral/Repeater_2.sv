  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_address = {_RANDOM_0[31:18], _RANDOM_1[0]};	// @[Repeater.scala:19:21, :20:18]
        saved_mask = _RANDOM_1[8:1];	// @[Repeater.scala:20:18]
        saved_corrupt = _RANDOM_3[9];	// @[Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
