  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_address = _RANDOM_0[29:18];	// @[Repeater.scala:19:21, :20:18]
        saved_mask = {_RANDOM_0[31:30], _RANDOM_1[5:0]};	// @[Repeater.scala:19:21, :20:18]
        saved_corrupt = _RANDOM_3[6];	// @[Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
