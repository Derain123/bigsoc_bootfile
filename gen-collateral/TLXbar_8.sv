...
module TLXbar_8(
  ...
  wire        requestDOI_0_1 = auto_out_d_bits_source == 4'h8;	// @[Parameters.scala:46:9, Xbar.scala:240:55]
  wire        out_8_valid = auto_out_b_valid & ~(auto_out_b_bits_source[3]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:182:40]
  wire        out_10_valid = auto_out_d_valid & ~(auto_out_d_bits_source[3]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:182:40]
  ...
  TLMonitor_61 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_b_bits_source  (auto_out_b_bits_source[2:0]),	// @[Xbar.scala:231:69]
    ...
    .io_in_d_bits_source  (auto_out_d_bits_source[2:0]),	// @[Xbar.scala:231:69]
