...
module FPU_3(
  ...
  wire             _dfma_io_out_valid;	// @[FPU.scala:881:28]
  ...
  wire             _ifpu_io_out_valid;	// @[FPU.scala:857:20]
  ...
  FPUFMAPipe_6 sfma (	// @[FPU.scala:843:20]
    .clock             (clock),
    .reset             (reset),
  ...
  FPToFP_3 fpmu (	// @[FPU.scala:862:20]
    .clock                 (clock),
    .reset                 (reset),
  ...
  FPUFMAPipe dfma (	// @[FPU.scala:881:28]
    .clock             (clock),
    .reset             (reset),
