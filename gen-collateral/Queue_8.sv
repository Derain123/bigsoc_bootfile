...
module Queue_8(
  ...
  wire [121:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[17:10];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_address = _ram_ext_R0_data[48:18];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[56:49];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[120:57];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[121];	// @[Decoupled.scala:273:95]
endmodule
