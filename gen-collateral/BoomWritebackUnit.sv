...
module BoomWritebackUnit(
  ...
  wire [3:0][127:0] _GEN = {{wb_buffer_3}, {wb_buffer_2}, {wb_buffer_1}, {wb_buffer_0}};	// @[Edges.scala:434:15, dcache.scala:46:22]
  ...
  wire              _T_16 = state == 3'h4;	// @[Edges.scala:432:15, dcache.scala:39:22, :135:22]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_param = _RANDOM_0[31:29];	// @[dcache.scala:37:16]
        req_way_en = _RANDOM_1[7:0];	// @[dcache.scala:37:16]
        req_voluntary = _RANDOM_1[8];	// @[dcache.scala:37:16]
        state = _RANDOM_1[11:9];	// @[dcache.scala:37:16, :39:22]
        r1_data_req_fired = _RANDOM_1[12];	// @[dcache.scala:37:16, :40:34]
        r2_data_req_fired = _RANDOM_1[13];	// @[dcache.scala:37:16, :41:34]
        r1_data_req_cnt = _RANDOM_1[16:14];	// @[dcache.scala:37:16, :42:28]
        r2_data_req_cnt = _RANDOM_1[19:17];	// @[dcache.scala:37:16, :43:28]
        data_req_cnt = _RANDOM_1[22:20];	// @[dcache.scala:37:16, :44:29]
        wb_buffer_0 = {_RANDOM_1[31], _RANDOM_2, _RANDOM_3, _RANDOM_4, _RANDOM_5[30:0]};	// @[dcache.scala:37:16, :46:22]
        wb_buffer_1 = {_RANDOM_5[31], _RANDOM_6, _RANDOM_7, _RANDOM_8, _RANDOM_9[30:0]};	// @[dcache.scala:46:22]
        wb_buffer_2 = {_RANDOM_9[31], _RANDOM_10, _RANDOM_11, _RANDOM_12, _RANDOM_13[30:0]};	// @[dcache.scala:46:22]
        wb_buffer_3 = {_RANDOM_13[31], _RANDOM_14, _RANDOM_15, _RANDOM_16, _RANDOM_17[30:0]};	// @[dcache.scala:46:22]
        acked = _RANDOM_17[31];	// @[dcache.scala:46:22, :47:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_release_bits_data = _GEN[data_req_cnt[1:0]];	// @[Edges.scala:434:15, dcache.scala:44:29]
