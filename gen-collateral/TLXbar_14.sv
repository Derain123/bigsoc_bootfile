...
module TLXbar_14(
  ...
  wire        out_8_valid = auto_out_b_valid & ~(auto_out_b_bits_source[2]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:182:40]
  wire        out_10_valid = auto_out_d_valid & ~(auto_out_d_bits_source[2]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:182:40]
  ...
  TLMonitor_70 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_b_bits_source  (auto_out_b_bits_source[1:0]),	// @[Xbar.scala:231:69]
    ...
    .io_in_d_bits_source  (auto_out_d_bits_source[1:0]),	// @[Xbar.scala:231:69]
  ...
  TLMonitor_71 monitor_1 (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
  ...
  assign auto_in_0_b_bits_source = auto_out_b_bits_source[1:0];	// @[Xbar.scala:231:69]
  ...
  assign auto_out_b_ready = ~(auto_out_b_bits_source[2]) & auto_in_0_b_ready;	// @[Mux.scala:27:73, Parameters.scala:54:{10,32}]
