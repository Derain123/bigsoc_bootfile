...
module FPUExeUnit(
  ...
  wire [6:0]  _resp_arb_io_out_bits_fflags_bits_uop_rob_idx;	// @[execution-unit.scala:554:26]
  ...
  BranchKillableQueue_6 queue (	// @[execution-unit.scala:528:23]
    .clock                                       (clock),
    .reset                                       (reset),
  ...
  BranchKillableQueue_7 fp_sdq (	// @[execution-unit.scala:542:24]
    .clock                               (clock),
    .reset                               (reset),
