...
module Queue_100(
  ...
  wire [173:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[172:45];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[173];	// @[Decoupled.scala:273:95]
endmodule
