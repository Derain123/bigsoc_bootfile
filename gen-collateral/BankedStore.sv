...
module BankedStore(
  ...
  input  [5:0]   io_sinkC_adr_bits_way,
  input  [3:0]   io_sinkC_adr_bits_set,
  ...
  input  [5:0]   io_sinkD_adr_bits_way,
  input  [3:0]   io_sinkD_adr_bits_set,
  input  [2:0]   io_sinkD_adr_bits_beat,
  input  [63:0]  io_sinkD_dat_data,
  input          io_sourceC_adr_valid,
  input  [5:0]   io_sourceC_adr_bits_way,
  input  [3:0]   io_sourceC_adr_bits_set,
  input  [2:0]   io_sourceC_adr_bits_beat,
  input          io_sourceD_radr_valid,
  input  [5:0]   io_sourceD_radr_bits_way,
  input  [3:0]   io_sourceD_radr_bits_set,
  input  [1:0]   io_sourceD_radr_bits_beat,
                 io_sourceD_radr_bits_mask,
  input          io_sourceD_wadr_valid,
  input  [5:0]   io_sourceD_wadr_bits_way,
  input  [3:0]   io_sourceD_wadr_bits_set,
  ...
  wire [9:0]  reqs_0_index = {io_sinkC_adr_bits_way, io_sinkC_adr_bits_set};	// @[BankedStore.scala:135:23]
  ...
  wire [9:0]  reqs_2_index = {io_sinkD_adr_bits_way, io_sinkD_adr_bits_set};	// @[BankedStore.scala:135:23]
  ...
  wire [9:0]  reqs_1_index = {io_sourceC_adr_bits_way, io_sourceC_adr_bits_set};	// @[BankedStore.scala:135:23]
  ...
  wire [9:0]  reqs_4_index = {io_sourceD_radr_bits_way, io_sourceD_radr_bits_set};	// @[BankedStore.scala:135:23]
  ...
  wire [9:0]  reqs_3_index = {io_sourceD_wadr_bits_way, io_sourceD_wadr_bits_set};	// @[BankedStore.scala:135:23]
