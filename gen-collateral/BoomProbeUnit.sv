  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_source = _RANDOM_0[15:13];	// @[dcache.scala:165:22, :167:16]
        req_address = {_RANDOM_0[31:16], _RANDOM_1[15:0]};	// @[dcache.scala:165:22, :167:16]
        way_en = _RANDOM_6[8:1];	// @[dcache.scala:171:19]
        old_coh_state = _RANDOM_6[10:9];	// @[dcache.scala:171:19, :173:20]
      `endif // RANDOMIZE_REG_INIT
    end // initial
