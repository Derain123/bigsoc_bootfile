...
module Queue_370(
  ...
  wire [70:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_8 ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_last, io_enq_bits_resp, io_enq_bits_data, io_enq_bits_id}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[67:4];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_resp = _ram_ext_R0_data[69:68];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_last = _ram_ext_R0_data[70];	// @[Decoupled.scala:273:95]
endmodule
