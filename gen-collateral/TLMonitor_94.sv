...
module TLMonitor_94(
  ...
  wire [4095:0]  _GEN = {4084'h0, io_in_a_bits_source};	// @[OneHot.scala:57:35]
  wire           d_release_ack = io_in_d_bits_opcode == 3'h6;	// @[Monitor.scala:81:25, :670:46]
  wire [4095:0]  _GEN_0 = {4084'h0, io_in_d_bits_source};	// @[OneHot.scala:57:35]
  ...
  wire [32782:0] _GEN_1 = {32769'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:677:76, OneHot.scala:64:12]
  wire [4095:0]  _d_clr_T = 4096'h1 << _GEN_0;	// @[OneHot.scala:57:35]
  wire [4095:0]  _a_set_T = 4096'h1 << _GEN;	// @[OneHot.scala:57:35]
  wire [32782:0] _d_opcodes_clr_T_5 = 32783'hF << _GEN_1;	// @[Monitor.scala:677:76]
  wire [32770:0] _a_opcodes_set_T_1 = {32767'h0, a_first_done ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {32757'h0, io_in_a_bits_source, 2'h0};	// @[Decoupled.scala:51:35, Monitor.scala:42:11, :632:35, :643:40, :652:72, :654:{28,53}, :656:54, OneHot.scala:64:12]
  wire [32782:0] _d_sizes_clr_T_5 = 32783'hF << _GEN_1;	// @[Monitor.scala:677:76, :678:74]
  wire [32769:0] _a_sizes_set_T_1 = {32767'h0, a_first_done ? {io_in_a_bits_size, 1'h1} : 3'h0} << {32756'h0, io_in_a_bits_source, 2'h0};	// @[Decoupled.scala:51:35, Misc.scala:201:34, Monitor.scala:42:11, :645:38, :652:72, :655:{28,51}, :656:54, :657:52, OneHot.scala:64:12]
  always @(posedge clock) begin
    if (reset) begin
      inflight <= 2064'h0;	// @[Monitor.scala:611:27, :723:35]
      inflight_opcodes <= 8256'h0;	// @[Monitor.scala:613:35, :725:35]
      inflight_sizes <= 8256'h0;	// @[Monitor.scala:615:33, :725:35]
      watchdog <= 32'h0;	// @[Monitor.scala:706:27]
    end
    else begin
      inflight <= (inflight | (a_first_done ? _a_set_T[2063:0] : 2064'h0)) & ~(_T_613 ? _d_clr_T[2063:0] : 2064'h0);	// @[Decoupled.scala:51:35, Monitor.scala:611:27, :623:34, :652:72, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (a_first_done ? _a_opcodes_set_T_1[8255:0] : 8256'h0)) & ~(_T_613 ? _d_opcodes_clr_T_5[8255:0] : 8256'h0);	// @[Decoupled.scala:51:35, Monitor.scala:613:35, :627:33, :652:72, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :725:35]
      inflight_sizes <= (inflight_sizes | (a_first_done ? _a_sizes_set_T_1[8255:0] : 8256'h0)) & ~(_T_613 ? _d_sizes_clr_T_5[8255:0] : 8256'h0);	// @[Decoupled.scala:51:35, Monitor.scala:615:33, :629:31, :652:72, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
  ...
  `ifndef SYNTHESIS
    ...
    wire  [2:0]      _GEN_4 = io_in_a_bits_address[2:0] & ~(_is_aligned_mask_T_1[2:0]);	// @[Edges.scala:21:16, package.scala:235:{46,71,76}]
    ...
    wire             _GEN_6 = io_in_a_bits_source > 12'h80F;	// @[Parameters.scala:57:20]
    ...
    wire             _GEN_17 = io_in_d_bits_source > 12'h80F;	// @[Parameters.scala:57:20]
    ...
    wire  [8255:0]   _GEN_21 = {8242'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44, OneHot.scala:64:12]
    wire  [8255:0]   _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_21;	// @[Monitor.scala:613:35, :634:44]
    wire  [4095:0]   _a_set_wo_ready_T = 4096'h1 << _GEN;	// @[OneHot.scala:57:35]
    wire  [2063:0]   a_set_wo_ready = io_in_a_valid ? _a_set_wo_ready_T[2063:0] : 2064'h0;	// @[Monitor.scala:624:34, :648:71, :649:22, :723:35, OneHot.scala:57:35]
    ...
    wire  [2063:0]   _GEN_22 = {2052'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    ...
    wire  [2063:0]   _T_618 = inflight >> _GEN_22;	// @[Monitor.scala:611:27, :682:25]
    wire  [8255:0]   _a_size_lookup_T_1 = inflight_sizes >> _GEN_21;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire  [4095:0]   _d_clr_wo_ready_T = 4096'h1 << _GEN_0;	// @[OneHot.scala:57:35]
    wire  [2063:0]   _T_704 = 2064'h0 >> _GEN_22;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [8255:0]   _c_size_lookup_T_1 = 8256'h0 >> _GEN_21;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_source < 12'h810 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :114:53, :115:71, Parameters.scala:57:20, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_12 & ~reset & ~(io_in_a_bits_source < 12'h810 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :122:56, :123:74, Parameters.scala:57:20, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (~reset & ~(a_set_wo_ready != (io_in_d_valid & ~d_release_ack ? _d_clr_wo_ready_T[2063:0] : 2064'h0) | a_set_wo_ready == 2064'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'A' and 'D' concurrent, despite minlatency 1 (connected at Plic.scala:363:15)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(inflight == 2064'h0 | _plusarg_reader_out == 32'h0 | watchdog < _plusarg_reader_out)) begin	// @[Monitor.scala:42:11, :611:27, :706:27, :709:{26,39,47,59}, :723:35, PlusArg.scala:80:11]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inflight_opcodes =
          {_RANDOM_66[31:23],
           ...
           _RANDOM_322,
           _RANDOM_323,
           _RANDOM_324[22:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes =
          {_RANDOM_324[31:23],
           _RANDOM_325,
           _RANDOM_326,
           ...
           _RANDOM_580,
           _RANDOM_581,
           _RANDOM_582[22:0]};	// @[Monitor.scala:613:35, :615:33]
        watchdog = {_RANDOM_582[31:25], _RANDOM_583[24:0]};	// @[Monitor.scala:615:33, :706:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
