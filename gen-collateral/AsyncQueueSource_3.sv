...
module AsyncQueueSource_3(
  ...
  input        io_enq_bits_ackhavereset,
               ...
               io_enq_bits_hamask_6,
               io_enq_bits_hamask_7,
               io_enq_bits_hamask_8,
               io_enq_bits_hamask_9,
               io_enq_bits_hamask_10,
               ...
               io_enq_bits_hrmask_6,
               io_enq_bits_hrmask_7,
               io_enq_bits_hrmask_8,
               io_enq_bits_hrmask_9,
               io_enq_bits_hrmask_10,
               io_async_ridx,
  ...
  output       io_async_mem_0_ackhavereset,
               ...
               io_async_mem_0_hamask_6,
               io_async_mem_0_hamask_7,
               io_async_mem_0_hamask_8,
               io_async_mem_0_hamask_9,
               io_async_mem_0_hamask_10,
               ...
               io_async_mem_0_hrmask_6,
               io_async_mem_0_hrmask_7,
               io_async_mem_0_hrmask_8,
               io_async_mem_0_hrmask_9,
               io_async_mem_0_hrmask_10,
               io_async_widx,
  ...
  reg        mem_0_hamask_6;	// @[AsyncQueue.scala:80:16]
  reg        mem_0_hamask_7;	// @[AsyncQueue.scala:80:16]
  reg        mem_0_hamask_8;	// @[AsyncQueue.scala:80:16]
  reg        mem_0_hamask_9;	// @[AsyncQueue.scala:80:16]
  reg        mem_0_hamask_10;	// @[AsyncQueue.scala:80:16]
  ...
  reg        mem_0_hrmask_6;	// @[AsyncQueue.scala:80:16]
  reg        mem_0_hrmask_7;	// @[AsyncQueue.scala:80:16]
  reg        mem_0_hrmask_8;	// @[AsyncQueue.scala:80:16]
  reg        mem_0_hrmask_9;	// @[AsyncQueue.scala:80:16]
  reg        mem_0_hrmask_10;	// @[AsyncQueue.scala:80:16]
  ...
  always @(posedge clock) begin
    if (_T) begin	// @[Decoupled.scala:51:35]
      ...
      mem_0_hamask_6 <= io_enq_bits_hamask_6;	// @[AsyncQueue.scala:80:16]
      mem_0_hamask_7 <= io_enq_bits_hamask_7;	// @[AsyncQueue.scala:80:16]
      mem_0_hamask_8 <= io_enq_bits_hamask_8;	// @[AsyncQueue.scala:80:16]
      mem_0_hamask_9 <= io_enq_bits_hamask_9;	// @[AsyncQueue.scala:80:16]
      mem_0_hamask_10 <= io_enq_bits_hamask_10;	// @[AsyncQueue.scala:80:16]
      ...
      mem_0_hrmask_6 <= io_enq_bits_hrmask_6;	// @[AsyncQueue.scala:80:16]
      mem_0_hrmask_7 <= io_enq_bits_hrmask_7;	// @[AsyncQueue.scala:80:16]
      mem_0_hrmask_8 <= io_enq_bits_hrmask_8;	// @[AsyncQueue.scala:80:16]
      mem_0_hrmask_9 <= io_enq_bits_hrmask_9;	// @[AsyncQueue.scala:80:16]
      mem_0_hrmask_10 <= io_enq_bits_hrmask_10;	// @[AsyncQueue.scala:80:16]
    end
  end // always @(posedge)
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      widx_widx_bin <= 1'h0;	// @[AsyncQueue.scala:52:25, :80:16]
      ready_reg <= 1'h0;	// @[AsyncQueue.scala:80:16, :88:56]
      widx_gray <= 1'h0;	// @[AsyncQueue.scala:80:16, :91:55]
    end
    else begin
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0_hamask_1 = _RANDOM_0[14];	// @[AsyncQueue.scala:80:16]
        mem_0_hamask_2 = _RANDOM_0[15];	// @[AsyncQueue.scala:80:16]
        mem_0_hamask_3 = _RANDOM_0[16];	// @[AsyncQueue.scala:80:16]
        mem_0_hamask_4 = _RANDOM_0[17];	// @[AsyncQueue.scala:80:16]
        mem_0_hamask_5 = _RANDOM_0[18];	// @[AsyncQueue.scala:80:16]
        mem_0_hamask_6 = _RANDOM_0[19];	// @[AsyncQueue.scala:80:16]
        mem_0_hamask_7 = _RANDOM_0[20];	// @[AsyncQueue.scala:80:16]
        mem_0_hamask_8 = _RANDOM_0[21];	// @[AsyncQueue.scala:80:16]
        mem_0_hamask_9 = _RANDOM_0[22];	// @[AsyncQueue.scala:80:16]
        mem_0_hamask_10 = _RANDOM_0[23];	// @[AsyncQueue.scala:80:16]
        mem_0_hrmask_0 = _RANDOM_0[24];	// @[AsyncQueue.scala:80:16]
        mem_0_hrmask_1 = _RANDOM_0[25];	// @[AsyncQueue.scala:80:16]
        mem_0_hrmask_2 = _RANDOM_0[26];	// @[AsyncQueue.scala:80:16]
        mem_0_hrmask_3 = _RANDOM_0[27];	// @[AsyncQueue.scala:80:16]
        mem_0_hrmask_4 = _RANDOM_0[28];	// @[AsyncQueue.scala:80:16]
        mem_0_hrmask_5 = _RANDOM_0[29];	// @[AsyncQueue.scala:80:16]
        mem_0_hrmask_6 = _RANDOM_0[30];	// @[AsyncQueue.scala:80:16]
        mem_0_hrmask_7 = _RANDOM_0[31];	// @[AsyncQueue.scala:80:16]
        mem_0_hrmask_8 = _RANDOM_1[0];	// @[AsyncQueue.scala:80:16]
        mem_0_hrmask_9 = _RANDOM_1[1];	// @[AsyncQueue.scala:80:16]
        mem_0_hrmask_10 = _RANDOM_1[2];	// @[AsyncQueue.scala:80:16]
        widx_widx_bin = _RANDOM_1[3];	// @[AsyncQueue.scala:52:25, :80:16]
        ready_reg = _RANDOM_1[4];	// @[AsyncQueue.scala:80:16, :88:56]
        widx_gray = _RANDOM_1[5];	// @[AsyncQueue.scala:80:16, :91:55]
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          widx_widx_bin = 1'h0;	// @[AsyncQueue.scala:52:25, :80:16]
  ...
  assign io_async_mem_0_hamask_6 = mem_0_hamask_6;	// @[AsyncQueue.scala:80:16]
  assign io_async_mem_0_hamask_7 = mem_0_hamask_7;	// @[AsyncQueue.scala:80:16]
  assign io_async_mem_0_hamask_8 = mem_0_hamask_8;	// @[AsyncQueue.scala:80:16]
  assign io_async_mem_0_hamask_9 = mem_0_hamask_9;	// @[AsyncQueue.scala:80:16]
  assign io_async_mem_0_hamask_10 = mem_0_hamask_10;	// @[AsyncQueue.scala:80:16]
  ...
  assign io_async_mem_0_hrmask_6 = mem_0_hrmask_6;	// @[AsyncQueue.scala:80:16]
  assign io_async_mem_0_hrmask_7 = mem_0_hrmask_7;	// @[AsyncQueue.scala:80:16]
  assign io_async_mem_0_hrmask_8 = mem_0_hrmask_8;	// @[AsyncQueue.scala:80:16]
  assign io_async_mem_0_hrmask_9 = mem_0_hrmask_9;	// @[AsyncQueue.scala:80:16]
  assign io_async_mem_0_hrmask_10 = mem_0_hrmask_10;	// @[AsyncQueue.scala:80:16]
