...
module TLMonitor_33(
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~(io_in_a_bits_source < 12'h810 & io_in_a_bits_address[14:12] == 3'h4)) begin	// @[Monitor.scala:42:11, :104:25, :114:53, :115:71, Parameters.scala:57:20, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(io_in_a_bits_source < 12'h810 & io_in_a_bits_address[14:12] == 3'h4)) begin	// @[Monitor.scala:42:11, :104:25, :122:56, :123:74, Parameters.scala:57:20, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inflight_opcodes =
          {_RANDOM_66[31:10],
           ...
           _RANDOM_322,
           _RANDOM_323,
           _RANDOM_324[9:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes =
          {_RANDOM_324[31:10],
           _RANDOM_325,
           _RANDOM_326,
           ...
           _RANDOM_580,
           _RANDOM_581,
           _RANDOM_582[9:0]};	// @[Monitor.scala:613:35, :615:33]
        watchdog = {_RANDOM_582[31:12], _RANDOM_583[11:0]};	// @[Monitor.scala:615:33, :706:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
