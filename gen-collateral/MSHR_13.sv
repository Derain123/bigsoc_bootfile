...
module MSHR_13(
  ...
  reg  [20:0]      req_old_meta_tag;	// @[NBDcache.scala:170:16]
  reg  [7:0]       req_way_en;	// @[NBDcache.scala:170:16]
  wire             idx_match = req_addr[10:6] == io_req_bits_addr[10:6];	// @[NBDcache.scala:170:16, :171:25, :174:{27,47}]
  ...
  wire             refill_done = (counter == 8'h1 | beats1 == 8'h0) & io_mem_grant_valid;	// @[Edges.scala:221:14, :229:27, :232:{25,33,43}, :233:22]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_old_meta_tag = _RANDOM_2[29:9];	// @[NBDcache.scala:170:16]
        req_way_en = {_RANDOM_2[31:30], _RANDOM_3[5:0]};	// @[NBDcache.scala:170:16]
        new_coh_state = _RANDOM_3[7:6];	// @[NBDcache.scala:170:16, :176:24]
        counter = _RANDOM_3[15:8];	// @[Edges.scala:229:27, NBDcache.scala:170:16]
        acked = _RANDOM_3[16];	// @[NBDcache.scala:170:16, :199:18]
        meta_hazard = _RANDOM_3[18:17];	// @[NBDcache.scala:170:16, :272:28]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_93 rpq (	// @[NBDcache.scala:194:19]
    .clock                (clock),
    .reset                (reset),
  ...
  Queue_94 grantackq (	// @[NBDcache.scala:257:25]
    .clock            (clock),
    .reset            (reset),
  ...
  assign io_tag = req_addr[31:11];	// @[NBDcache.scala:170:16, :172:26, :268:10]
  ...
  assign io_refill_addr = {req_addr[10:6] | _GEN_0[6:2], _GEN_0[1:0], 4'h0};	// @[Edges.scala:234:25, NBDcache.scala:168:22, :170:16, :267:{18,36}]
  assign io_meta_read_valid = _io_replay_valid_T;	// @[NBDcache.scala:197:49]
  assign io_meta_read_bits_idx = req_addr[10:6];	// @[NBDcache.scala:170:16, :171:25]
  assign io_meta_write_valid = _io_meta_write_valid_output;	// @[package.scala:73:59]
  assign io_meta_write_bits_idx = req_addr[10:6];	// @[NBDcache.scala:170:16, :171:25]
  ...
  assign io_meta_write_bits_data_tag = req_addr[31:11];	// @[NBDcache.scala:170:16, :172:26, :268:10]
  assign io_replay_valid = _io_replay_valid_T & _rpq_io_deq_valid;	// @[NBDcache.scala:194:19, :197:49, :304:44]
  assign io_replay_bits_addr = {8'h0, req_addr[31:6], _rpq_io_deq_bits_addr[5:0]};	// @[Cat.scala:33:92, Edges.scala:229:27, NBDcache.scala:170:16, :194:19, :307:{23,67}]
  ...
  assign io_wb_req_bits_idx = req_addr[10:6];	// @[NBDcache.scala:170:16, :171:25]
