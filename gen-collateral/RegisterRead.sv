  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        exe_reg_uops_0_ftq_idx = _RANDOM_5[21:17];	// @[register-read.scala:70:29]
        exe_reg_uops_0_edge_inst = _RANDOM_5[22];	// @[register-read.scala:70:29]
        exe_reg_uops_0_pc_lob = _RANDOM_5[28:23];	// @[register-read.scala:70:29]
        exe_reg_uops_0_taken = _RANDOM_5[29];	// @[register-read.scala:70:29]
        exe_reg_uops_0_imm_packed = {_RANDOM_5[31:30], _RANDOM_6[17:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_0_csr_addr = _RANDOM_6[29:18];	// @[register-read.scala:70:29]
        exe_reg_uops_0_rob_idx = {_RANDOM_6[31:30], _RANDOM_7[4:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_0_ldq_idx = _RANDOM_7[9:5];	// @[register-read.scala:70:29]
        exe_reg_uops_0_stq_idx = _RANDOM_7[14:10];	// @[register-read.scala:70:29]
        exe_reg_uops_0_rxq_idx = _RANDOM_7[16:15];	// @[register-read.scala:70:29]
        exe_reg_uops_0_pdst = _RANDOM_7[23:17];	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs1 = _RANDOM_7[30:24];	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs2 = {_RANDOM_7[31], _RANDOM_8[5:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs3 = _RANDOM_8[12:6];	// @[register-read.scala:70:29]
        exe_reg_uops_0_ppred = _RANDOM_8[17:13];	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs1_busy = _RANDOM_8[18];	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs2_busy = _RANDOM_8[19];	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs3_busy = _RANDOM_8[20];	// @[register-read.scala:70:29]
        exe_reg_uops_0_ppred_busy = _RANDOM_8[21];	// @[register-read.scala:70:29]
        exe_reg_uops_0_stale_pdst = _RANDOM_8[28:22];	// @[register-read.scala:70:29]
        ...
        exe_reg_rs1_data_0 = {_RANDOM_12[31:27], _RANDOM_13, _RANDOM_14[27:0]};	// @[register-read.scala:70:29, :71:29]
        exe_reg_rs2_data_0 = {_RANDOM_14[31:28], _RANDOM_15, _RANDOM_16[28:0]};	// @[register-read.scala:71:29, :72:29]
        exe_reg_rs3_data_0 = {_RANDOM_16[31:29], _RANDOM_17, _RANDOM_18[29:0]};	// @[register-read.scala:72:29, :73:29]
        rrd_valids_0_REG = _RANDOM_18[31];	// @[register-read.scala:73:29, :84:29]
        rrd_uops_0_REG_uopc = _RANDOM_19[6:0];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_inst = {_RANDOM_19[31:7], _RANDOM_20[6:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_debug_inst = {_RANDOM_20[31:7], _RANDOM_21[6:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_rvc = _RANDOM_21[7];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_debug_pc = {_RANDOM_21[31:8], _RANDOM_22[15:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_iq_type = _RANDOM_22[18:16];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_fu_code = _RANDOM_22[28:19];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_br_type = {_RANDOM_22[31:29], _RANDOM_23[0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_op1_sel = _RANDOM_23[2:1];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_op2_sel = _RANDOM_23[5:3];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_imm_sel = _RANDOM_23[8:6];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_op_fcn = _RANDOM_23[12:9];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_fcn_dw = _RANDOM_23[13];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_csr_cmd = _RANDOM_23[16:14];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_is_load = _RANDOM_23[17];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_is_sta = _RANDOM_23[18];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_is_std = _RANDOM_23[19];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_iw_state = _RANDOM_23[21:20];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_br = _RANDOM_23[24];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_jalr = _RANDOM_23[25];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_jal = _RANDOM_23[26];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_sfb = _RANDOM_23[27];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_br_mask = {_RANDOM_23[31:28], _RANDOM_24[11:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_br_tag = _RANDOM_24[15:12];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ftq_idx = _RANDOM_24[20:16];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_edge_inst = _RANDOM_24[21];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_pc_lob = _RANDOM_24[27:22];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_taken = _RANDOM_24[28];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_imm_packed = {_RANDOM_24[31:29], _RANDOM_25[16:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_csr_addr = _RANDOM_25[28:17];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_rob_idx = {_RANDOM_25[31:29], _RANDOM_26[3:0]};	// @[register-read.scala:86:29]
        ...
        rrd_uops_0_REG_pdst = _RANDOM_26[22:16];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs1 = _RANDOM_26[29:23];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs2 = {_RANDOM_26[31:30], _RANDOM_27[4:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs3 = _RANDOM_27[11:5];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ppred = _RANDOM_27[16:12];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs1_busy = _RANDOM_27[17];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs2_busy = _RANDOM_27[18];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs3_busy = _RANDOM_27[19];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ppred_busy = _RANDOM_27[20];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_stale_pdst = _RANDOM_27[27:21];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_exception = _RANDOM_27[28];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_exc_cause = {_RANDOM_27[31:29], _RANDOM_28, _RANDOM_29[28:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_bypassable = _RANDOM_29[29];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_mem_cmd = {_RANDOM_29[31:30], _RANDOM_30[2:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_mem_size = _RANDOM_30[4:3];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_mem_signed = _RANDOM_30[5];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_fence = _RANDOM_30[6];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_fencei = _RANDOM_30[7];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_amo = _RANDOM_30[8];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_uses_ldq = _RANDOM_30[9];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_uses_stq = _RANDOM_30[10];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_sys_pc2epc = _RANDOM_30[11];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_unique = _RANDOM_30[12];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_flush_on_commit = _RANDOM_30[13];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ldst_is_rs1 = _RANDOM_30[14];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ldst = _RANDOM_30[20:15];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_lrs1 = _RANDOM_30[26:21];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_lrs2 = {_RANDOM_30[31:27], _RANDOM_31[0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_lrs3 = _RANDOM_31[6:1];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ldst_val = _RANDOM_31[7];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_dst_rtype = _RANDOM_31[9:8];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_lrs1_rtype = _RANDOM_31[11:10];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_lrs2_rtype = _RANDOM_31[13:12];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_frs3_en = _RANDOM_31[14];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_fp_val = _RANDOM_31[15];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_fp_single = _RANDOM_31[16];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_xcpt_pf_if = _RANDOM_31[17];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_xcpt_ae_if = _RANDOM_31[18];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_xcpt_ma_if = _RANDOM_31[19];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_bp_debug_if = _RANDOM_31[20];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_bp_xcpt_if = _RANDOM_31[21];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_debug_fsrc = _RANDOM_31[23:22];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_debug_tsrc = _RANDOM_31[25:24];	// @[register-read.scala:86:29]
        rrd_rs1_data_0_REG = _RANDOM_31[26];	// @[register-read.scala:86:29, :124:57]
        rrd_rs2_data_0_REG = _RANDOM_31[27];	// @[register-read.scala:86:29, :125:57]
        rrd_rs3_data_0_REG = _RANDOM_31[28];	// @[register-read.scala:86:29, :126:57]
      `endif // RANDOMIZE_REG_INIT
    end // initial
