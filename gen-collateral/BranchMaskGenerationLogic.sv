...
module BranchMaskGenerationLogic(
  ...
  wire [15:0] _T_102 = {16{io_will_fire_0}} & tag_masks_0 | branch_mask;	// @[decode.scala:750:28, :768:32, :770:22, :785:20]
  wire [15:0] _T_104 = {16{io_will_fire_1}} & tag_masks_1 | _T_102;	// @[decode.scala:768:32, :770:22, :785:20]
  always @(posedge clock) begin
    if (reset)
      ...
      branch_mask <= ({16{io_will_fire_2}} & (_T_67[0] ? (_T_67[1] ? (_T_67[2] ? (_T_67[3] ? (_T_67[4] ? (_T_67[5] ? (_T_67[6] ? (_T_67[7] ? (_T_67[8] ? (_T_67[9] ? (_T_67[10] ? (_T_67[11] ? (_T_67[12] ? (_T_67[13] ? (_T_67[14] ? {~(_T_67[15]), 15'h0} : 16'h4000) : 16'h2000) : 16'h1000) : 16'h800) : 16'h400) : 16'h200) : 16'h100) : 16'h80) : 16'h40) : 16'h20) : 16'h10) : 16'h8) : 16'h4) : 16'h2) : 16'h1) | _T_104) & ~io_brupdate_b1_resolve_mask & (io_brupdate_b2_mispredict ? io_brupdate_b2_uop_br_mask : 16'hFFFF);	// @[decode.scala:750:28, :760:41, :765:18, :768:{13,27,32}, :770:{22,30}, :775:24, :785:20, :794:19, :797:57, util.scala:89:23]
  end // always @(posedge)
  `ifndef SYNTHESIS
  ...
  assign io_br_mask_1 = _T_102 & ~io_brupdate_b1_resolve_mask;	// @[decode.scala:785:20, util.scala:89:{21,23}]
  assign io_br_mask_2 = _T_104 & ~io_brupdate_b1_resolve_mask;	// @[decode.scala:785:20, util.scala:89:{21,23}]
