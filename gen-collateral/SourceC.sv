...
module SourceC(
  ...
  output [3:0]  io_evict_req_set,
  output [5:0]  io_evict_req_way
);
  ...
  reg  [17:0] req_r_tag;	// @[Reg.scala:19:16]
  reg  [3:0]  req_r_set;	// @[Reg.scala:19:16]
  reg  [5:0]  req_r_way;	// @[Reg.scala:19:16]
  wire [3:0]  req_set = busy ? req_r_set : io_req_bits_set;	// @[Reg.scala:19:16, SourceC.scala:66:21, :69:17]
  wire [5:0]  req_way = busy ? req_r_way : io_req_bits_way;	// @[Reg.scala:19:16, SourceC.scala:66:21, :69:17]
  ...
  reg  [17:0] s2_req_tag;	// @[Reg.scala:19:16]
  ...
  reg  [17:0] s3_req_tag;	// @[Reg.scala:19:16]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_r_tag = {_RANDOM_0[31:19], _RANDOM_1[4:0]};	// @[Reg.scala:19:16, SourceC.scala:58:21]
        req_r_set = _RANDOM_1[8:5];	// @[Reg.scala:19:16]
        req_r_way = _RANDOM_1[14:9];	// @[Reg.scala:19:16]
        ...
        s2_req_source = _RANDOM_1[26:23];	// @[Reg.scala:19:16]
        s2_req_tag = {_RANDOM_1[31:27], _RANDOM_2[12:0]};	// @[Reg.scala:19:16]
        s2_req_set = _RANDOM_2[16:13];	// @[Reg.scala:19:16]
        ...
        s3_req_source = _RANDOM_3[6:3];	// @[Reg.scala:19:16]
        s3_req_tag = _RANDOM_3[24:7];	// @[Reg.scala:19:16]
        s3_req_set = _RANDOM_3[28:25];	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
