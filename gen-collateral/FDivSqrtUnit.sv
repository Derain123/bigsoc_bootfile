  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_buffer_req_uop_rob_idx = {_RANDOM_6[31:30], _RANDOM_7[4:0]};	// @[fdiv.scala:96:25]
        r_buffer_req_uop_pdst = _RANDOM_7[23:17];	// @[fdiv.scala:96:25]
        r_buffer_req_uop_is_amo = _RANDOM_11[9];	// @[fdiv.scala:96:25]
        r_buffer_req_uop_uses_ldq = _RANDOM_11[10];	// @[fdiv.scala:96:25]
        r_buffer_req_uop_uses_stq = _RANDOM_11[11];	// @[fdiv.scala:96:25]
        r_buffer_req_uop_dst_rtype = _RANDOM_12[10:9];	// @[fdiv.scala:96:25]
        r_buffer_req_uop_fp_val = _RANDOM_12[16];	// @[fdiv.scala:96:25]
        r_buffer_fin_typeTagIn = _RANDOM_19[8:7];	// @[fdiv.scala:97:25]
        r_buffer_fin_div = _RANDOM_19[15];	// @[fdiv.scala:97:25]
        r_buffer_fin_sqrt = _RANDOM_19[16];	// @[fdiv.scala:97:25]
        r_buffer_fin_rm = _RANDOM_19[20:18];	// @[fdiv.scala:97:25]
        r_buffer_fin_in1 = {_RANDOM_19[31:27], _RANDOM_20, _RANDOM_21[27:0]};	// @[fdiv.scala:97:25]
        r_buffer_fin_in2 = {_RANDOM_21[31:28], _RANDOM_22, _RANDOM_23[28:0]};	// @[fdiv.scala:97:25]
        r_divsqrt_val = _RANDOM_25[30];	// @[fdiv.scala:143:30]
        r_divsqrt_killed = _RANDOM_25[31];	// @[fdiv.scala:143:30, :144:29]
        r_divsqrt_fin_typeTagIn = _RANDOM_26[8:7];	// @[fdiv.scala:145:26]
        r_divsqrt_fin_rm = _RANDOM_26[20:18];	// @[fdiv.scala:145:26]
        r_divsqrt_uop_br_mask = {_RANDOM_37[31:26], _RANDOM_38[9:0]};	// @[fdiv.scala:146:26]
        r_divsqrt_uop_rob_idx = {_RANDOM_39[31:27], _RANDOM_40[1:0]};	// @[fdiv.scala:146:26]
        r_divsqrt_uop_pdst = _RANDOM_40[20:14];	// @[fdiv.scala:146:26]
        r_divsqrt_uop_is_amo = _RANDOM_44[6];	// @[fdiv.scala:146:26]
        r_divsqrt_uop_uses_ldq = _RANDOM_44[7];	// @[fdiv.scala:146:26]
        r_divsqrt_uop_uses_stq = _RANDOM_44[8];	// @[fdiv.scala:146:26]
        r_divsqrt_uop_dst_rtype = _RANDOM_45[7:6];	// @[fdiv.scala:146:26]
        r_divsqrt_uop_fp_val = _RANDOM_45[13];	// @[fdiv.scala:146:26]
        r_out_val = _RANDOM_45[24];	// @[fdiv.scala:146:26, :182:26]
        r_out_uop_br_mask = {_RANDOM_50[31:21], _RANDOM_51[4:0]};	// @[fdiv.scala:183:22]
        r_out_uop_rob_idx = _RANDOM_52[28:22];	// @[fdiv.scala:183:22]
        r_out_uop_pdst = _RANDOM_53[15:9];	// @[fdiv.scala:183:22]
        r_out_uop_is_amo = _RANDOM_57[1];	// @[fdiv.scala:183:22]
        r_out_uop_uses_ldq = _RANDOM_57[2];	// @[fdiv.scala:183:22]
        r_out_uop_uses_stq = _RANDOM_57[3];	// @[fdiv.scala:183:22]
        r_out_uop_dst_rtype = _RANDOM_58[2:1];	// @[fdiv.scala:183:22]
        r_out_uop_fp_val = _RANDOM_58[8];	// @[fdiv.scala:183:22]
        r_out_flags_double = _RANDOM_58[23:19];	// @[fdiv.scala:183:22, :184:31]
        r_out_wdata_double = {_RANDOM_58[31:24], _RANDOM_59, _RANDOM_60[24:0]};	// @[fdiv.scala:183:22, :185:31]
      `endif // RANDOMIZE_REG_INIT
    end // initial
