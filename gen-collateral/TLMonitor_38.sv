  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_4 = `RANDOM;
        _RANDOM_5 = `RANDOM;
        d_first_counter = _RANDOM_1[27:19];	// @[Edges.scala:229:27]
        opcode_1 = _RANDOM_1[30:28];	// @[Edges.scala:229:27, Monitor.scala:535:22]
        param_1 = {_RANDOM_1[31], _RANDOM_2[0]};	// @[Edges.scala:229:27, Monitor.scala:536:22]
        ...
        d_first_counter_1 = {_RANDOM_2[31:30], _RANDOM_3[6:0]};	// @[Edges.scala:229:27, Monitor.scala:536:22]
        watchdog = {_RANDOM_3[31:7], _RANDOM_4[6:0]};	// @[Edges.scala:229:27, Monitor.scala:706:27]
        d_first_counter_2 = {_RANDOM_4[31:29], _RANDOM_5[5:0]};	// @[Edges.scala:229:27, Monitor.scala:706:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
