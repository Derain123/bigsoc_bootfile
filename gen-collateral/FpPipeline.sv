  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        fregfile_io_write_ports_0_REG_bits_addr = _RANDOM_0[17:11];	// @[fp-pipeline.scala:124:36, :185:40]
        fregfile_io_write_ports_0_REG_bits_data = {_RANDOM_0[31:18], _RANDOM_1, _RANDOM_2[18:0]};	// @[fp-pipeline.scala:124:36, :185:40]
      `endif // RANDOMIZE_REG_INIT
    end // initial
