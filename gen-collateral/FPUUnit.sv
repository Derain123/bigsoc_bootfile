...
module FPUUnit(
  ...
  reg  [6:0]  r_uops_0_rob_idx;	// @[functional-unit.scala:227:23]
  ...
  reg  [6:0]  r_uops_1_rob_idx;	// @[functional-unit.scala:227:23]
  ...
  reg  [6:0]  r_uops_2_rob_idx;	// @[functional-unit.scala:227:23]
  ...
  reg  [6:0]  r_uops_3_rob_idx;	// @[functional-unit.scala:227:23]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_uops_0_ftq_idx = _RANDOM_5[24:20];	// @[functional-unit.scala:227:23]
        r_uops_0_edge_inst = _RANDOM_5[25];	// @[functional-unit.scala:227:23]
        r_uops_0_pc_lob = _RANDOM_5[31:26];	// @[functional-unit.scala:227:23]
        r_uops_0_taken = _RANDOM_6[0];	// @[functional-unit.scala:227:23]
        r_uops_0_imm_packed = _RANDOM_6[20:1];	// @[functional-unit.scala:227:23]
        r_uops_0_csr_addr = {_RANDOM_6[31:21], _RANDOM_7[0]};	// @[functional-unit.scala:227:23]
        r_uops_0_rob_idx = _RANDOM_7[7:1];	// @[functional-unit.scala:227:23]
        ...
        r_uops_0_pdst = _RANDOM_7[26:20];	// @[functional-unit.scala:227:23]
        r_uops_0_prs1 = {_RANDOM_7[31:27], _RANDOM_8[1:0]};	// @[functional-unit.scala:227:23]
        r_uops_0_prs2 = _RANDOM_8[8:2];	// @[functional-unit.scala:227:23]
        r_uops_0_prs3 = _RANDOM_8[15:9];	// @[functional-unit.scala:227:23]
        r_uops_0_ppred = _RANDOM_8[20:16];	// @[functional-unit.scala:227:23]
        r_uops_0_prs1_busy = _RANDOM_8[21];	// @[functional-unit.scala:227:23]
        r_uops_0_prs2_busy = _RANDOM_8[22];	// @[functional-unit.scala:227:23]
        r_uops_0_prs3_busy = _RANDOM_8[23];	// @[functional-unit.scala:227:23]
        r_uops_0_ppred_busy = _RANDOM_8[24];	// @[functional-unit.scala:227:23]
        r_uops_0_stale_pdst = _RANDOM_8[31:25];	// @[functional-unit.scala:227:23]
        r_uops_0_exception = _RANDOM_9[0];	// @[functional-unit.scala:227:23]
        r_uops_0_exc_cause = {_RANDOM_9[31:1], _RANDOM_10, _RANDOM_11[0]};	// @[functional-unit.scala:227:23]
        r_uops_0_bypassable = _RANDOM_11[1];	// @[functional-unit.scala:227:23]
        r_uops_0_mem_cmd = _RANDOM_11[6:2];	// @[functional-unit.scala:227:23]
        r_uops_0_mem_size = _RANDOM_11[8:7];	// @[functional-unit.scala:227:23]
        r_uops_0_mem_signed = _RANDOM_11[9];	// @[functional-unit.scala:227:23]
        r_uops_0_is_fence = _RANDOM_11[10];	// @[functional-unit.scala:227:23]
        r_uops_0_is_fencei = _RANDOM_11[11];	// @[functional-unit.scala:227:23]
        r_uops_0_is_amo = _RANDOM_11[12];	// @[functional-unit.scala:227:23]
        r_uops_0_uses_ldq = _RANDOM_11[13];	// @[functional-unit.scala:227:23]
        r_uops_0_uses_stq = _RANDOM_11[14];	// @[functional-unit.scala:227:23]
        r_uops_0_is_sys_pc2epc = _RANDOM_11[15];	// @[functional-unit.scala:227:23]
        r_uops_0_is_unique = _RANDOM_11[16];	// @[functional-unit.scala:227:23]
        r_uops_0_flush_on_commit = _RANDOM_11[17];	// @[functional-unit.scala:227:23]
        r_uops_0_ldst_is_rs1 = _RANDOM_11[18];	// @[functional-unit.scala:227:23]
        r_uops_0_ldst = _RANDOM_11[24:19];	// @[functional-unit.scala:227:23]
        r_uops_0_lrs1 = _RANDOM_11[30:25];	// @[functional-unit.scala:227:23]
        r_uops_0_lrs2 = {_RANDOM_11[31], _RANDOM_12[4:0]};	// @[functional-unit.scala:227:23]
        r_uops_0_lrs3 = _RANDOM_12[10:5];	// @[functional-unit.scala:227:23]
        r_uops_0_ldst_val = _RANDOM_12[11];	// @[functional-unit.scala:227:23]
        r_uops_0_dst_rtype = _RANDOM_12[13:12];	// @[functional-unit.scala:227:23]
        r_uops_0_lrs1_rtype = _RANDOM_12[15:14];	// @[functional-unit.scala:227:23]
        r_uops_0_lrs2_rtype = _RANDOM_12[17:16];	// @[functional-unit.scala:227:23]
        r_uops_0_frs3_en = _RANDOM_12[18];	// @[functional-unit.scala:227:23]
        r_uops_0_fp_val = _RANDOM_12[19];	// @[functional-unit.scala:227:23]
        r_uops_0_fp_single = _RANDOM_12[20];	// @[functional-unit.scala:227:23]
        r_uops_0_xcpt_pf_if = _RANDOM_12[21];	// @[functional-unit.scala:227:23]
        r_uops_0_xcpt_ae_if = _RANDOM_12[22];	// @[functional-unit.scala:227:23]
        r_uops_0_xcpt_ma_if = _RANDOM_12[23];	// @[functional-unit.scala:227:23]
        r_uops_0_bp_debug_if = _RANDOM_12[24];	// @[functional-unit.scala:227:23]
        r_uops_0_bp_xcpt_if = _RANDOM_12[25];	// @[functional-unit.scala:227:23]
        r_uops_0_debug_fsrc = _RANDOM_12[27:26];	// @[functional-unit.scala:227:23]
        r_uops_0_debug_tsrc = _RANDOM_12[29:28];	// @[functional-unit.scala:227:23]
        r_uops_1_uopc = {_RANDOM_12[31:30], _RANDOM_13[4:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_inst = {_RANDOM_13[31:5], _RANDOM_14[4:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_debug_inst = {_RANDOM_14[31:5], _RANDOM_15[4:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_is_rvc = _RANDOM_15[5];	// @[functional-unit.scala:227:23]
        r_uops_1_debug_pc = {_RANDOM_15[31:6], _RANDOM_16[13:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_iq_type = _RANDOM_16[16:14];	// @[functional-unit.scala:227:23]
        r_uops_1_fu_code = _RANDOM_16[26:17];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_br_type = _RANDOM_16[30:27];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_op1_sel = {_RANDOM_16[31], _RANDOM_17[0]};	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_op2_sel = _RANDOM_17[3:1];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_imm_sel = _RANDOM_17[6:4];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_op_fcn = _RANDOM_17[10:7];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_fcn_dw = _RANDOM_17[11];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_csr_cmd = _RANDOM_17[14:12];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_is_load = _RANDOM_17[15];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_is_sta = _RANDOM_17[16];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_is_std = _RANDOM_17[17];	// @[functional-unit.scala:227:23]
        r_uops_1_iw_state = _RANDOM_17[19:18];	// @[functional-unit.scala:227:23]
        r_uops_1_iw_p1_poisoned = _RANDOM_17[20];	// @[functional-unit.scala:227:23]
        r_uops_1_iw_p2_poisoned = _RANDOM_17[21];	// @[functional-unit.scala:227:23]
        r_uops_1_is_br = _RANDOM_17[22];	// @[functional-unit.scala:227:23]
        r_uops_1_is_jalr = _RANDOM_17[23];	// @[functional-unit.scala:227:23]
        r_uops_1_is_jal = _RANDOM_17[24];	// @[functional-unit.scala:227:23]
        r_uops_1_is_sfb = _RANDOM_17[25];	// @[functional-unit.scala:227:23]
        r_uops_1_br_mask = {_RANDOM_17[31:26], _RANDOM_18[9:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_br_tag = _RANDOM_18[13:10];	// @[functional-unit.scala:227:23]
        r_uops_1_ftq_idx = _RANDOM_18[18:14];	// @[functional-unit.scala:227:23]
        r_uops_1_edge_inst = _RANDOM_18[19];	// @[functional-unit.scala:227:23]
        r_uops_1_pc_lob = _RANDOM_18[25:20];	// @[functional-unit.scala:227:23]
        r_uops_1_taken = _RANDOM_18[26];	// @[functional-unit.scala:227:23]
        r_uops_1_imm_packed = {_RANDOM_18[31:27], _RANDOM_19[14:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_csr_addr = _RANDOM_19[26:15];	// @[functional-unit.scala:227:23]
        r_uops_1_rob_idx = {_RANDOM_19[31:27], _RANDOM_20[1:0]};	// @[functional-unit.scala:227:23]
        ...
        r_uops_1_pdst = _RANDOM_20[20:14];	// @[functional-unit.scala:227:23]
        r_uops_1_prs1 = _RANDOM_20[27:21];	// @[functional-unit.scala:227:23]
        r_uops_1_prs2 = {_RANDOM_20[31:28], _RANDOM_21[2:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_prs3 = _RANDOM_21[9:3];	// @[functional-unit.scala:227:23]
        r_uops_1_ppred = _RANDOM_21[14:10];	// @[functional-unit.scala:227:23]
        r_uops_1_prs1_busy = _RANDOM_21[15];	// @[functional-unit.scala:227:23]
        r_uops_1_prs2_busy = _RANDOM_21[16];	// @[functional-unit.scala:227:23]
        r_uops_1_prs3_busy = _RANDOM_21[17];	// @[functional-unit.scala:227:23]
        r_uops_1_ppred_busy = _RANDOM_21[18];	// @[functional-unit.scala:227:23]
        r_uops_1_stale_pdst = _RANDOM_21[25:19];	// @[functional-unit.scala:227:23]
        r_uops_1_exception = _RANDOM_21[26];	// @[functional-unit.scala:227:23]
        r_uops_1_exc_cause = {_RANDOM_21[31:27], _RANDOM_22, _RANDOM_23[26:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_bypassable = _RANDOM_23[27];	// @[functional-unit.scala:227:23]
        r_uops_1_mem_cmd = {_RANDOM_23[31:28], _RANDOM_24[0]};	// @[functional-unit.scala:227:23]
        r_uops_1_mem_size = _RANDOM_24[2:1];	// @[functional-unit.scala:227:23]
        r_uops_1_mem_signed = _RANDOM_24[3];	// @[functional-unit.scala:227:23]
        r_uops_1_is_fence = _RANDOM_24[4];	// @[functional-unit.scala:227:23]
        r_uops_1_is_fencei = _RANDOM_24[5];	// @[functional-unit.scala:227:23]
        r_uops_1_is_amo = _RANDOM_24[6];	// @[functional-unit.scala:227:23]
        r_uops_1_uses_ldq = _RANDOM_24[7];	// @[functional-unit.scala:227:23]
        r_uops_1_uses_stq = _RANDOM_24[8];	// @[functional-unit.scala:227:23]
        r_uops_1_is_sys_pc2epc = _RANDOM_24[9];	// @[functional-unit.scala:227:23]
        r_uops_1_is_unique = _RANDOM_24[10];	// @[functional-unit.scala:227:23]
        r_uops_1_flush_on_commit = _RANDOM_24[11];	// @[functional-unit.scala:227:23]
        r_uops_1_ldst_is_rs1 = _RANDOM_24[12];	// @[functional-unit.scala:227:23]
        r_uops_1_ldst = _RANDOM_24[18:13];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs1 = _RANDOM_24[24:19];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs2 = _RANDOM_24[30:25];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs3 = {_RANDOM_24[31], _RANDOM_25[4:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_ldst_val = _RANDOM_25[5];	// @[functional-unit.scala:227:23]
        r_uops_1_dst_rtype = _RANDOM_25[7:6];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs1_rtype = _RANDOM_25[9:8];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs2_rtype = _RANDOM_25[11:10];	// @[functional-unit.scala:227:23]
        r_uops_1_frs3_en = _RANDOM_25[12];	// @[functional-unit.scala:227:23]
        r_uops_1_fp_val = _RANDOM_25[13];	// @[functional-unit.scala:227:23]
        r_uops_1_fp_single = _RANDOM_25[14];	// @[functional-unit.scala:227:23]
        r_uops_1_xcpt_pf_if = _RANDOM_25[15];	// @[functional-unit.scala:227:23]
        r_uops_1_xcpt_ae_if = _RANDOM_25[16];	// @[functional-unit.scala:227:23]
        r_uops_1_xcpt_ma_if = _RANDOM_25[17];	// @[functional-unit.scala:227:23]
        r_uops_1_bp_debug_if = _RANDOM_25[18];	// @[functional-unit.scala:227:23]
        r_uops_1_bp_xcpt_if = _RANDOM_25[19];	// @[functional-unit.scala:227:23]
        r_uops_1_debug_fsrc = _RANDOM_25[21:20];	// @[functional-unit.scala:227:23]
        r_uops_1_debug_tsrc = _RANDOM_25[23:22];	// @[functional-unit.scala:227:23]
        r_uops_2_uopc = _RANDOM_25[30:24];	// @[functional-unit.scala:227:23]
        r_uops_2_inst = {_RANDOM_25[31], _RANDOM_26[30:0]};	// @[functional-unit.scala:227:23]
        r_uops_2_debug_inst = {_RANDOM_26[31], _RANDOM_27[30:0]};	// @[functional-unit.scala:227:23]
        r_uops_2_is_rvc = _RANDOM_27[31];	// @[functional-unit.scala:227:23]
        r_uops_2_debug_pc = {_RANDOM_28, _RANDOM_29[7:0]};	// @[functional-unit.scala:227:23]
        r_uops_2_iq_type = _RANDOM_29[10:8];	// @[functional-unit.scala:227:23]
        r_uops_2_fu_code = _RANDOM_29[20:11];	// @[functional-unit.scala:227:23]
        r_uops_2_ctrl_br_type = _RANDOM_29[24:21];	// @[functional-unit.scala:227:23]
        r_uops_2_ctrl_op1_sel = _RANDOM_29[26:25];	// @[functional-unit.scala:227:23]
        r_uops_2_ctrl_op2_sel = _RANDOM_29[29:27];	// @[functional-unit.scala:227:23]
        r_uops_2_ctrl_imm_sel = {_RANDOM_29[31:30], _RANDOM_30[0]};	// @[functional-unit.scala:227:23]
        r_uops_2_ctrl_op_fcn = _RANDOM_30[4:1];	// @[functional-unit.scala:227:23]
        r_uops_2_ctrl_fcn_dw = _RANDOM_30[5];	// @[functional-unit.scala:227:23]
        r_uops_2_ctrl_csr_cmd = _RANDOM_30[8:6];	// @[functional-unit.scala:227:23]
        r_uops_2_ctrl_is_load = _RANDOM_30[9];	// @[functional-unit.scala:227:23]
        r_uops_2_ctrl_is_sta = _RANDOM_30[10];	// @[functional-unit.scala:227:23]
        r_uops_2_ctrl_is_std = _RANDOM_30[11];	// @[functional-unit.scala:227:23]
        r_uops_2_iw_state = _RANDOM_30[13:12];	// @[functional-unit.scala:227:23]
        r_uops_2_iw_p1_poisoned = _RANDOM_30[14];	// @[functional-unit.scala:227:23]
        r_uops_2_iw_p2_poisoned = _RANDOM_30[15];	// @[functional-unit.scala:227:23]
        r_uops_2_is_br = _RANDOM_30[16];	// @[functional-unit.scala:227:23]
        r_uops_2_is_jalr = _RANDOM_30[17];	// @[functional-unit.scala:227:23]
        r_uops_2_is_jal = _RANDOM_30[18];	// @[functional-unit.scala:227:23]
        r_uops_2_is_sfb = _RANDOM_30[19];	// @[functional-unit.scala:227:23]
        r_uops_2_br_mask = {_RANDOM_30[31:20], _RANDOM_31[3:0]};	// @[functional-unit.scala:227:23]
        r_uops_2_br_tag = _RANDOM_31[7:4];	// @[functional-unit.scala:227:23]
        r_uops_2_ftq_idx = _RANDOM_31[12:8];	// @[functional-unit.scala:227:23]
        r_uops_2_edge_inst = _RANDOM_31[13];	// @[functional-unit.scala:227:23]
        r_uops_2_pc_lob = _RANDOM_31[19:14];	// @[functional-unit.scala:227:23]
        r_uops_2_taken = _RANDOM_31[20];	// @[functional-unit.scala:227:23]
        r_uops_2_imm_packed = {_RANDOM_31[31:21], _RANDOM_32[8:0]};	// @[functional-unit.scala:227:23]
        r_uops_2_csr_addr = _RANDOM_32[20:9];	// @[functional-unit.scala:227:23]
        r_uops_2_rob_idx = _RANDOM_32[27:21];	// @[functional-unit.scala:227:23]
        r_uops_2_ldq_idx = {_RANDOM_32[31:28], _RANDOM_33[0]};	// @[functional-unit.scala:227:23]
        r_uops_2_stq_idx = _RANDOM_33[5:1];	// @[functional-unit.scala:227:23]
        r_uops_2_rxq_idx = _RANDOM_33[7:6];	// @[functional-unit.scala:227:23]
        r_uops_2_pdst = _RANDOM_33[14:8];	// @[functional-unit.scala:227:23]
        r_uops_2_prs1 = _RANDOM_33[21:15];	// @[functional-unit.scala:227:23]
        r_uops_2_prs2 = _RANDOM_33[28:22];	// @[functional-unit.scala:227:23]
        r_uops_2_prs3 = {_RANDOM_33[31:29], _RANDOM_34[3:0]};	// @[functional-unit.scala:227:23]
        r_uops_2_ppred = _RANDOM_34[8:4];	// @[functional-unit.scala:227:23]
        r_uops_2_prs1_busy = _RANDOM_34[9];	// @[functional-unit.scala:227:23]
        r_uops_2_prs2_busy = _RANDOM_34[10];	// @[functional-unit.scala:227:23]
        r_uops_2_prs3_busy = _RANDOM_34[11];	// @[functional-unit.scala:227:23]
        r_uops_2_ppred_busy = _RANDOM_34[12];	// @[functional-unit.scala:227:23]
        r_uops_2_stale_pdst = _RANDOM_34[19:13];	// @[functional-unit.scala:227:23]
        r_uops_2_exception = _RANDOM_34[20];	// @[functional-unit.scala:227:23]
        r_uops_2_exc_cause = {_RANDOM_34[31:21], _RANDOM_35, _RANDOM_36[20:0]};	// @[functional-unit.scala:227:23]
        r_uops_2_bypassable = _RANDOM_36[21];	// @[functional-unit.scala:227:23]
        r_uops_2_mem_cmd = _RANDOM_36[26:22];	// @[functional-unit.scala:227:23]
        r_uops_2_mem_size = _RANDOM_36[28:27];	// @[functional-unit.scala:227:23]
        r_uops_2_mem_signed = _RANDOM_36[29];	// @[functional-unit.scala:227:23]
        r_uops_2_is_fence = _RANDOM_36[30];	// @[functional-unit.scala:227:23]
        r_uops_2_is_fencei = _RANDOM_36[31];	// @[functional-unit.scala:227:23]
        r_uops_2_is_amo = _RANDOM_37[0];	// @[functional-unit.scala:227:23]
        r_uops_2_uses_ldq = _RANDOM_37[1];	// @[functional-unit.scala:227:23]
        r_uops_2_uses_stq = _RANDOM_37[2];	// @[functional-unit.scala:227:23]
        r_uops_2_is_sys_pc2epc = _RANDOM_37[3];	// @[functional-unit.scala:227:23]
        r_uops_2_is_unique = _RANDOM_37[4];	// @[functional-unit.scala:227:23]
        r_uops_2_flush_on_commit = _RANDOM_37[5];	// @[functional-unit.scala:227:23]
        r_uops_2_ldst_is_rs1 = _RANDOM_37[6];	// @[functional-unit.scala:227:23]
        r_uops_2_ldst = _RANDOM_37[12:7];	// @[functional-unit.scala:227:23]
        r_uops_2_lrs1 = _RANDOM_37[18:13];	// @[functional-unit.scala:227:23]
        r_uops_2_lrs2 = _RANDOM_37[24:19];	// @[functional-unit.scala:227:23]
        r_uops_2_lrs3 = _RANDOM_37[30:25];	// @[functional-unit.scala:227:23]
        r_uops_2_ldst_val = _RANDOM_37[31];	// @[functional-unit.scala:227:23]
        r_uops_2_dst_rtype = _RANDOM_38[1:0];	// @[functional-unit.scala:227:23]
        r_uops_2_lrs1_rtype = _RANDOM_38[3:2];	// @[functional-unit.scala:227:23]
        r_uops_2_lrs2_rtype = _RANDOM_38[5:4];	// @[functional-unit.scala:227:23]
        r_uops_2_frs3_en = _RANDOM_38[6];	// @[functional-unit.scala:227:23]
        r_uops_2_fp_val = _RANDOM_38[7];	// @[functional-unit.scala:227:23]
        r_uops_2_fp_single = _RANDOM_38[8];	// @[functional-unit.scala:227:23]
        r_uops_2_xcpt_pf_if = _RANDOM_38[9];	// @[functional-unit.scala:227:23]
        r_uops_2_xcpt_ae_if = _RANDOM_38[10];	// @[functional-unit.scala:227:23]
        r_uops_2_xcpt_ma_if = _RANDOM_38[11];	// @[functional-unit.scala:227:23]
        r_uops_2_bp_debug_if = _RANDOM_38[12];	// @[functional-unit.scala:227:23]
        r_uops_2_bp_xcpt_if = _RANDOM_38[13];	// @[functional-unit.scala:227:23]
        r_uops_2_debug_fsrc = _RANDOM_38[15:14];	// @[functional-unit.scala:227:23]
        r_uops_2_debug_tsrc = _RANDOM_38[17:16];	// @[functional-unit.scala:227:23]
        r_uops_3_uopc = _RANDOM_38[24:18];	// @[functional-unit.scala:227:23]
        r_uops_3_inst = {_RANDOM_38[31:25], _RANDOM_39[24:0]};	// @[functional-unit.scala:227:23]
        r_uops_3_debug_inst = {_RANDOM_39[31:25], _RANDOM_40[24:0]};	// @[functional-unit.scala:227:23]
        r_uops_3_is_rvc = _RANDOM_40[25];	// @[functional-unit.scala:227:23]
        r_uops_3_debug_pc = {_RANDOM_40[31:26], _RANDOM_41, _RANDOM_42[1:0]};	// @[functional-unit.scala:227:23]
        r_uops_3_iq_type = _RANDOM_42[4:2];	// @[functional-unit.scala:227:23]
        r_uops_3_fu_code = _RANDOM_42[14:5];	// @[functional-unit.scala:227:23]
        r_uops_3_ctrl_br_type = _RANDOM_42[18:15];	// @[functional-unit.scala:227:23]
        r_uops_3_ctrl_op1_sel = _RANDOM_42[20:19];	// @[functional-unit.scala:227:23]
        r_uops_3_ctrl_op2_sel = _RANDOM_42[23:21];	// @[functional-unit.scala:227:23]
        r_uops_3_ctrl_imm_sel = _RANDOM_42[26:24];	// @[functional-unit.scala:227:23]
        r_uops_3_ctrl_op_fcn = _RANDOM_42[30:27];	// @[functional-unit.scala:227:23]
        r_uops_3_ctrl_fcn_dw = _RANDOM_42[31];	// @[functional-unit.scala:227:23]
        r_uops_3_ctrl_csr_cmd = _RANDOM_43[2:0];	// @[functional-unit.scala:227:23]
        r_uops_3_ctrl_is_load = _RANDOM_43[3];	// @[functional-unit.scala:227:23]
        r_uops_3_ctrl_is_sta = _RANDOM_43[4];	// @[functional-unit.scala:227:23]
        r_uops_3_ctrl_is_std = _RANDOM_43[5];	// @[functional-unit.scala:227:23]
        r_uops_3_iw_state = _RANDOM_43[7:6];	// @[functional-unit.scala:227:23]
        r_uops_3_iw_p1_poisoned = _RANDOM_43[8];	// @[functional-unit.scala:227:23]
        r_uops_3_iw_p2_poisoned = _RANDOM_43[9];	// @[functional-unit.scala:227:23]
        r_uops_3_is_br = _RANDOM_43[10];	// @[functional-unit.scala:227:23]
        r_uops_3_is_jalr = _RANDOM_43[11];	// @[functional-unit.scala:227:23]
        r_uops_3_is_jal = _RANDOM_43[12];	// @[functional-unit.scala:227:23]
        r_uops_3_is_sfb = _RANDOM_43[13];	// @[functional-unit.scala:227:23]
        r_uops_3_br_mask = _RANDOM_43[29:14];	// @[functional-unit.scala:227:23]
        r_uops_3_br_tag = {_RANDOM_43[31:30], _RANDOM_44[1:0]};	// @[functional-unit.scala:227:23]
        r_uops_3_ftq_idx = _RANDOM_44[6:2];	// @[functional-unit.scala:227:23]
        r_uops_3_edge_inst = _RANDOM_44[7];	// @[functional-unit.scala:227:23]
        r_uops_3_pc_lob = _RANDOM_44[13:8];	// @[functional-unit.scala:227:23]
        r_uops_3_taken = _RANDOM_44[14];	// @[functional-unit.scala:227:23]
        r_uops_3_imm_packed = {_RANDOM_44[31:15], _RANDOM_45[2:0]};	// @[functional-unit.scala:227:23]
        r_uops_3_csr_addr = _RANDOM_45[14:3];	// @[functional-unit.scala:227:23]
        r_uops_3_rob_idx = _RANDOM_45[21:15];	// @[functional-unit.scala:227:23]
        r_uops_3_ldq_idx = _RANDOM_45[26:22];	// @[functional-unit.scala:227:23]
        r_uops_3_stq_idx = _RANDOM_45[31:27];	// @[functional-unit.scala:227:23]
        r_uops_3_rxq_idx = _RANDOM_46[1:0];	// @[functional-unit.scala:227:23]
        r_uops_3_pdst = _RANDOM_46[8:2];	// @[functional-unit.scala:227:23]
        r_uops_3_prs1 = _RANDOM_46[15:9];	// @[functional-unit.scala:227:23]
        r_uops_3_prs2 = _RANDOM_46[22:16];	// @[functional-unit.scala:227:23]
        r_uops_3_prs3 = _RANDOM_46[29:23];	// @[functional-unit.scala:227:23]
        r_uops_3_ppred = {_RANDOM_46[31:30], _RANDOM_47[2:0]};	// @[functional-unit.scala:227:23]
        r_uops_3_prs1_busy = _RANDOM_47[3];	// @[functional-unit.scala:227:23]
        r_uops_3_prs2_busy = _RANDOM_47[4];	// @[functional-unit.scala:227:23]
        r_uops_3_prs3_busy = _RANDOM_47[5];	// @[functional-unit.scala:227:23]
        r_uops_3_ppred_busy = _RANDOM_47[6];	// @[functional-unit.scala:227:23]
        r_uops_3_stale_pdst = _RANDOM_47[13:7];	// @[functional-unit.scala:227:23]
        r_uops_3_exception = _RANDOM_47[14];	// @[functional-unit.scala:227:23]
        r_uops_3_exc_cause = {_RANDOM_47[31:15], _RANDOM_48, _RANDOM_49[14:0]};	// @[functional-unit.scala:227:23]
        r_uops_3_bypassable = _RANDOM_49[15];	// @[functional-unit.scala:227:23]
        r_uops_3_mem_cmd = _RANDOM_49[20:16];	// @[functional-unit.scala:227:23]
        r_uops_3_mem_size = _RANDOM_49[22:21];	// @[functional-unit.scala:227:23]
        r_uops_3_mem_signed = _RANDOM_49[23];	// @[functional-unit.scala:227:23]
        r_uops_3_is_fence = _RANDOM_49[24];	// @[functional-unit.scala:227:23]
        r_uops_3_is_fencei = _RANDOM_49[25];	// @[functional-unit.scala:227:23]
        r_uops_3_is_amo = _RANDOM_49[26];	// @[functional-unit.scala:227:23]
        r_uops_3_uses_ldq = _RANDOM_49[27];	// @[functional-unit.scala:227:23]
        r_uops_3_uses_stq = _RANDOM_49[28];	// @[functional-unit.scala:227:23]
        r_uops_3_is_sys_pc2epc = _RANDOM_49[29];	// @[functional-unit.scala:227:23]
        r_uops_3_is_unique = _RANDOM_49[30];	// @[functional-unit.scala:227:23]
        r_uops_3_flush_on_commit = _RANDOM_49[31];	// @[functional-unit.scala:227:23]
        r_uops_3_ldst_is_rs1 = _RANDOM_50[0];	// @[functional-unit.scala:227:23]
        r_uops_3_ldst = _RANDOM_50[6:1];	// @[functional-unit.scala:227:23]
        r_uops_3_lrs1 = _RANDOM_50[12:7];	// @[functional-unit.scala:227:23]
        r_uops_3_lrs2 = _RANDOM_50[18:13];	// @[functional-unit.scala:227:23]
        r_uops_3_lrs3 = _RANDOM_50[24:19];	// @[functional-unit.scala:227:23]
        r_uops_3_ldst_val = _RANDOM_50[25];	// @[functional-unit.scala:227:23]
        r_uops_3_dst_rtype = _RANDOM_50[27:26];	// @[functional-unit.scala:227:23]
        r_uops_3_lrs1_rtype = _RANDOM_50[29:28];	// @[functional-unit.scala:227:23]
        r_uops_3_lrs2_rtype = _RANDOM_50[31:30];	// @[functional-unit.scala:227:23]
        r_uops_3_frs3_en = _RANDOM_51[0];	// @[functional-unit.scala:227:23]
        r_uops_3_fp_val = _RANDOM_51[1];	// @[functional-unit.scala:227:23]
        r_uops_3_fp_single = _RANDOM_51[2];	// @[functional-unit.scala:227:23]
        r_uops_3_xcpt_pf_if = _RANDOM_51[3];	// @[functional-unit.scala:227:23]
        r_uops_3_xcpt_ae_if = _RANDOM_51[4];	// @[functional-unit.scala:227:23]
        r_uops_3_xcpt_ma_if = _RANDOM_51[5];	// @[functional-unit.scala:227:23]
        r_uops_3_bp_debug_if = _RANDOM_51[6];	// @[functional-unit.scala:227:23]
        r_uops_3_bp_xcpt_if = _RANDOM_51[7];	// @[functional-unit.scala:227:23]
        r_uops_3_debug_fsrc = _RANDOM_51[9:8];	// @[functional-unit.scala:227:23]
        r_uops_3_debug_tsrc = _RANDOM_51[11:10];	// @[functional-unit.scala:227:23]
      `endif // RANDOMIZE_REG_INIT
    end // initial
