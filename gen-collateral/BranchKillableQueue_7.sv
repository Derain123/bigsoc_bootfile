...
module BranchKillableQueue_7(
  ...
  wire [3:0][6:0]  _GEN_3 = {{uops_0_rob_idx}, {uops_2_rob_idx}, {uops_1_rob_idx}, {uops_0_rob_idx}};	// @[util.scala:466:20, :508:19]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uops_0_rob_idx = _RANDOM_7[6:0];	// @[util.scala:466:20]
        uops_0_stq_idx = _RANDOM_7[16:12];	// @[util.scala:466:20]
        uops_0_pdst = _RANDOM_7[25:19];	// @[util.scala:466:20]
        ...
        uops_1_rob_idx = {_RANDOM_19[31:26], _RANDOM_20[0]};	// @[util.scala:466:20]
        uops_1_stq_idx = _RANDOM_20[10:6];	// @[util.scala:466:20]
        uops_1_pdst = _RANDOM_20[19:13];	// @[util.scala:466:20]
        ...
        uops_2_rob_idx = _RANDOM_32[26:20];	// @[util.scala:466:20]
        uops_2_stq_idx = _RANDOM_33[4:0];	// @[util.scala:466:20]
        uops_2_pdst = _RANDOM_33[13:7];	// @[util.scala:466:20]
        uops_2_is_amo = _RANDOM_36[31];	// @[util.scala:466:20]
        uops_2_uses_stq = _RANDOM_37[1];	// @[util.scala:466:20]
        uops_2_dst_rtype = {_RANDOM_37[31], _RANDOM_38[0]};	// @[util.scala:466:20]
        uops_2_fp_val = _RANDOM_38[6];	// @[util.scala:466:20]
        enq_ptr_value = _RANDOM_38[18:17];	// @[Counter.scala:61:40, util.scala:466:20]
        deq_ptr_value = _RANDOM_38[20:19];	// @[Counter.scala:61:40, util.scala:466:20]
        maybe_full = _RANDOM_38[21];	// @[util.scala:466:20, :470:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_combMem_43 ram_ext (	// @[util.scala:464:20]
  ...
  assign io_deq_bits_fflags_valid = ~_io_empty_output & _ram_ext_R0_data[476];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_fflags_bits_uop_rob_idx = _io_empty_output ? 7'h0 : _ram_ext_R0_data[704:698];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_fflags_bits_flags = _io_empty_output ? 5'h0 : _ram_ext_R0_data[891:887];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
