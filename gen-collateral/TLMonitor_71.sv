...
module TLMonitor_71(
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_11 = _T_1107 & ~io_in_a_valid;	// @[Monitor.scala:680:71, :684:30]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_4 = `RANDOM;
        _RANDOM_5 = `RANDOM;
        d_first_counter = _RANDOM_1[26:19];	// @[Edges.scala:229:27]
        opcode_1 = _RANDOM_1[29:27];	// @[Edges.scala:229:27, Monitor.scala:535:22]
        param_1 = _RANDOM_1[31:30];	// @[Edges.scala:229:27, Monitor.scala:536:22]
