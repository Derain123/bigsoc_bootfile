...
module IssueSlot_24(
  ...
  wire        _T_85 = io_spec_ld_wakeup_0_valid & io_spec_ld_wakeup_0_bits == next_uop_prs1 & (io_in_uop_valid ? io_in_uop_bits_lrs1_rtype : slot_uop_lrs1_rtype) == 2'h0;	// @[issue-slot.scala:86:22, :102:25, :103:21, :210:{33,51}, :211:27]
  wire        _T_93 = io_spec_ld_wakeup_0_valid & io_spec_ld_wakeup_0_bits == next_uop_prs2 & (io_in_uop_valid ? io_in_uop_bits_lrs2_rtype : slot_uop_lrs2_rtype) == 2'h0;	// @[issue-slot.scala:86:22, :102:25, :103:21, :217:{33,51}, :218:27]
  ...
  wire        _T_103 = state == 2'h2;	// @[consts.scala:277:20, issue-slot.scala:86:22, :260:65]
  wire        _T_105 = p1 & p2 & ppred;	// @[issue-slot.scala:87:22, :88:22, :90:22, :278:20]
  wire        _T_106 = p1 & ppred;	// @[issue-slot.scala:87:22, :90:22, :280:21]
  wire        _GEN_4 = ~_T_103 | _T_105 | _T_106 | ~(p2 & ppred);	// @[issue-slot.scala:88:22, :90:22, :255:10, :260:65, :277:30, :278:{20,30}, :280:{21,31}, :281:19, :283:{21,31}]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      p1_poisoned <= _T_85;	// @[issue-slot.scala:95:28, :210:51]
      p2_poisoned <= _T_93;	// @[issue-slot.scala:96:28, :217:51]
    end
    if (io_in_uop_valid) begin
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[issue-slot.scala:156:12]
      ...
      if (_T_85 & ~reset & next_p1_poisoned) begin	// @[issue-slot.scala:99:29, :210:51, :214:14]
      ...
      if (_T_93 & ~reset & next_p2_poisoned) begin	// @[issue-slot.scala:100:29, :217:51, :221:14]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        slot_uop_ftq_idx = _RANDOM_5[28:24];	// @[issue-slot.scala:102:25]
        slot_uop_edge_inst = _RANDOM_5[29];	// @[issue-slot.scala:102:25]
        slot_uop_pc_lob = {_RANDOM_5[31:30], _RANDOM_6[3:0]};	// @[issue-slot.scala:102:25]
        slot_uop_taken = _RANDOM_6[4];	// @[issue-slot.scala:102:25]
        slot_uop_imm_packed = _RANDOM_6[24:5];	// @[issue-slot.scala:102:25]
        slot_uop_csr_addr = {_RANDOM_6[31:25], _RANDOM_7[4:0]};	// @[issue-slot.scala:102:25]
        slot_uop_rob_idx = _RANDOM_7[11:5];	// @[issue-slot.scala:102:25]
        slot_uop_ldq_idx = _RANDOM_7[16:12];	// @[issue-slot.scala:102:25]
        slot_uop_stq_idx = _RANDOM_7[21:17];	// @[issue-slot.scala:102:25]
        slot_uop_rxq_idx = _RANDOM_7[23:22];	// @[issue-slot.scala:102:25]
        slot_uop_pdst = _RANDOM_7[30:24];	// @[issue-slot.scala:102:25]
        slot_uop_prs1 = {_RANDOM_7[31], _RANDOM_8[5:0]};	// @[issue-slot.scala:102:25]
        slot_uop_prs2 = _RANDOM_8[12:6];	// @[issue-slot.scala:102:25]
        slot_uop_prs3 = _RANDOM_8[19:13];	// @[issue-slot.scala:102:25]
        slot_uop_ppred = _RANDOM_8[24:20];	// @[issue-slot.scala:102:25]
        slot_uop_prs1_busy = _RANDOM_8[25];	// @[issue-slot.scala:102:25]
        slot_uop_prs2_busy = _RANDOM_8[26];	// @[issue-slot.scala:102:25]
        slot_uop_prs3_busy = _RANDOM_8[27];	// @[issue-slot.scala:102:25]
        slot_uop_ppred_busy = _RANDOM_8[28];	// @[issue-slot.scala:102:25]
        slot_uop_stale_pdst = {_RANDOM_8[31:29], _RANDOM_9[3:0]};	// @[issue-slot.scala:102:25]
        slot_uop_exception = _RANDOM_9[4];	// @[issue-slot.scala:102:25]
        slot_uop_exc_cause = {_RANDOM_9[31:5], _RANDOM_10, _RANDOM_11[4:0]};	// @[issue-slot.scala:102:25]
        slot_uop_bypassable = _RANDOM_11[5];	// @[issue-slot.scala:102:25]
        slot_uop_mem_cmd = _RANDOM_11[10:6];	// @[issue-slot.scala:102:25]
        slot_uop_mem_size = _RANDOM_11[12:11];	// @[issue-slot.scala:102:25]
        slot_uop_mem_signed = _RANDOM_11[13];	// @[issue-slot.scala:102:25]
        slot_uop_is_fence = _RANDOM_11[14];	// @[issue-slot.scala:102:25]
        slot_uop_is_fencei = _RANDOM_11[15];	// @[issue-slot.scala:102:25]
        slot_uop_is_amo = _RANDOM_11[16];	// @[issue-slot.scala:102:25]
        slot_uop_uses_ldq = _RANDOM_11[17];	// @[issue-slot.scala:102:25]
        slot_uop_uses_stq = _RANDOM_11[18];	// @[issue-slot.scala:102:25]
        slot_uop_is_sys_pc2epc = _RANDOM_11[19];	// @[issue-slot.scala:102:25]
        slot_uop_is_unique = _RANDOM_11[20];	// @[issue-slot.scala:102:25]
        slot_uop_flush_on_commit = _RANDOM_11[21];	// @[issue-slot.scala:102:25]
        slot_uop_ldst_is_rs1 = _RANDOM_11[22];	// @[issue-slot.scala:102:25]
        slot_uop_ldst = _RANDOM_11[28:23];	// @[issue-slot.scala:102:25]
        slot_uop_lrs1 = {_RANDOM_11[31:29], _RANDOM_12[2:0]};	// @[issue-slot.scala:102:25]
        slot_uop_lrs2 = _RANDOM_12[8:3];	// @[issue-slot.scala:102:25]
        slot_uop_lrs3 = _RANDOM_12[14:9];	// @[issue-slot.scala:102:25]
        slot_uop_ldst_val = _RANDOM_12[15];	// @[issue-slot.scala:102:25]
        slot_uop_dst_rtype = _RANDOM_12[17:16];	// @[issue-slot.scala:102:25]
        slot_uop_lrs1_rtype = _RANDOM_12[19:18];	// @[issue-slot.scala:102:25]
        slot_uop_lrs2_rtype = _RANDOM_12[21:20];	// @[issue-slot.scala:102:25]
        slot_uop_frs3_en = _RANDOM_12[22];	// @[issue-slot.scala:102:25]
        slot_uop_fp_val = _RANDOM_12[23];	// @[issue-slot.scala:102:25]
        slot_uop_fp_single = _RANDOM_12[24];	// @[issue-slot.scala:102:25]
        slot_uop_xcpt_pf_if = _RANDOM_12[25];	// @[issue-slot.scala:102:25]
        slot_uop_xcpt_ae_if = _RANDOM_12[26];	// @[issue-slot.scala:102:25]
        slot_uop_xcpt_ma_if = _RANDOM_12[27];	// @[issue-slot.scala:102:25]
        slot_uop_bp_debug_if = _RANDOM_12[28];	// @[issue-slot.scala:102:25]
        slot_uop_bp_xcpt_if = _RANDOM_12[29];	// @[issue-slot.scala:102:25]
        slot_uop_debug_fsrc = _RANDOM_12[31:30];	// @[issue-slot.scala:102:25]
        slot_uop_debug_tsrc = _RANDOM_13[1:0];	// @[issue-slot.scala:102:25]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_will_be_valid = (|state) & ~(io_grant & (_may_vacate_T | _T_103 & p1 & p2 & ppred) & ~(io_ldspec_miss & (p1_poisoned | p2_poisoned)));	// @[issue-slot.scala:79:24, :86:22, :87:22, :88:22, :90:22, :95:28, :96:28, :245:15, :260:{55,65,92}, :261:{37,53}, :262:{32,35,48,51}]
  ...
  assign io_uop_lrs2_rtype = ~_T_103 | _T_105 | ~_T_106 ? slot_uop_lrs2_rtype : 2'h2;	// @[consts.scala:277:20, issue-slot.scala:102:25, :255:10, :260:65, :277:30, :278:{20,30}, :280:{21,31}]
