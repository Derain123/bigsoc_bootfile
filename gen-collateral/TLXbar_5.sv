...
module TLXbar_5(
  ...
  input  [7:0]  auto_out_7_d_bits_source,
  ...
  output [7:0]  auto_out_7_a_bits_source,
  ...
  wire        requestAIO_0_0 = {auto_in_a_bits_address[30], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13] ^ 2'h1} == 7'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire [10:0] _GEN = auto_in_a_bits_address[26:16] ^ 11'h201;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_1 = {auto_in_a_bits_address[30], _GEN[10:9], auto_in_a_bits_address[20], _GEN[0], auto_in_a_bits_address[14:13]} == 7'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire [5:0]  _GEN_0 = auto_in_a_bits_address[30:25] ^ 6'h22;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_2 = {auto_in_a_bits_address[30], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13] ^ 2'h2} == 7'h0 | {_GEN_0[5], _GEN_0[1:0], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13]} == 7'h0;	// @[Parameters.scala:137:{31,45,65}, Xbar.scala:366:92]
  ...
  wire        requestAIO_0_5 = {auto_in_a_bits_address[30], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13]} == 7'h0;	// @[Parameters.scala:137:{45,65}]
  ...
  wire [7:0]  out_27_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 8'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 8'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_source : 8'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_source : 8'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_source : 8'h0) | (muxStateEarly_5 ? auto_out_5_d_bits_source : 8'h0) | (muxStateEarly_6 ? auto_out_6_d_bits_source : 8'h0) | (muxStateEarly_7 ? auto_out_7_d_bits_source : 8'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      readys_mask <= 8'hFF;	// @[Arbiter.scala:24:23, Parameters.scala:57:20]
      ...
      if (latch)	// @[Arbiter.scala:90:24]
        ...
        beatsLeft <= beatsLeft - {8'h0, auto_in_d_ready & out_27_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, Bundles.scala:259:74, ReadyValidCancel.scala:49:33]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readys_mask = _RANDOM_0[16:9];	// @[Arbiter.scala:24:23, :88:30]
        state_0 = _RANDOM_0[17];	// @[Arbiter.scala:88:30, :117:26]
        state_1 = _RANDOM_0[18];	// @[Arbiter.scala:88:30, :117:26]
        state_2 = _RANDOM_0[19];	// @[Arbiter.scala:88:30, :117:26]
        state_3 = _RANDOM_0[20];	// @[Arbiter.scala:88:30, :117:26]
        state_4 = _RANDOM_0[21];	// @[Arbiter.scala:88:30, :117:26]
        state_5 = _RANDOM_0[22];	// @[Arbiter.scala:88:30, :117:26]
        state_6 = _RANDOM_0[23];	// @[Arbiter.scala:88:30, :117:26]
        state_7 = _RANDOM_0[24];	// @[Arbiter.scala:88:30, :117:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
