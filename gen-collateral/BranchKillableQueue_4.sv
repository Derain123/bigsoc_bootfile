...
module BranchKillableQueue_4(
  ...
  wire [474:0]     _ram_ext_R0_data;	// @[util.scala:464:20]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uops_0_ldq_idx = _RANDOM_7[12:8];	// @[util.scala:466:20]
        uops_0_stq_idx = _RANDOM_7[17:13];	// @[util.scala:466:20]
        uops_0_is_amo = _RANDOM_11[12];	// @[util.scala:466:20]
        uops_0_uses_ldq = _RANDOM_11[13];	// @[util.scala:466:20]
        uops_0_uses_stq = _RANDOM_11[14];	// @[util.scala:466:20]
        uops_1_br_mask = {_RANDOM_17[31:26], _RANDOM_18[9:0]};	// @[util.scala:466:20]
        uops_1_ldq_idx = _RANDOM_20[6:2];	// @[util.scala:466:20]
        uops_1_stq_idx = _RANDOM_20[11:7];	// @[util.scala:466:20]
        uops_1_is_amo = _RANDOM_24[6];	// @[util.scala:466:20]
        uops_1_uses_ldq = _RANDOM_24[7];	// @[util.scala:466:20]
        uops_1_uses_stq = _RANDOM_24[8];	// @[util.scala:466:20]
        uops_2_br_mask = {_RANDOM_30[31:20], _RANDOM_31[3:0]};	// @[util.scala:466:20]
        uops_2_ldq_idx = {_RANDOM_32[31:28], _RANDOM_33[0]};	// @[util.scala:466:20]
        uops_2_stq_idx = _RANDOM_33[5:1];	// @[util.scala:466:20]
        uops_2_is_amo = _RANDOM_37[0];	// @[util.scala:466:20]
        uops_2_uses_ldq = _RANDOM_37[1];	// @[util.scala:466:20]
        uops_2_uses_stq = _RANDOM_37[2];	// @[util.scala:466:20]
        uops_3_br_mask = _RANDOM_43[29:14];	// @[util.scala:466:20]
        uops_3_ldq_idx = _RANDOM_45[26:22];	// @[util.scala:466:20]
        uops_3_stq_idx = _RANDOM_45[31:27];	// @[util.scala:466:20]
        uops_3_is_amo = _RANDOM_49[26];	// @[util.scala:466:20]
        uops_3_uses_ldq = _RANDOM_49[27];	// @[util.scala:466:20]
        uops_3_uses_stq = _RANDOM_49[28];	// @[util.scala:466:20]
        enq_ptr_value = _RANDOM_51[13:12];	// @[Counter.scala:61:40]
        deq_ptr_value = _RANDOM_51[15:14];	// @[Counter.scala:61:40]
        maybe_full = _RANDOM_51[16];	// @[Counter.scala:61:40, util.scala:470:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_combMem_40 ram_ext (	// @[util.scala:464:20]
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[473:410];	// @[util.scala:464:20]
  assign io_deq_bits_is_hella = _ram_ext_R0_data[474];	// @[util.scala:464:20]
endmodule
