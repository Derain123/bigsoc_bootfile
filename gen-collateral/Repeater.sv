  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_source = _RANDOM_0[17:11];	// @[Repeater.scala:19:21, :20:18]
        saved_address = {_RANDOM_0[31:18], _RANDOM_1[16:0]};	// @[Repeater.scala:19:21, :20:18]
        saved_mask = {_RANDOM_1[31:17], _RANDOM_2[0]};	// @[Repeater.scala:20:18]
        saved_data = {_RANDOM_2[31:1], _RANDOM_3, _RANDOM_4, _RANDOM_5, _RANDOM_6[0]};	// @[Repeater.scala:20:18]
        saved_corrupt = _RANDOM_6[1];	// @[Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
