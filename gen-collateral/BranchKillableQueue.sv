...
module BranchKillableQueue(
  ...
  wire [550:0]      _ram_ext_R0_data;	// @[util.scala:464:20]
  ...
  wire [15:0][6:0]  _GEN_33 = {{uops_15_rob_idx}, {uops_14_rob_idx}, {uops_13_rob_idx}, {uops_12_rob_idx}, {uops_11_rob_idx}, {uops_10_rob_idx}, {uops_9_rob_idx}, {uops_8_rob_idx}, {uops_7_rob_idx}, {uops_6_rob_idx}, {uops_5_rob_idx}, {uops_4_rob_idx}, {uops_3_rob_idx}, {uops_2_rob_idx}, {uops_1_rob_idx}, {uops_0_rob_idx}};	// @[util.scala:466:20, :508:19]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uops_0_ftq_idx = _RANDOM_6[4:0];	// @[util.scala:466:20]
        uops_0_edge_inst = _RANDOM_6[5];	// @[util.scala:466:20]
        uops_0_pc_lob = _RANDOM_6[11:6];	// @[util.scala:466:20]
        uops_0_taken = _RANDOM_6[12];	// @[util.scala:466:20]
        uops_0_imm_packed = {_RANDOM_6[31:13], _RANDOM_7[0]};	// @[util.scala:466:20]
        uops_0_csr_addr = _RANDOM_7[12:1];	// @[util.scala:466:20]
        uops_0_rob_idx = _RANDOM_7[19:13];	// @[util.scala:466:20]
        uops_0_ldq_idx = _RANDOM_7[24:20];	// @[util.scala:466:20]
        uops_0_stq_idx = _RANDOM_7[29:25];	// @[util.scala:466:20]
        uops_0_rxq_idx = _RANDOM_7[31:30];	// @[util.scala:466:20]
        uops_0_pdst = _RANDOM_8[6:0];	// @[util.scala:466:20]
        uops_0_prs1 = _RANDOM_8[13:7];	// @[util.scala:466:20]
        uops_0_prs2 = _RANDOM_8[20:14];	// @[util.scala:466:20]
        uops_0_prs3 = _RANDOM_8[27:21];	// @[util.scala:466:20]
        uops_0_ppred = {_RANDOM_8[31:28], _RANDOM_9[0]};	// @[util.scala:466:20]
        uops_0_prs1_busy = _RANDOM_9[1];	// @[util.scala:466:20]
        uops_0_prs2_busy = _RANDOM_9[2];	// @[util.scala:466:20]
        uops_0_prs3_busy = _RANDOM_9[3];	// @[util.scala:466:20]
        uops_0_ppred_busy = _RANDOM_9[4];	// @[util.scala:466:20]
        uops_0_stale_pdst = _RANDOM_9[11:5];	// @[util.scala:466:20]
        uops_0_exception = _RANDOM_9[12];	// @[util.scala:466:20]
        uops_0_exc_cause = {_RANDOM_9[31:13], _RANDOM_10, _RANDOM_11[12:0]};	// @[util.scala:466:20]
        uops_0_bypassable = _RANDOM_11[13];	// @[util.scala:466:20]
        uops_0_mem_cmd = _RANDOM_11[18:14];	// @[util.scala:466:20]
        uops_0_mem_size = _RANDOM_11[20:19];	// @[util.scala:466:20]
        uops_0_mem_signed = _RANDOM_11[21];	// @[util.scala:466:20]
        uops_0_is_fence = _RANDOM_11[22];	// @[util.scala:466:20]
        uops_0_is_fencei = _RANDOM_11[23];	// @[util.scala:466:20]
        uops_0_is_amo = _RANDOM_11[24];	// @[util.scala:466:20]
        uops_0_uses_ldq = _RANDOM_11[25];	// @[util.scala:466:20]
        uops_0_uses_stq = _RANDOM_11[26];	// @[util.scala:466:20]
        uops_0_is_sys_pc2epc = _RANDOM_11[27];	// @[util.scala:466:20]
        uops_0_is_unique = _RANDOM_11[28];	// @[util.scala:466:20]
        uops_0_flush_on_commit = _RANDOM_11[29];	// @[util.scala:466:20]
        uops_0_ldst_is_rs1 = _RANDOM_11[30];	// @[util.scala:466:20]
        uops_0_ldst = {_RANDOM_11[31], _RANDOM_12[4:0]};	// @[util.scala:466:20]
        uops_0_lrs1 = _RANDOM_12[10:5];	// @[util.scala:466:20]
        uops_0_lrs2 = _RANDOM_12[16:11];	// @[util.scala:466:20]
        uops_0_lrs3 = _RANDOM_12[22:17];	// @[util.scala:466:20]
        uops_0_ldst_val = _RANDOM_12[23];	// @[util.scala:466:20]
        uops_0_dst_rtype = _RANDOM_12[25:24];	// @[util.scala:466:20]
        uops_0_lrs1_rtype = _RANDOM_12[27:26];	// @[util.scala:466:20]
        uops_0_lrs2_rtype = _RANDOM_12[29:28];	// @[util.scala:466:20]
        uops_0_frs3_en = _RANDOM_12[30];	// @[util.scala:466:20]
        uops_0_fp_val = _RANDOM_12[31];	// @[util.scala:466:20]
        uops_0_fp_single = _RANDOM_13[0];	// @[util.scala:466:20]
        uops_0_xcpt_pf_if = _RANDOM_13[1];	// @[util.scala:466:20]
        uops_0_xcpt_ae_if = _RANDOM_13[2];	// @[util.scala:466:20]
        uops_0_xcpt_ma_if = _RANDOM_13[3];	// @[util.scala:466:20]
        uops_0_bp_debug_if = _RANDOM_13[4];	// @[util.scala:466:20]
        uops_0_bp_xcpt_if = _RANDOM_13[5];	// @[util.scala:466:20]
        uops_0_debug_fsrc = _RANDOM_13[7:6];	// @[util.scala:466:20]
        uops_0_debug_tsrc = _RANDOM_13[9:8];	// @[util.scala:466:20]
        uops_1_uopc = _RANDOM_13[16:10];	// @[util.scala:466:20]
        uops_1_inst = {_RANDOM_13[31:17], _RANDOM_14[16:0]};	// @[util.scala:466:20]
        uops_1_debug_inst = {_RANDOM_14[31:17], _RANDOM_15[16:0]};	// @[util.scala:466:20]
        uops_1_is_rvc = _RANDOM_15[17];	// @[util.scala:466:20]
        uops_1_debug_pc = {_RANDOM_15[31:18], _RANDOM_16[25:0]};	// @[util.scala:466:20]
        uops_1_iq_type = _RANDOM_16[28:26];	// @[util.scala:466:20]
        uops_1_fu_code = {_RANDOM_16[31:29], _RANDOM_17[6:0]};	// @[util.scala:466:20]
        uops_1_ctrl_br_type = _RANDOM_17[10:7];	// @[util.scala:466:20]
        uops_1_ctrl_op1_sel = _RANDOM_17[12:11];	// @[util.scala:466:20]
        uops_1_ctrl_op2_sel = _RANDOM_17[15:13];	// @[util.scala:466:20]
        uops_1_ctrl_imm_sel = _RANDOM_17[18:16];	// @[util.scala:466:20]
        uops_1_ctrl_op_fcn = _RANDOM_17[22:19];	// @[util.scala:466:20]
        uops_1_ctrl_fcn_dw = _RANDOM_17[23];	// @[util.scala:466:20]
        uops_1_ctrl_csr_cmd = _RANDOM_17[26:24];	// @[util.scala:466:20]
        uops_1_ctrl_is_load = _RANDOM_17[27];	// @[util.scala:466:20]
        uops_1_ctrl_is_sta = _RANDOM_17[28];	// @[util.scala:466:20]
        uops_1_ctrl_is_std = _RANDOM_17[29];	// @[util.scala:466:20]
        uops_1_iw_state = _RANDOM_17[31:30];	// @[util.scala:466:20]
        uops_1_iw_p1_poisoned = _RANDOM_18[0];	// @[util.scala:466:20]
        uops_1_iw_p2_poisoned = _RANDOM_18[1];	// @[util.scala:466:20]
        uops_1_is_br = _RANDOM_18[2];	// @[util.scala:466:20]
        uops_1_is_jalr = _RANDOM_18[3];	// @[util.scala:466:20]
        uops_1_is_jal = _RANDOM_18[4];	// @[util.scala:466:20]
        uops_1_is_sfb = _RANDOM_18[5];	// @[util.scala:466:20]
        uops_1_br_mask = _RANDOM_18[21:6];	// @[util.scala:466:20]
        uops_1_br_tag = _RANDOM_18[25:22];	// @[util.scala:466:20]
        uops_1_ftq_idx = _RANDOM_18[30:26];	// @[util.scala:466:20]
        uops_1_edge_inst = _RANDOM_18[31];	// @[util.scala:466:20]
        uops_1_pc_lob = _RANDOM_19[5:0];	// @[util.scala:466:20]
        uops_1_taken = _RANDOM_19[6];	// @[util.scala:466:20]
        uops_1_imm_packed = _RANDOM_19[26:7];	// @[util.scala:466:20]
        uops_1_csr_addr = {_RANDOM_19[31:27], _RANDOM_20[6:0]};	// @[util.scala:466:20]
        uops_1_rob_idx = _RANDOM_20[13:7];	// @[util.scala:466:20]
        ...
        uops_1_pdst = {_RANDOM_20[31:26], _RANDOM_21[0]};	// @[util.scala:466:20]
        uops_1_prs1 = _RANDOM_21[7:1];	// @[util.scala:466:20]
        uops_1_prs2 = _RANDOM_21[14:8];	// @[util.scala:466:20]
        uops_1_prs3 = _RANDOM_21[21:15];	// @[util.scala:466:20]
        uops_1_ppred = _RANDOM_21[26:22];	// @[util.scala:466:20]
        uops_1_prs1_busy = _RANDOM_21[27];	// @[util.scala:466:20]
        uops_1_prs2_busy = _RANDOM_21[28];	// @[util.scala:466:20]
        uops_1_prs3_busy = _RANDOM_21[29];	// @[util.scala:466:20]
        uops_1_ppred_busy = _RANDOM_21[30];	// @[util.scala:466:20]
        uops_1_stale_pdst = {_RANDOM_21[31], _RANDOM_22[5:0]};	// @[util.scala:466:20]
        uops_1_exception = _RANDOM_22[6];	// @[util.scala:466:20]
        uops_1_exc_cause = {_RANDOM_22[31:7], _RANDOM_23, _RANDOM_24[6:0]};	// @[util.scala:466:20]
        uops_1_bypassable = _RANDOM_24[7];	// @[util.scala:466:20]
        uops_1_mem_cmd = _RANDOM_24[12:8];	// @[util.scala:466:20]
        uops_1_mem_size = _RANDOM_24[14:13];	// @[util.scala:466:20]
        uops_1_mem_signed = _RANDOM_24[15];	// @[util.scala:466:20]
        uops_1_is_fence = _RANDOM_24[16];	// @[util.scala:466:20]
        uops_1_is_fencei = _RANDOM_24[17];	// @[util.scala:466:20]
        uops_1_is_amo = _RANDOM_24[18];	// @[util.scala:466:20]
        uops_1_uses_ldq = _RANDOM_24[19];	// @[util.scala:466:20]
        uops_1_uses_stq = _RANDOM_24[20];	// @[util.scala:466:20]
        uops_1_is_sys_pc2epc = _RANDOM_24[21];	// @[util.scala:466:20]
        uops_1_is_unique = _RANDOM_24[22];	// @[util.scala:466:20]
        uops_1_flush_on_commit = _RANDOM_24[23];	// @[util.scala:466:20]
        uops_1_ldst_is_rs1 = _RANDOM_24[24];	// @[util.scala:466:20]
        uops_1_ldst = _RANDOM_24[30:25];	// @[util.scala:466:20]
        uops_1_lrs1 = {_RANDOM_24[31], _RANDOM_25[4:0]};	// @[util.scala:466:20]
        uops_1_lrs2 = _RANDOM_25[10:5];	// @[util.scala:466:20]
        uops_1_lrs3 = _RANDOM_25[16:11];	// @[util.scala:466:20]
        uops_1_ldst_val = _RANDOM_25[17];	// @[util.scala:466:20]
        uops_1_dst_rtype = _RANDOM_25[19:18];	// @[util.scala:466:20]
        uops_1_lrs1_rtype = _RANDOM_25[21:20];	// @[util.scala:466:20]
        uops_1_lrs2_rtype = _RANDOM_25[23:22];	// @[util.scala:466:20]
        uops_1_frs3_en = _RANDOM_25[24];	// @[util.scala:466:20]
        uops_1_fp_val = _RANDOM_25[25];	// @[util.scala:466:20]
        uops_1_fp_single = _RANDOM_25[26];	// @[util.scala:466:20]
        uops_1_xcpt_pf_if = _RANDOM_25[27];	// @[util.scala:466:20]
        uops_1_xcpt_ae_if = _RANDOM_25[28];	// @[util.scala:466:20]
        uops_1_xcpt_ma_if = _RANDOM_25[29];	// @[util.scala:466:20]
        uops_1_bp_debug_if = _RANDOM_25[30];	// @[util.scala:466:20]
        uops_1_bp_xcpt_if = _RANDOM_25[31];	// @[util.scala:466:20]
        uops_1_debug_fsrc = _RANDOM_26[1:0];	// @[util.scala:466:20]
        uops_1_debug_tsrc = _RANDOM_26[3:2];	// @[util.scala:466:20]
        uops_2_uopc = _RANDOM_26[10:4];	// @[util.scala:466:20]
        uops_2_inst = {_RANDOM_26[31:11], _RANDOM_27[10:0]};	// @[util.scala:466:20]
        uops_2_debug_inst = {_RANDOM_27[31:11], _RANDOM_28[10:0]};	// @[util.scala:466:20]
        uops_2_is_rvc = _RANDOM_28[11];	// @[util.scala:466:20]
        uops_2_debug_pc = {_RANDOM_28[31:12], _RANDOM_29[19:0]};	// @[util.scala:466:20]
        uops_2_iq_type = _RANDOM_29[22:20];	// @[util.scala:466:20]
        uops_2_fu_code = {_RANDOM_29[31:23], _RANDOM_30[0]};	// @[util.scala:466:20]
        uops_2_ctrl_br_type = _RANDOM_30[4:1];	// @[util.scala:466:20]
        uops_2_ctrl_op1_sel = _RANDOM_30[6:5];	// @[util.scala:466:20]
        uops_2_ctrl_op2_sel = _RANDOM_30[9:7];	// @[util.scala:466:20]
        uops_2_ctrl_imm_sel = _RANDOM_30[12:10];	// @[util.scala:466:20]
        uops_2_ctrl_op_fcn = _RANDOM_30[16:13];	// @[util.scala:466:20]
        uops_2_ctrl_fcn_dw = _RANDOM_30[17];	// @[util.scala:466:20]
        uops_2_ctrl_csr_cmd = _RANDOM_30[20:18];	// @[util.scala:466:20]
        uops_2_ctrl_is_load = _RANDOM_30[21];	// @[util.scala:466:20]
        uops_2_ctrl_is_sta = _RANDOM_30[22];	// @[util.scala:466:20]
        uops_2_ctrl_is_std = _RANDOM_30[23];	// @[util.scala:466:20]
        uops_2_iw_state = _RANDOM_30[25:24];	// @[util.scala:466:20]
        uops_2_iw_p1_poisoned = _RANDOM_30[26];	// @[util.scala:466:20]
        uops_2_iw_p2_poisoned = _RANDOM_30[27];	// @[util.scala:466:20]
        uops_2_is_br = _RANDOM_30[28];	// @[util.scala:466:20]
        uops_2_is_jalr = _RANDOM_30[29];	// @[util.scala:466:20]
        uops_2_is_jal = _RANDOM_30[30];	// @[util.scala:466:20]
        uops_2_is_sfb = _RANDOM_30[31];	// @[util.scala:466:20]
        uops_2_br_mask = _RANDOM_31[15:0];	// @[util.scala:466:20]
        uops_2_br_tag = _RANDOM_31[19:16];	// @[util.scala:466:20]
        uops_2_ftq_idx = _RANDOM_31[24:20];	// @[util.scala:466:20]
        uops_2_edge_inst = _RANDOM_31[25];	// @[util.scala:466:20]
        uops_2_pc_lob = _RANDOM_31[31:26];	// @[util.scala:466:20]
        uops_2_taken = _RANDOM_32[0];	// @[util.scala:466:20]
        uops_2_imm_packed = _RANDOM_32[20:1];	// @[util.scala:466:20]
        uops_2_csr_addr = {_RANDOM_32[31:21], _RANDOM_33[0]};	// @[util.scala:466:20]
        uops_2_rob_idx = _RANDOM_33[7:1];	// @[util.scala:466:20]
        uops_2_ldq_idx = _RANDOM_33[12:8];	// @[util.scala:466:20]
        uops_2_stq_idx = _RANDOM_33[17:13];	// @[util.scala:466:20]
        uops_2_rxq_idx = _RANDOM_33[19:18];	// @[util.scala:466:20]
        uops_2_pdst = _RANDOM_33[26:20];	// @[util.scala:466:20]
        uops_2_prs1 = {_RANDOM_33[31:27], _RANDOM_34[1:0]};	// @[util.scala:466:20]
        uops_2_prs2 = _RANDOM_34[8:2];	// @[util.scala:466:20]
        uops_2_prs3 = _RANDOM_34[15:9];	// @[util.scala:466:20]
        uops_2_ppred = _RANDOM_34[20:16];	// @[util.scala:466:20]
        uops_2_prs1_busy = _RANDOM_34[21];	// @[util.scala:466:20]
        uops_2_prs2_busy = _RANDOM_34[22];	// @[util.scala:466:20]
        uops_2_prs3_busy = _RANDOM_34[23];	// @[util.scala:466:20]
        uops_2_ppred_busy = _RANDOM_34[24];	// @[util.scala:466:20]
        uops_2_stale_pdst = _RANDOM_34[31:25];	// @[util.scala:466:20]
        uops_2_exception = _RANDOM_35[0];	// @[util.scala:466:20]
        uops_2_exc_cause = {_RANDOM_35[31:1], _RANDOM_36, _RANDOM_37[0]};	// @[util.scala:466:20]
        uops_2_bypassable = _RANDOM_37[1];	// @[util.scala:466:20]
        uops_2_mem_cmd = _RANDOM_37[6:2];	// @[util.scala:466:20]
        uops_2_mem_size = _RANDOM_37[8:7];	// @[util.scala:466:20]
        uops_2_mem_signed = _RANDOM_37[9];	// @[util.scala:466:20]
        uops_2_is_fence = _RANDOM_37[10];	// @[util.scala:466:20]
        uops_2_is_fencei = _RANDOM_37[11];	// @[util.scala:466:20]
        uops_2_is_amo = _RANDOM_37[12];	// @[util.scala:466:20]
        uops_2_uses_ldq = _RANDOM_37[13];	// @[util.scala:466:20]
        uops_2_uses_stq = _RANDOM_37[14];	// @[util.scala:466:20]
        uops_2_is_sys_pc2epc = _RANDOM_37[15];	// @[util.scala:466:20]
        uops_2_is_unique = _RANDOM_37[16];	// @[util.scala:466:20]
        uops_2_flush_on_commit = _RANDOM_37[17];	// @[util.scala:466:20]
        uops_2_ldst_is_rs1 = _RANDOM_37[18];	// @[util.scala:466:20]
        uops_2_ldst = _RANDOM_37[24:19];	// @[util.scala:466:20]
        uops_2_lrs1 = _RANDOM_37[30:25];	// @[util.scala:466:20]
        uops_2_lrs2 = {_RANDOM_37[31], _RANDOM_38[4:0]};	// @[util.scala:466:20]
        uops_2_lrs3 = _RANDOM_38[10:5];	// @[util.scala:466:20]
        uops_2_ldst_val = _RANDOM_38[11];	// @[util.scala:466:20]
        uops_2_dst_rtype = _RANDOM_38[13:12];	// @[util.scala:466:20]
        uops_2_lrs1_rtype = _RANDOM_38[15:14];	// @[util.scala:466:20]
        uops_2_lrs2_rtype = _RANDOM_38[17:16];	// @[util.scala:466:20]
        uops_2_frs3_en = _RANDOM_38[18];	// @[util.scala:466:20]
        uops_2_fp_val = _RANDOM_38[19];	// @[util.scala:466:20]
        uops_2_fp_single = _RANDOM_38[20];	// @[util.scala:466:20]
        uops_2_xcpt_pf_if = _RANDOM_38[21];	// @[util.scala:466:20]
        uops_2_xcpt_ae_if = _RANDOM_38[22];	// @[util.scala:466:20]
        uops_2_xcpt_ma_if = _RANDOM_38[23];	// @[util.scala:466:20]
        uops_2_bp_debug_if = _RANDOM_38[24];	// @[util.scala:466:20]
        uops_2_bp_xcpt_if = _RANDOM_38[25];	// @[util.scala:466:20]
        uops_2_debug_fsrc = _RANDOM_38[27:26];	// @[util.scala:466:20]
        uops_2_debug_tsrc = _RANDOM_38[29:28];	// @[util.scala:466:20]
        uops_3_uopc = {_RANDOM_38[31:30], _RANDOM_39[4:0]};	// @[util.scala:466:20]
        uops_3_inst = {_RANDOM_39[31:5], _RANDOM_40[4:0]};	// @[util.scala:466:20]
        uops_3_debug_inst = {_RANDOM_40[31:5], _RANDOM_41[4:0]};	// @[util.scala:466:20]
        uops_3_is_rvc = _RANDOM_41[5];	// @[util.scala:466:20]
        uops_3_debug_pc = {_RANDOM_41[31:6], _RANDOM_42[13:0]};	// @[util.scala:466:20]
        uops_3_iq_type = _RANDOM_42[16:14];	// @[util.scala:466:20]
        uops_3_fu_code = _RANDOM_42[26:17];	// @[util.scala:466:20]
        uops_3_ctrl_br_type = _RANDOM_42[30:27];	// @[util.scala:466:20]
        uops_3_ctrl_op1_sel = {_RANDOM_42[31], _RANDOM_43[0]};	// @[util.scala:466:20]
        uops_3_ctrl_op2_sel = _RANDOM_43[3:1];	// @[util.scala:466:20]
        uops_3_ctrl_imm_sel = _RANDOM_43[6:4];	// @[util.scala:466:20]
        uops_3_ctrl_op_fcn = _RANDOM_43[10:7];	// @[util.scala:466:20]
        uops_3_ctrl_fcn_dw = _RANDOM_43[11];	// @[util.scala:466:20]
        uops_3_ctrl_csr_cmd = _RANDOM_43[14:12];	// @[util.scala:466:20]
        uops_3_ctrl_is_load = _RANDOM_43[15];	// @[util.scala:466:20]
        uops_3_ctrl_is_sta = _RANDOM_43[16];	// @[util.scala:466:20]
        uops_3_ctrl_is_std = _RANDOM_43[17];	// @[util.scala:466:20]
        uops_3_iw_state = _RANDOM_43[19:18];	// @[util.scala:466:20]
        uops_3_iw_p1_poisoned = _RANDOM_43[20];	// @[util.scala:466:20]
        uops_3_iw_p2_poisoned = _RANDOM_43[21];	// @[util.scala:466:20]
        uops_3_is_br = _RANDOM_43[22];	// @[util.scala:466:20]
        uops_3_is_jalr = _RANDOM_43[23];	// @[util.scala:466:20]
        uops_3_is_jal = _RANDOM_43[24];	// @[util.scala:466:20]
        uops_3_is_sfb = _RANDOM_43[25];	// @[util.scala:466:20]
        uops_3_br_mask = {_RANDOM_43[31:26], _RANDOM_44[9:0]};	// @[util.scala:466:20]
        uops_3_br_tag = _RANDOM_44[13:10];	// @[util.scala:466:20]
        uops_3_ftq_idx = _RANDOM_44[18:14];	// @[util.scala:466:20]
        uops_3_edge_inst = _RANDOM_44[19];	// @[util.scala:466:20]
        uops_3_pc_lob = _RANDOM_44[25:20];	// @[util.scala:466:20]
        uops_3_taken = _RANDOM_44[26];	// @[util.scala:466:20]
        uops_3_imm_packed = {_RANDOM_44[31:27], _RANDOM_45[14:0]};	// @[util.scala:466:20]
        uops_3_csr_addr = _RANDOM_45[26:15];	// @[util.scala:466:20]
        uops_3_rob_idx = {_RANDOM_45[31:27], _RANDOM_46[1:0]};	// @[util.scala:466:20]
        uops_3_ldq_idx = _RANDOM_46[6:2];	// @[util.scala:466:20]
        uops_3_stq_idx = _RANDOM_46[11:7];	// @[util.scala:466:20]
        uops_3_rxq_idx = _RANDOM_46[13:12];	// @[util.scala:466:20]
        uops_3_pdst = _RANDOM_46[20:14];	// @[util.scala:466:20]
        uops_3_prs1 = _RANDOM_46[27:21];	// @[util.scala:466:20]
        uops_3_prs2 = {_RANDOM_46[31:28], _RANDOM_47[2:0]};	// @[util.scala:466:20]
        uops_3_prs3 = _RANDOM_47[9:3];	// @[util.scala:466:20]
        uops_3_ppred = _RANDOM_47[14:10];	// @[util.scala:466:20]
        uops_3_prs1_busy = _RANDOM_47[15];	// @[util.scala:466:20]
        uops_3_prs2_busy = _RANDOM_47[16];	// @[util.scala:466:20]
        uops_3_prs3_busy = _RANDOM_47[17];	// @[util.scala:466:20]
        uops_3_ppred_busy = _RANDOM_47[18];	// @[util.scala:466:20]
        uops_3_stale_pdst = _RANDOM_47[25:19];	// @[util.scala:466:20]
        uops_3_exception = _RANDOM_47[26];	// @[util.scala:466:20]
        uops_3_exc_cause = {_RANDOM_47[31:27], _RANDOM_48, _RANDOM_49[26:0]};	// @[util.scala:466:20]
        uops_3_bypassable = _RANDOM_49[27];	// @[util.scala:466:20]
        uops_3_mem_cmd = {_RANDOM_49[31:28], _RANDOM_50[0]};	// @[util.scala:466:20]
        uops_3_mem_size = _RANDOM_50[2:1];	// @[util.scala:466:20]
        uops_3_mem_signed = _RANDOM_50[3];	// @[util.scala:466:20]
        uops_3_is_fence = _RANDOM_50[4];	// @[util.scala:466:20]
        uops_3_is_fencei = _RANDOM_50[5];	// @[util.scala:466:20]
        uops_3_is_amo = _RANDOM_50[6];	// @[util.scala:466:20]
        uops_3_uses_ldq = _RANDOM_50[7];	// @[util.scala:466:20]
        uops_3_uses_stq = _RANDOM_50[8];	// @[util.scala:466:20]
        uops_3_is_sys_pc2epc = _RANDOM_50[9];	// @[util.scala:466:20]
        uops_3_is_unique = _RANDOM_50[10];	// @[util.scala:466:20]
        uops_3_flush_on_commit = _RANDOM_50[11];	// @[util.scala:466:20]
        uops_3_ldst_is_rs1 = _RANDOM_50[12];	// @[util.scala:466:20]
        uops_3_ldst = _RANDOM_50[18:13];	// @[util.scala:466:20]
        uops_3_lrs1 = _RANDOM_50[24:19];	// @[util.scala:466:20]
        uops_3_lrs2 = _RANDOM_50[30:25];	// @[util.scala:466:20]
        uops_3_lrs3 = {_RANDOM_50[31], _RANDOM_51[4:0]};	// @[util.scala:466:20]
        uops_3_ldst_val = _RANDOM_51[5];	// @[util.scala:466:20]
        uops_3_dst_rtype = _RANDOM_51[7:6];	// @[util.scala:466:20]
        uops_3_lrs1_rtype = _RANDOM_51[9:8];	// @[util.scala:466:20]
        uops_3_lrs2_rtype = _RANDOM_51[11:10];	// @[util.scala:466:20]
        uops_3_frs3_en = _RANDOM_51[12];	// @[util.scala:466:20]
        uops_3_fp_val = _RANDOM_51[13];	// @[util.scala:466:20]
        uops_3_fp_single = _RANDOM_51[14];	// @[util.scala:466:20]
        uops_3_xcpt_pf_if = _RANDOM_51[15];	// @[util.scala:466:20]
        uops_3_xcpt_ae_if = _RANDOM_51[16];	// @[util.scala:466:20]
        uops_3_xcpt_ma_if = _RANDOM_51[17];	// @[util.scala:466:20]
        uops_3_bp_debug_if = _RANDOM_51[18];	// @[util.scala:466:20]
        uops_3_bp_xcpt_if = _RANDOM_51[19];	// @[util.scala:466:20]
        uops_3_debug_fsrc = _RANDOM_51[21:20];	// @[util.scala:466:20]
        uops_3_debug_tsrc = _RANDOM_51[23:22];	// @[util.scala:466:20]
        uops_4_uopc = _RANDOM_51[30:24];	// @[util.scala:466:20]
        uops_4_inst = {_RANDOM_51[31], _RANDOM_52[30:0]};	// @[util.scala:466:20]
        uops_4_debug_inst = {_RANDOM_52[31], _RANDOM_53[30:0]};	// @[util.scala:466:20]
        uops_4_is_rvc = _RANDOM_53[31];	// @[util.scala:466:20]
        uops_4_debug_pc = {_RANDOM_54, _RANDOM_55[7:0]};	// @[util.scala:466:20]
        uops_4_iq_type = _RANDOM_55[10:8];	// @[util.scala:466:20]
        uops_4_fu_code = _RANDOM_55[20:11];	// @[util.scala:466:20]
        uops_4_ctrl_br_type = _RANDOM_55[24:21];	// @[util.scala:466:20]
        uops_4_ctrl_op1_sel = _RANDOM_55[26:25];	// @[util.scala:466:20]
        uops_4_ctrl_op2_sel = _RANDOM_55[29:27];	// @[util.scala:466:20]
        uops_4_ctrl_imm_sel = {_RANDOM_55[31:30], _RANDOM_56[0]};	// @[util.scala:466:20]
        uops_4_ctrl_op_fcn = _RANDOM_56[4:1];	// @[util.scala:466:20]
        uops_4_ctrl_fcn_dw = _RANDOM_56[5];	// @[util.scala:466:20]
        uops_4_ctrl_csr_cmd = _RANDOM_56[8:6];	// @[util.scala:466:20]
        uops_4_ctrl_is_load = _RANDOM_56[9];	// @[util.scala:466:20]
        uops_4_ctrl_is_sta = _RANDOM_56[10];	// @[util.scala:466:20]
        uops_4_ctrl_is_std = _RANDOM_56[11];	// @[util.scala:466:20]
        uops_4_iw_state = _RANDOM_56[13:12];	// @[util.scala:466:20]
        uops_4_iw_p1_poisoned = _RANDOM_56[14];	// @[util.scala:466:20]
        uops_4_iw_p2_poisoned = _RANDOM_56[15];	// @[util.scala:466:20]
        uops_4_is_br = _RANDOM_56[16];	// @[util.scala:466:20]
        uops_4_is_jalr = _RANDOM_56[17];	// @[util.scala:466:20]
        uops_4_is_jal = _RANDOM_56[18];	// @[util.scala:466:20]
        uops_4_is_sfb = _RANDOM_56[19];	// @[util.scala:466:20]
        uops_4_br_mask = {_RANDOM_56[31:20], _RANDOM_57[3:0]};	// @[util.scala:466:20]
        uops_4_br_tag = _RANDOM_57[7:4];	// @[util.scala:466:20]
        uops_4_ftq_idx = _RANDOM_57[12:8];	// @[util.scala:466:20]
        uops_4_edge_inst = _RANDOM_57[13];	// @[util.scala:466:20]
        uops_4_pc_lob = _RANDOM_57[19:14];	// @[util.scala:466:20]
        uops_4_taken = _RANDOM_57[20];	// @[util.scala:466:20]
        uops_4_imm_packed = {_RANDOM_57[31:21], _RANDOM_58[8:0]};	// @[util.scala:466:20]
        uops_4_csr_addr = _RANDOM_58[20:9];	// @[util.scala:466:20]
        uops_4_rob_idx = _RANDOM_58[27:21];	// @[util.scala:466:20]
        uops_4_ldq_idx = {_RANDOM_58[31:28], _RANDOM_59[0]};	// @[util.scala:466:20]
        uops_4_stq_idx = _RANDOM_59[5:1];	// @[util.scala:466:20]
        uops_4_rxq_idx = _RANDOM_59[7:6];	// @[util.scala:466:20]
        uops_4_pdst = _RANDOM_59[14:8];	// @[util.scala:466:20]
        uops_4_prs1 = _RANDOM_59[21:15];	// @[util.scala:466:20]
        uops_4_prs2 = _RANDOM_59[28:22];	// @[util.scala:466:20]
        uops_4_prs3 = {_RANDOM_59[31:29], _RANDOM_60[3:0]};	// @[util.scala:466:20]
        uops_4_ppred = _RANDOM_60[8:4];	// @[util.scala:466:20]
        uops_4_prs1_busy = _RANDOM_60[9];	// @[util.scala:466:20]
        uops_4_prs2_busy = _RANDOM_60[10];	// @[util.scala:466:20]
        uops_4_prs3_busy = _RANDOM_60[11];	// @[util.scala:466:20]
        uops_4_ppred_busy = _RANDOM_60[12];	// @[util.scala:466:20]
        uops_4_stale_pdst = _RANDOM_60[19:13];	// @[util.scala:466:20]
        uops_4_exception = _RANDOM_60[20];	// @[util.scala:466:20]
        uops_4_exc_cause = {_RANDOM_60[31:21], _RANDOM_61, _RANDOM_62[20:0]};	// @[util.scala:466:20]
        uops_4_bypassable = _RANDOM_62[21];	// @[util.scala:466:20]
        uops_4_mem_cmd = _RANDOM_62[26:22];	// @[util.scala:466:20]
        uops_4_mem_size = _RANDOM_62[28:27];	// @[util.scala:466:20]
        uops_4_mem_signed = _RANDOM_62[29];	// @[util.scala:466:20]
        uops_4_is_fence = _RANDOM_62[30];	// @[util.scala:466:20]
        uops_4_is_fencei = _RANDOM_62[31];	// @[util.scala:466:20]
        uops_4_is_amo = _RANDOM_63[0];	// @[util.scala:466:20]
        uops_4_uses_ldq = _RANDOM_63[1];	// @[util.scala:466:20]
        uops_4_uses_stq = _RANDOM_63[2];	// @[util.scala:466:20]
        uops_4_is_sys_pc2epc = _RANDOM_63[3];	// @[util.scala:466:20]
        uops_4_is_unique = _RANDOM_63[4];	// @[util.scala:466:20]
        uops_4_flush_on_commit = _RANDOM_63[5];	// @[util.scala:466:20]
        uops_4_ldst_is_rs1 = _RANDOM_63[6];	// @[util.scala:466:20]
        uops_4_ldst = _RANDOM_63[12:7];	// @[util.scala:466:20]
        uops_4_lrs1 = _RANDOM_63[18:13];	// @[util.scala:466:20]
        uops_4_lrs2 = _RANDOM_63[24:19];	// @[util.scala:466:20]
        uops_4_lrs3 = _RANDOM_63[30:25];	// @[util.scala:466:20]
        uops_4_ldst_val = _RANDOM_63[31];	// @[util.scala:466:20]
        uops_4_dst_rtype = _RANDOM_64[1:0];	// @[util.scala:466:20]
        uops_4_lrs1_rtype = _RANDOM_64[3:2];	// @[util.scala:466:20]
        uops_4_lrs2_rtype = _RANDOM_64[5:4];	// @[util.scala:466:20]
        uops_4_frs3_en = _RANDOM_64[6];	// @[util.scala:466:20]
        uops_4_fp_val = _RANDOM_64[7];	// @[util.scala:466:20]
        uops_4_fp_single = _RANDOM_64[8];	// @[util.scala:466:20]
        uops_4_xcpt_pf_if = _RANDOM_64[9];	// @[util.scala:466:20]
        uops_4_xcpt_ae_if = _RANDOM_64[10];	// @[util.scala:466:20]
        uops_4_xcpt_ma_if = _RANDOM_64[11];	// @[util.scala:466:20]
        uops_4_bp_debug_if = _RANDOM_64[12];	// @[util.scala:466:20]
        uops_4_bp_xcpt_if = _RANDOM_64[13];	// @[util.scala:466:20]
        uops_4_debug_fsrc = _RANDOM_64[15:14];	// @[util.scala:466:20]
        uops_4_debug_tsrc = _RANDOM_64[17:16];	// @[util.scala:466:20]
        uops_5_uopc = _RANDOM_64[24:18];	// @[util.scala:466:20]
        uops_5_inst = {_RANDOM_64[31:25], _RANDOM_65[24:0]};	// @[util.scala:466:20]
        uops_5_debug_inst = {_RANDOM_65[31:25], _RANDOM_66[24:0]};	// @[util.scala:466:20]
        uops_5_is_rvc = _RANDOM_66[25];	// @[util.scala:466:20]
        uops_5_debug_pc = {_RANDOM_66[31:26], _RANDOM_67, _RANDOM_68[1:0]};	// @[util.scala:466:20]
        uops_5_iq_type = _RANDOM_68[4:2];	// @[util.scala:466:20]
        uops_5_fu_code = _RANDOM_68[14:5];	// @[util.scala:466:20]
        uops_5_ctrl_br_type = _RANDOM_68[18:15];	// @[util.scala:466:20]
        uops_5_ctrl_op1_sel = _RANDOM_68[20:19];	// @[util.scala:466:20]
        uops_5_ctrl_op2_sel = _RANDOM_68[23:21];	// @[util.scala:466:20]
        uops_5_ctrl_imm_sel = _RANDOM_68[26:24];	// @[util.scala:466:20]
        uops_5_ctrl_op_fcn = _RANDOM_68[30:27];	// @[util.scala:466:20]
        uops_5_ctrl_fcn_dw = _RANDOM_68[31];	// @[util.scala:466:20]
        uops_5_ctrl_csr_cmd = _RANDOM_69[2:0];	// @[util.scala:466:20]
        uops_5_ctrl_is_load = _RANDOM_69[3];	// @[util.scala:466:20]
        uops_5_ctrl_is_sta = _RANDOM_69[4];	// @[util.scala:466:20]
        uops_5_ctrl_is_std = _RANDOM_69[5];	// @[util.scala:466:20]
        uops_5_iw_state = _RANDOM_69[7:6];	// @[util.scala:466:20]
        uops_5_iw_p1_poisoned = _RANDOM_69[8];	// @[util.scala:466:20]
        uops_5_iw_p2_poisoned = _RANDOM_69[9];	// @[util.scala:466:20]
        uops_5_is_br = _RANDOM_69[10];	// @[util.scala:466:20]
        uops_5_is_jalr = _RANDOM_69[11];	// @[util.scala:466:20]
        uops_5_is_jal = _RANDOM_69[12];	// @[util.scala:466:20]
        uops_5_is_sfb = _RANDOM_69[13];	// @[util.scala:466:20]
        uops_5_br_mask = _RANDOM_69[29:14];	// @[util.scala:466:20]
        uops_5_br_tag = {_RANDOM_69[31:30], _RANDOM_70[1:0]};	// @[util.scala:466:20]
        uops_5_ftq_idx = _RANDOM_70[6:2];	// @[util.scala:466:20]
        uops_5_edge_inst = _RANDOM_70[7];	// @[util.scala:466:20]
        uops_5_pc_lob = _RANDOM_70[13:8];	// @[util.scala:466:20]
        uops_5_taken = _RANDOM_70[14];	// @[util.scala:466:20]
        uops_5_imm_packed = {_RANDOM_70[31:15], _RANDOM_71[2:0]};	// @[util.scala:466:20]
        uops_5_csr_addr = _RANDOM_71[14:3];	// @[util.scala:466:20]
        uops_5_rob_idx = _RANDOM_71[21:15];	// @[util.scala:466:20]
        uops_5_ldq_idx = _RANDOM_71[26:22];	// @[util.scala:466:20]
        uops_5_stq_idx = _RANDOM_71[31:27];	// @[util.scala:466:20]
        uops_5_rxq_idx = _RANDOM_72[1:0];	// @[util.scala:466:20]
        uops_5_pdst = _RANDOM_72[8:2];	// @[util.scala:466:20]
        uops_5_prs1 = _RANDOM_72[15:9];	// @[util.scala:466:20]
        uops_5_prs2 = _RANDOM_72[22:16];	// @[util.scala:466:20]
        uops_5_prs3 = _RANDOM_72[29:23];	// @[util.scala:466:20]
        uops_5_ppred = {_RANDOM_72[31:30], _RANDOM_73[2:0]};	// @[util.scala:466:20]
        uops_5_prs1_busy = _RANDOM_73[3];	// @[util.scala:466:20]
        uops_5_prs2_busy = _RANDOM_73[4];	// @[util.scala:466:20]
        uops_5_prs3_busy = _RANDOM_73[5];	// @[util.scala:466:20]
        uops_5_ppred_busy = _RANDOM_73[6];	// @[util.scala:466:20]
        uops_5_stale_pdst = _RANDOM_73[13:7];	// @[util.scala:466:20]
        uops_5_exception = _RANDOM_73[14];	// @[util.scala:466:20]
        uops_5_exc_cause = {_RANDOM_73[31:15], _RANDOM_74, _RANDOM_75[14:0]};	// @[util.scala:466:20]
        uops_5_bypassable = _RANDOM_75[15];	// @[util.scala:466:20]
        uops_5_mem_cmd = _RANDOM_75[20:16];	// @[util.scala:466:20]
        uops_5_mem_size = _RANDOM_75[22:21];	// @[util.scala:466:20]
        uops_5_mem_signed = _RANDOM_75[23];	// @[util.scala:466:20]
        uops_5_is_fence = _RANDOM_75[24];	// @[util.scala:466:20]
        uops_5_is_fencei = _RANDOM_75[25];	// @[util.scala:466:20]
        uops_5_is_amo = _RANDOM_75[26];	// @[util.scala:466:20]
        uops_5_uses_ldq = _RANDOM_75[27];	// @[util.scala:466:20]
        uops_5_uses_stq = _RANDOM_75[28];	// @[util.scala:466:20]
        uops_5_is_sys_pc2epc = _RANDOM_75[29];	// @[util.scala:466:20]
        uops_5_is_unique = _RANDOM_75[30];	// @[util.scala:466:20]
        uops_5_flush_on_commit = _RANDOM_75[31];	// @[util.scala:466:20]
        uops_5_ldst_is_rs1 = _RANDOM_76[0];	// @[util.scala:466:20]
        uops_5_ldst = _RANDOM_76[6:1];	// @[util.scala:466:20]
        uops_5_lrs1 = _RANDOM_76[12:7];	// @[util.scala:466:20]
        uops_5_lrs2 = _RANDOM_76[18:13];	// @[util.scala:466:20]
        uops_5_lrs3 = _RANDOM_76[24:19];	// @[util.scala:466:20]
        uops_5_ldst_val = _RANDOM_76[25];	// @[util.scala:466:20]
        uops_5_dst_rtype = _RANDOM_76[27:26];	// @[util.scala:466:20]
        uops_5_lrs1_rtype = _RANDOM_76[29:28];	// @[util.scala:466:20]
        uops_5_lrs2_rtype = _RANDOM_76[31:30];	// @[util.scala:466:20]
        uops_5_frs3_en = _RANDOM_77[0];	// @[util.scala:466:20]
        uops_5_fp_val = _RANDOM_77[1];	// @[util.scala:466:20]
        uops_5_fp_single = _RANDOM_77[2];	// @[util.scala:466:20]
        uops_5_xcpt_pf_if = _RANDOM_77[3];	// @[util.scala:466:20]
        uops_5_xcpt_ae_if = _RANDOM_77[4];	// @[util.scala:466:20]
        uops_5_xcpt_ma_if = _RANDOM_77[5];	// @[util.scala:466:20]
        uops_5_bp_debug_if = _RANDOM_77[6];	// @[util.scala:466:20]
        uops_5_bp_xcpt_if = _RANDOM_77[7];	// @[util.scala:466:20]
        uops_5_debug_fsrc = _RANDOM_77[9:8];	// @[util.scala:466:20]
        uops_5_debug_tsrc = _RANDOM_77[11:10];	// @[util.scala:466:20]
        uops_6_uopc = _RANDOM_77[18:12];	// @[util.scala:466:20]
        uops_6_inst = {_RANDOM_77[31:19], _RANDOM_78[18:0]};	// @[util.scala:466:20]
        uops_6_debug_inst = {_RANDOM_78[31:19], _RANDOM_79[18:0]};	// @[util.scala:466:20]
        uops_6_is_rvc = _RANDOM_79[19];	// @[util.scala:466:20]
        uops_6_debug_pc = {_RANDOM_79[31:20], _RANDOM_80[27:0]};	// @[util.scala:466:20]
        uops_6_iq_type = _RANDOM_80[30:28];	// @[util.scala:466:20]
        uops_6_fu_code = {_RANDOM_80[31], _RANDOM_81[8:0]};	// @[util.scala:466:20]
        uops_6_ctrl_br_type = _RANDOM_81[12:9];	// @[util.scala:466:20]
        uops_6_ctrl_op1_sel = _RANDOM_81[14:13];	// @[util.scala:466:20]
        uops_6_ctrl_op2_sel = _RANDOM_81[17:15];	// @[util.scala:466:20]
        uops_6_ctrl_imm_sel = _RANDOM_81[20:18];	// @[util.scala:466:20]
        uops_6_ctrl_op_fcn = _RANDOM_81[24:21];	// @[util.scala:466:20]
        uops_6_ctrl_fcn_dw = _RANDOM_81[25];	// @[util.scala:466:20]
        uops_6_ctrl_csr_cmd = _RANDOM_81[28:26];	// @[util.scala:466:20]
        uops_6_ctrl_is_load = _RANDOM_81[29];	// @[util.scala:466:20]
        uops_6_ctrl_is_sta = _RANDOM_81[30];	// @[util.scala:466:20]
        uops_6_ctrl_is_std = _RANDOM_81[31];	// @[util.scala:466:20]
        uops_6_iw_state = _RANDOM_82[1:0];	// @[util.scala:466:20]
        uops_6_iw_p1_poisoned = _RANDOM_82[2];	// @[util.scala:466:20]
        uops_6_iw_p2_poisoned = _RANDOM_82[3];	// @[util.scala:466:20]
        uops_6_is_br = _RANDOM_82[4];	// @[util.scala:466:20]
        uops_6_is_jalr = _RANDOM_82[5];	// @[util.scala:466:20]
        uops_6_is_jal = _RANDOM_82[6];	// @[util.scala:466:20]
        uops_6_is_sfb = _RANDOM_82[7];	// @[util.scala:466:20]
        uops_6_br_mask = _RANDOM_82[23:8];	// @[util.scala:466:20]
        uops_6_br_tag = _RANDOM_82[27:24];	// @[util.scala:466:20]
        uops_6_ftq_idx = {_RANDOM_82[31:28], _RANDOM_83[0]};	// @[util.scala:466:20]
        uops_6_edge_inst = _RANDOM_83[1];	// @[util.scala:466:20]
        uops_6_pc_lob = _RANDOM_83[7:2];	// @[util.scala:466:20]
        uops_6_taken = _RANDOM_83[8];	// @[util.scala:466:20]
        uops_6_imm_packed = _RANDOM_83[28:9];	// @[util.scala:466:20]
        uops_6_csr_addr = {_RANDOM_83[31:29], _RANDOM_84[8:0]};	// @[util.scala:466:20]
        uops_6_rob_idx = _RANDOM_84[15:9];	// @[util.scala:466:20]
        uops_6_ldq_idx = _RANDOM_84[20:16];	// @[util.scala:466:20]
        uops_6_stq_idx = _RANDOM_84[25:21];	// @[util.scala:466:20]
        uops_6_rxq_idx = _RANDOM_84[27:26];	// @[util.scala:466:20]
        uops_6_pdst = {_RANDOM_84[31:28], _RANDOM_85[2:0]};	// @[util.scala:466:20]
        uops_6_prs1 = _RANDOM_85[9:3];	// @[util.scala:466:20]
        uops_6_prs2 = _RANDOM_85[16:10];	// @[util.scala:466:20]
        uops_6_prs3 = _RANDOM_85[23:17];	// @[util.scala:466:20]
        uops_6_ppred = _RANDOM_85[28:24];	// @[util.scala:466:20]
        uops_6_prs1_busy = _RANDOM_85[29];	// @[util.scala:466:20]
        uops_6_prs2_busy = _RANDOM_85[30];	// @[util.scala:466:20]
        uops_6_prs3_busy = _RANDOM_85[31];	// @[util.scala:466:20]
        uops_6_ppred_busy = _RANDOM_86[0];	// @[util.scala:466:20]
        uops_6_stale_pdst = _RANDOM_86[7:1];	// @[util.scala:466:20]
        uops_6_exception = _RANDOM_86[8];	// @[util.scala:466:20]
        uops_6_exc_cause = {_RANDOM_86[31:9], _RANDOM_87, _RANDOM_88[8:0]};	// @[util.scala:466:20]
        uops_6_bypassable = _RANDOM_88[9];	// @[util.scala:466:20]
        uops_6_mem_cmd = _RANDOM_88[14:10];	// @[util.scala:466:20]
        uops_6_mem_size = _RANDOM_88[16:15];	// @[util.scala:466:20]
        uops_6_mem_signed = _RANDOM_88[17];	// @[util.scala:466:20]
        uops_6_is_fence = _RANDOM_88[18];	// @[util.scala:466:20]
        uops_6_is_fencei = _RANDOM_88[19];	// @[util.scala:466:20]
        uops_6_is_amo = _RANDOM_88[20];	// @[util.scala:466:20]
        uops_6_uses_ldq = _RANDOM_88[21];	// @[util.scala:466:20]
        uops_6_uses_stq = _RANDOM_88[22];	// @[util.scala:466:20]
        uops_6_is_sys_pc2epc = _RANDOM_88[23];	// @[util.scala:466:20]
        uops_6_is_unique = _RANDOM_88[24];	// @[util.scala:466:20]
        uops_6_flush_on_commit = _RANDOM_88[25];	// @[util.scala:466:20]
        uops_6_ldst_is_rs1 = _RANDOM_88[26];	// @[util.scala:466:20]
        uops_6_ldst = {_RANDOM_88[31:27], _RANDOM_89[0]};	// @[util.scala:466:20]
        uops_6_lrs1 = _RANDOM_89[6:1];	// @[util.scala:466:20]
        uops_6_lrs2 = _RANDOM_89[12:7];	// @[util.scala:466:20]
        uops_6_lrs3 = _RANDOM_89[18:13];	// @[util.scala:466:20]
        uops_6_ldst_val = _RANDOM_89[19];	// @[util.scala:466:20]
        uops_6_dst_rtype = _RANDOM_89[21:20];	// @[util.scala:466:20]
        uops_6_lrs1_rtype = _RANDOM_89[23:22];	// @[util.scala:466:20]
        uops_6_lrs2_rtype = _RANDOM_89[25:24];	// @[util.scala:466:20]
        uops_6_frs3_en = _RANDOM_89[26];	// @[util.scala:466:20]
        uops_6_fp_val = _RANDOM_89[27];	// @[util.scala:466:20]
        uops_6_fp_single = _RANDOM_89[28];	// @[util.scala:466:20]
        uops_6_xcpt_pf_if = _RANDOM_89[29];	// @[util.scala:466:20]
        uops_6_xcpt_ae_if = _RANDOM_89[30];	// @[util.scala:466:20]
        uops_6_xcpt_ma_if = _RANDOM_89[31];	// @[util.scala:466:20]
        uops_6_bp_debug_if = _RANDOM_90[0];	// @[util.scala:466:20]
        uops_6_bp_xcpt_if = _RANDOM_90[1];	// @[util.scala:466:20]
        uops_6_debug_fsrc = _RANDOM_90[3:2];	// @[util.scala:466:20]
        uops_6_debug_tsrc = _RANDOM_90[5:4];	// @[util.scala:466:20]
        uops_7_uopc = _RANDOM_90[12:6];	// @[util.scala:466:20]
        uops_7_inst = {_RANDOM_90[31:13], _RANDOM_91[12:0]};	// @[util.scala:466:20]
        uops_7_debug_inst = {_RANDOM_91[31:13], _RANDOM_92[12:0]};	// @[util.scala:466:20]
        uops_7_is_rvc = _RANDOM_92[13];	// @[util.scala:466:20]
        uops_7_debug_pc = {_RANDOM_92[31:14], _RANDOM_93[21:0]};	// @[util.scala:466:20]
        uops_7_iq_type = _RANDOM_93[24:22];	// @[util.scala:466:20]
        uops_7_fu_code = {_RANDOM_93[31:25], _RANDOM_94[2:0]};	// @[util.scala:466:20]
        uops_7_ctrl_br_type = _RANDOM_94[6:3];	// @[util.scala:466:20]
        uops_7_ctrl_op1_sel = _RANDOM_94[8:7];	// @[util.scala:466:20]
        uops_7_ctrl_op2_sel = _RANDOM_94[11:9];	// @[util.scala:466:20]
        uops_7_ctrl_imm_sel = _RANDOM_94[14:12];	// @[util.scala:466:20]
        uops_7_ctrl_op_fcn = _RANDOM_94[18:15];	// @[util.scala:466:20]
        uops_7_ctrl_fcn_dw = _RANDOM_94[19];	// @[util.scala:466:20]
        uops_7_ctrl_csr_cmd = _RANDOM_94[22:20];	// @[util.scala:466:20]
        uops_7_ctrl_is_load = _RANDOM_94[23];	// @[util.scala:466:20]
        uops_7_ctrl_is_sta = _RANDOM_94[24];	// @[util.scala:466:20]
        uops_7_ctrl_is_std = _RANDOM_94[25];	// @[util.scala:466:20]
        uops_7_iw_state = _RANDOM_94[27:26];	// @[util.scala:466:20]
        uops_7_iw_p1_poisoned = _RANDOM_94[28];	// @[util.scala:466:20]
        uops_7_iw_p2_poisoned = _RANDOM_94[29];	// @[util.scala:466:20]
        uops_7_is_br = _RANDOM_94[30];	// @[util.scala:466:20]
        uops_7_is_jalr = _RANDOM_94[31];	// @[util.scala:466:20]
        uops_7_is_jal = _RANDOM_95[0];	// @[util.scala:466:20]
        uops_7_is_sfb = _RANDOM_95[1];	// @[util.scala:466:20]
        uops_7_br_mask = _RANDOM_95[17:2];	// @[util.scala:466:20]
        uops_7_br_tag = _RANDOM_95[21:18];	// @[util.scala:466:20]
        uops_7_ftq_idx = _RANDOM_95[26:22];	// @[util.scala:466:20]
        uops_7_edge_inst = _RANDOM_95[27];	// @[util.scala:466:20]
        uops_7_pc_lob = {_RANDOM_95[31:28], _RANDOM_96[1:0]};	// @[util.scala:466:20]
        uops_7_taken = _RANDOM_96[2];	// @[util.scala:466:20]
        uops_7_imm_packed = _RANDOM_96[22:3];	// @[util.scala:466:20]
        uops_7_csr_addr = {_RANDOM_96[31:23], _RANDOM_97[2:0]};	// @[util.scala:466:20]
        uops_7_rob_idx = _RANDOM_97[9:3];	// @[util.scala:466:20]
        uops_7_ldq_idx = _RANDOM_97[14:10];	// @[util.scala:466:20]
        uops_7_stq_idx = _RANDOM_97[19:15];	// @[util.scala:466:20]
        uops_7_rxq_idx = _RANDOM_97[21:20];	// @[util.scala:466:20]
        uops_7_pdst = _RANDOM_97[28:22];	// @[util.scala:466:20]
        uops_7_prs1 = {_RANDOM_97[31:29], _RANDOM_98[3:0]};	// @[util.scala:466:20]
        uops_7_prs2 = _RANDOM_98[10:4];	// @[util.scala:466:20]
        uops_7_prs3 = _RANDOM_98[17:11];	// @[util.scala:466:20]
        uops_7_ppred = _RANDOM_98[22:18];	// @[util.scala:466:20]
        uops_7_prs1_busy = _RANDOM_98[23];	// @[util.scala:466:20]
        uops_7_prs2_busy = _RANDOM_98[24];	// @[util.scala:466:20]
        uops_7_prs3_busy = _RANDOM_98[25];	// @[util.scala:466:20]
        uops_7_ppred_busy = _RANDOM_98[26];	// @[util.scala:466:20]
        uops_7_stale_pdst = {_RANDOM_98[31:27], _RANDOM_99[1:0]};	// @[util.scala:466:20]
        uops_7_exception = _RANDOM_99[2];	// @[util.scala:466:20]
        uops_7_exc_cause = {_RANDOM_99[31:3], _RANDOM_100, _RANDOM_101[2:0]};	// @[util.scala:466:20]
        uops_7_bypassable = _RANDOM_101[3];	// @[util.scala:466:20]
        uops_7_mem_cmd = _RANDOM_101[8:4];	// @[util.scala:466:20]
        uops_7_mem_size = _RANDOM_101[10:9];	// @[util.scala:466:20]
        uops_7_mem_signed = _RANDOM_101[11];	// @[util.scala:466:20]
        uops_7_is_fence = _RANDOM_101[12];	// @[util.scala:466:20]
        uops_7_is_fencei = _RANDOM_101[13];	// @[util.scala:466:20]
        uops_7_is_amo = _RANDOM_101[14];	// @[util.scala:466:20]
        uops_7_uses_ldq = _RANDOM_101[15];	// @[util.scala:466:20]
        uops_7_uses_stq = _RANDOM_101[16];	// @[util.scala:466:20]
        uops_7_is_sys_pc2epc = _RANDOM_101[17];	// @[util.scala:466:20]
        uops_7_is_unique = _RANDOM_101[18];	// @[util.scala:466:20]
        uops_7_flush_on_commit = _RANDOM_101[19];	// @[util.scala:466:20]
        uops_7_ldst_is_rs1 = _RANDOM_101[20];	// @[util.scala:466:20]
        uops_7_ldst = _RANDOM_101[26:21];	// @[util.scala:466:20]
        uops_7_lrs1 = {_RANDOM_101[31:27], _RANDOM_102[0]};	// @[util.scala:466:20]
        uops_7_lrs2 = _RANDOM_102[6:1];	// @[util.scala:466:20]
        uops_7_lrs3 = _RANDOM_102[12:7];	// @[util.scala:466:20]
        uops_7_ldst_val = _RANDOM_102[13];	// @[util.scala:466:20]
        uops_7_dst_rtype = _RANDOM_102[15:14];	// @[util.scala:466:20]
        uops_7_lrs1_rtype = _RANDOM_102[17:16];	// @[util.scala:466:20]
        uops_7_lrs2_rtype = _RANDOM_102[19:18];	// @[util.scala:466:20]
        uops_7_frs3_en = _RANDOM_102[20];	// @[util.scala:466:20]
        uops_7_fp_val = _RANDOM_102[21];	// @[util.scala:466:20]
        uops_7_fp_single = _RANDOM_102[22];	// @[util.scala:466:20]
        uops_7_xcpt_pf_if = _RANDOM_102[23];	// @[util.scala:466:20]
        uops_7_xcpt_ae_if = _RANDOM_102[24];	// @[util.scala:466:20]
        uops_7_xcpt_ma_if = _RANDOM_102[25];	// @[util.scala:466:20]
        uops_7_bp_debug_if = _RANDOM_102[26];	// @[util.scala:466:20]
        uops_7_bp_xcpt_if = _RANDOM_102[27];	// @[util.scala:466:20]
        uops_7_debug_fsrc = _RANDOM_102[29:28];	// @[util.scala:466:20]
        uops_7_debug_tsrc = _RANDOM_102[31:30];	// @[util.scala:466:20]
        uops_8_uopc = _RANDOM_103[6:0];	// @[util.scala:466:20]
        uops_8_inst = {_RANDOM_103[31:7], _RANDOM_104[6:0]};	// @[util.scala:466:20]
        uops_8_debug_inst = {_RANDOM_104[31:7], _RANDOM_105[6:0]};	// @[util.scala:466:20]
        uops_8_is_rvc = _RANDOM_105[7];	// @[util.scala:466:20]
        uops_8_debug_pc = {_RANDOM_105[31:8], _RANDOM_106[15:0]};	// @[util.scala:466:20]
        uops_8_iq_type = _RANDOM_106[18:16];	// @[util.scala:466:20]
        uops_8_fu_code = _RANDOM_106[28:19];	// @[util.scala:466:20]
        uops_8_ctrl_br_type = {_RANDOM_106[31:29], _RANDOM_107[0]};	// @[util.scala:466:20]
        uops_8_ctrl_op1_sel = _RANDOM_107[2:1];	// @[util.scala:466:20]
        uops_8_ctrl_op2_sel = _RANDOM_107[5:3];	// @[util.scala:466:20]
        uops_8_ctrl_imm_sel = _RANDOM_107[8:6];	// @[util.scala:466:20]
        uops_8_ctrl_op_fcn = _RANDOM_107[12:9];	// @[util.scala:466:20]
        uops_8_ctrl_fcn_dw = _RANDOM_107[13];	// @[util.scala:466:20]
        uops_8_ctrl_csr_cmd = _RANDOM_107[16:14];	// @[util.scala:466:20]
        uops_8_ctrl_is_load = _RANDOM_107[17];	// @[util.scala:466:20]
        uops_8_ctrl_is_sta = _RANDOM_107[18];	// @[util.scala:466:20]
        uops_8_ctrl_is_std = _RANDOM_107[19];	// @[util.scala:466:20]
        uops_8_iw_state = _RANDOM_107[21:20];	// @[util.scala:466:20]
        uops_8_iw_p1_poisoned = _RANDOM_107[22];	// @[util.scala:466:20]
        uops_8_iw_p2_poisoned = _RANDOM_107[23];	// @[util.scala:466:20]
        uops_8_is_br = _RANDOM_107[24];	// @[util.scala:466:20]
        uops_8_is_jalr = _RANDOM_107[25];	// @[util.scala:466:20]
        uops_8_is_jal = _RANDOM_107[26];	// @[util.scala:466:20]
        uops_8_is_sfb = _RANDOM_107[27];	// @[util.scala:466:20]
        uops_8_br_mask = {_RANDOM_107[31:28], _RANDOM_108[11:0]};	// @[util.scala:466:20]
        uops_8_br_tag = _RANDOM_108[15:12];	// @[util.scala:466:20]
        uops_8_ftq_idx = _RANDOM_108[20:16];	// @[util.scala:466:20]
        uops_8_edge_inst = _RANDOM_108[21];	// @[util.scala:466:20]
        uops_8_pc_lob = _RANDOM_108[27:22];	// @[util.scala:466:20]
        uops_8_taken = _RANDOM_108[28];	// @[util.scala:466:20]
        uops_8_imm_packed = {_RANDOM_108[31:29], _RANDOM_109[16:0]};	// @[util.scala:466:20]
        uops_8_csr_addr = _RANDOM_109[28:17];	// @[util.scala:466:20]
        uops_8_rob_idx = {_RANDOM_109[31:29], _RANDOM_110[3:0]};	// @[util.scala:466:20]
        uops_8_ldq_idx = _RANDOM_110[8:4];	// @[util.scala:466:20]
        uops_8_stq_idx = _RANDOM_110[13:9];	// @[util.scala:466:20]
        uops_8_rxq_idx = _RANDOM_110[15:14];	// @[util.scala:466:20]
        uops_8_pdst = _RANDOM_110[22:16];	// @[util.scala:466:20]
        uops_8_prs1 = _RANDOM_110[29:23];	// @[util.scala:466:20]
        uops_8_prs2 = {_RANDOM_110[31:30], _RANDOM_111[4:0]};	// @[util.scala:466:20]
        uops_8_prs3 = _RANDOM_111[11:5];	// @[util.scala:466:20]
        uops_8_ppred = _RANDOM_111[16:12];	// @[util.scala:466:20]
        uops_8_prs1_busy = _RANDOM_111[17];	// @[util.scala:466:20]
        uops_8_prs2_busy = _RANDOM_111[18];	// @[util.scala:466:20]
        uops_8_prs3_busy = _RANDOM_111[19];	// @[util.scala:466:20]
        uops_8_ppred_busy = _RANDOM_111[20];	// @[util.scala:466:20]
        uops_8_stale_pdst = _RANDOM_111[27:21];	// @[util.scala:466:20]
        uops_8_exception = _RANDOM_111[28];	// @[util.scala:466:20]
        uops_8_exc_cause = {_RANDOM_111[31:29], _RANDOM_112, _RANDOM_113[28:0]};	// @[util.scala:466:20]
        uops_8_bypassable = _RANDOM_113[29];	// @[util.scala:466:20]
        uops_8_mem_cmd = {_RANDOM_113[31:30], _RANDOM_114[2:0]};	// @[util.scala:466:20]
        uops_8_mem_size = _RANDOM_114[4:3];	// @[util.scala:466:20]
        uops_8_mem_signed = _RANDOM_114[5];	// @[util.scala:466:20]
        uops_8_is_fence = _RANDOM_114[6];	// @[util.scala:466:20]
        uops_8_is_fencei = _RANDOM_114[7];	// @[util.scala:466:20]
        uops_8_is_amo = _RANDOM_114[8];	// @[util.scala:466:20]
        uops_8_uses_ldq = _RANDOM_114[9];	// @[util.scala:466:20]
        uops_8_uses_stq = _RANDOM_114[10];	// @[util.scala:466:20]
        uops_8_is_sys_pc2epc = _RANDOM_114[11];	// @[util.scala:466:20]
        uops_8_is_unique = _RANDOM_114[12];	// @[util.scala:466:20]
        uops_8_flush_on_commit = _RANDOM_114[13];	// @[util.scala:466:20]
        uops_8_ldst_is_rs1 = _RANDOM_114[14];	// @[util.scala:466:20]
        uops_8_ldst = _RANDOM_114[20:15];	// @[util.scala:466:20]
        uops_8_lrs1 = _RANDOM_114[26:21];	// @[util.scala:466:20]
        uops_8_lrs2 = {_RANDOM_114[31:27], _RANDOM_115[0]};	// @[util.scala:466:20]
        uops_8_lrs3 = _RANDOM_115[6:1];	// @[util.scala:466:20]
        uops_8_ldst_val = _RANDOM_115[7];	// @[util.scala:466:20]
        uops_8_dst_rtype = _RANDOM_115[9:8];	// @[util.scala:466:20]
        uops_8_lrs1_rtype = _RANDOM_115[11:10];	// @[util.scala:466:20]
        uops_8_lrs2_rtype = _RANDOM_115[13:12];	// @[util.scala:466:20]
        uops_8_frs3_en = _RANDOM_115[14];	// @[util.scala:466:20]
        uops_8_fp_val = _RANDOM_115[15];	// @[util.scala:466:20]
        uops_8_fp_single = _RANDOM_115[16];	// @[util.scala:466:20]
        uops_8_xcpt_pf_if = _RANDOM_115[17];	// @[util.scala:466:20]
        uops_8_xcpt_ae_if = _RANDOM_115[18];	// @[util.scala:466:20]
        uops_8_xcpt_ma_if = _RANDOM_115[19];	// @[util.scala:466:20]
        uops_8_bp_debug_if = _RANDOM_115[20];	// @[util.scala:466:20]
        uops_8_bp_xcpt_if = _RANDOM_115[21];	// @[util.scala:466:20]
        uops_8_debug_fsrc = _RANDOM_115[23:22];	// @[util.scala:466:20]
        uops_8_debug_tsrc = _RANDOM_115[25:24];	// @[util.scala:466:20]
        uops_9_uopc = {_RANDOM_115[31:26], _RANDOM_116[0]};	// @[util.scala:466:20]
        uops_9_inst = {_RANDOM_116[31:1], _RANDOM_117[0]};	// @[util.scala:466:20]
        uops_9_debug_inst = {_RANDOM_117[31:1], _RANDOM_118[0]};	// @[util.scala:466:20]
        uops_9_is_rvc = _RANDOM_118[1];	// @[util.scala:466:20]
        uops_9_debug_pc = {_RANDOM_118[31:2], _RANDOM_119[9:0]};	// @[util.scala:466:20]
        uops_9_iq_type = _RANDOM_119[12:10];	// @[util.scala:466:20]
        uops_9_fu_code = _RANDOM_119[22:13];	// @[util.scala:466:20]
        uops_9_ctrl_br_type = _RANDOM_119[26:23];	// @[util.scala:466:20]
        uops_9_ctrl_op1_sel = _RANDOM_119[28:27];	// @[util.scala:466:20]
        uops_9_ctrl_op2_sel = _RANDOM_119[31:29];	// @[util.scala:466:20]
        uops_9_ctrl_imm_sel = _RANDOM_120[2:0];	// @[util.scala:466:20]
        uops_9_ctrl_op_fcn = _RANDOM_120[6:3];	// @[util.scala:466:20]
        uops_9_ctrl_fcn_dw = _RANDOM_120[7];	// @[util.scala:466:20]
        uops_9_ctrl_csr_cmd = _RANDOM_120[10:8];	// @[util.scala:466:20]
        uops_9_ctrl_is_load = _RANDOM_120[11];	// @[util.scala:466:20]
        uops_9_ctrl_is_sta = _RANDOM_120[12];	// @[util.scala:466:20]
        uops_9_ctrl_is_std = _RANDOM_120[13];	// @[util.scala:466:20]
        uops_9_iw_state = _RANDOM_120[15:14];	// @[util.scala:466:20]
        uops_9_iw_p1_poisoned = _RANDOM_120[16];	// @[util.scala:466:20]
        uops_9_iw_p2_poisoned = _RANDOM_120[17];	// @[util.scala:466:20]
        uops_9_is_br = _RANDOM_120[18];	// @[util.scala:466:20]
        uops_9_is_jalr = _RANDOM_120[19];	// @[util.scala:466:20]
        uops_9_is_jal = _RANDOM_120[20];	// @[util.scala:466:20]
        uops_9_is_sfb = _RANDOM_120[21];	// @[util.scala:466:20]
        uops_9_br_mask = {_RANDOM_120[31:22], _RANDOM_121[5:0]};	// @[util.scala:466:20]
        uops_9_br_tag = _RANDOM_121[9:6];	// @[util.scala:466:20]
        uops_9_ftq_idx = _RANDOM_121[14:10];	// @[util.scala:466:20]
        uops_9_edge_inst = _RANDOM_121[15];	// @[util.scala:466:20]
        uops_9_pc_lob = _RANDOM_121[21:16];	// @[util.scala:466:20]
        uops_9_taken = _RANDOM_121[22];	// @[util.scala:466:20]
        uops_9_imm_packed = {_RANDOM_121[31:23], _RANDOM_122[10:0]};	// @[util.scala:466:20]
        uops_9_csr_addr = _RANDOM_122[22:11];	// @[util.scala:466:20]
        uops_9_rob_idx = _RANDOM_122[29:23];	// @[util.scala:466:20]
        uops_9_ldq_idx = {_RANDOM_122[31:30], _RANDOM_123[2:0]};	// @[util.scala:466:20]
        uops_9_stq_idx = _RANDOM_123[7:3];	// @[util.scala:466:20]
        uops_9_rxq_idx = _RANDOM_123[9:8];	// @[util.scala:466:20]
        uops_9_pdst = _RANDOM_123[16:10];	// @[util.scala:466:20]
        uops_9_prs1 = _RANDOM_123[23:17];	// @[util.scala:466:20]
        uops_9_prs2 = _RANDOM_123[30:24];	// @[util.scala:466:20]
        uops_9_prs3 = {_RANDOM_123[31], _RANDOM_124[5:0]};	// @[util.scala:466:20]
        uops_9_ppred = _RANDOM_124[10:6];	// @[util.scala:466:20]
        uops_9_prs1_busy = _RANDOM_124[11];	// @[util.scala:466:20]
        uops_9_prs2_busy = _RANDOM_124[12];	// @[util.scala:466:20]
        uops_9_prs3_busy = _RANDOM_124[13];	// @[util.scala:466:20]
        uops_9_ppred_busy = _RANDOM_124[14];	// @[util.scala:466:20]
        uops_9_stale_pdst = _RANDOM_124[21:15];	// @[util.scala:466:20]
        uops_9_exception = _RANDOM_124[22];	// @[util.scala:466:20]
        uops_9_exc_cause = {_RANDOM_124[31:23], _RANDOM_125, _RANDOM_126[22:0]};	// @[util.scala:466:20]
        uops_9_bypassable = _RANDOM_126[23];	// @[util.scala:466:20]
        uops_9_mem_cmd = _RANDOM_126[28:24];	// @[util.scala:466:20]
        uops_9_mem_size = _RANDOM_126[30:29];	// @[util.scala:466:20]
        uops_9_mem_signed = _RANDOM_126[31];	// @[util.scala:466:20]
        uops_9_is_fence = _RANDOM_127[0];	// @[util.scala:466:20]
        uops_9_is_fencei = _RANDOM_127[1];	// @[util.scala:466:20]
        uops_9_is_amo = _RANDOM_127[2];	// @[util.scala:466:20]
        uops_9_uses_ldq = _RANDOM_127[3];	// @[util.scala:466:20]
        uops_9_uses_stq = _RANDOM_127[4];	// @[util.scala:466:20]
        uops_9_is_sys_pc2epc = _RANDOM_127[5];	// @[util.scala:466:20]
        uops_9_is_unique = _RANDOM_127[6];	// @[util.scala:466:20]
        uops_9_flush_on_commit = _RANDOM_127[7];	// @[util.scala:466:20]
        uops_9_ldst_is_rs1 = _RANDOM_127[8];	// @[util.scala:466:20]
        uops_9_ldst = _RANDOM_127[14:9];	// @[util.scala:466:20]
        uops_9_lrs1 = _RANDOM_127[20:15];	// @[util.scala:466:20]
        uops_9_lrs2 = _RANDOM_127[26:21];	// @[util.scala:466:20]
        uops_9_lrs3 = {_RANDOM_127[31:27], _RANDOM_128[0]};	// @[util.scala:466:20]
        uops_9_ldst_val = _RANDOM_128[1];	// @[util.scala:466:20]
        uops_9_dst_rtype = _RANDOM_128[3:2];	// @[util.scala:466:20]
        uops_9_lrs1_rtype = _RANDOM_128[5:4];	// @[util.scala:466:20]
        uops_9_lrs2_rtype = _RANDOM_128[7:6];	// @[util.scala:466:20]
        uops_9_frs3_en = _RANDOM_128[8];	// @[util.scala:466:20]
        uops_9_fp_val = _RANDOM_128[9];	// @[util.scala:466:20]
        uops_9_fp_single = _RANDOM_128[10];	// @[util.scala:466:20]
        uops_9_xcpt_pf_if = _RANDOM_128[11];	// @[util.scala:466:20]
        uops_9_xcpt_ae_if = _RANDOM_128[12];	// @[util.scala:466:20]
        uops_9_xcpt_ma_if = _RANDOM_128[13];	// @[util.scala:466:20]
        uops_9_bp_debug_if = _RANDOM_128[14];	// @[util.scala:466:20]
        uops_9_bp_xcpt_if = _RANDOM_128[15];	// @[util.scala:466:20]
        uops_9_debug_fsrc = _RANDOM_128[17:16];	// @[util.scala:466:20]
        uops_9_debug_tsrc = _RANDOM_128[19:18];	// @[util.scala:466:20]
        uops_10_uopc = _RANDOM_128[26:20];	// @[util.scala:466:20]
        uops_10_inst = {_RANDOM_128[31:27], _RANDOM_129[26:0]};	// @[util.scala:466:20]
        uops_10_debug_inst = {_RANDOM_129[31:27], _RANDOM_130[26:0]};	// @[util.scala:466:20]
        uops_10_is_rvc = _RANDOM_130[27];	// @[util.scala:466:20]
        uops_10_debug_pc = {_RANDOM_130[31:28], _RANDOM_131, _RANDOM_132[3:0]};	// @[util.scala:466:20]
        uops_10_iq_type = _RANDOM_132[6:4];	// @[util.scala:466:20]
        uops_10_fu_code = _RANDOM_132[16:7];	// @[util.scala:466:20]
        uops_10_ctrl_br_type = _RANDOM_132[20:17];	// @[util.scala:466:20]
        uops_10_ctrl_op1_sel = _RANDOM_132[22:21];	// @[util.scala:466:20]
        uops_10_ctrl_op2_sel = _RANDOM_132[25:23];	// @[util.scala:466:20]
        uops_10_ctrl_imm_sel = _RANDOM_132[28:26];	// @[util.scala:466:20]
        uops_10_ctrl_op_fcn = {_RANDOM_132[31:29], _RANDOM_133[0]};	// @[util.scala:466:20]
        uops_10_ctrl_fcn_dw = _RANDOM_133[1];	// @[util.scala:466:20]
        uops_10_ctrl_csr_cmd = _RANDOM_133[4:2];	// @[util.scala:466:20]
        uops_10_ctrl_is_load = _RANDOM_133[5];	// @[util.scala:466:20]
        uops_10_ctrl_is_sta = _RANDOM_133[6];	// @[util.scala:466:20]
        uops_10_ctrl_is_std = _RANDOM_133[7];	// @[util.scala:466:20]
        uops_10_iw_state = _RANDOM_133[9:8];	// @[util.scala:466:20]
        uops_10_iw_p1_poisoned = _RANDOM_133[10];	// @[util.scala:466:20]
        uops_10_iw_p2_poisoned = _RANDOM_133[11];	// @[util.scala:466:20]
        uops_10_is_br = _RANDOM_133[12];	// @[util.scala:466:20]
        uops_10_is_jalr = _RANDOM_133[13];	// @[util.scala:466:20]
        uops_10_is_jal = _RANDOM_133[14];	// @[util.scala:466:20]
        uops_10_is_sfb = _RANDOM_133[15];	// @[util.scala:466:20]
        uops_10_br_mask = _RANDOM_133[31:16];	// @[util.scala:466:20]
        uops_10_br_tag = _RANDOM_134[3:0];	// @[util.scala:466:20]
        uops_10_ftq_idx = _RANDOM_134[8:4];	// @[util.scala:466:20]
        uops_10_edge_inst = _RANDOM_134[9];	// @[util.scala:466:20]
        uops_10_pc_lob = _RANDOM_134[15:10];	// @[util.scala:466:20]
        uops_10_taken = _RANDOM_134[16];	// @[util.scala:466:20]
        uops_10_imm_packed = {_RANDOM_134[31:17], _RANDOM_135[4:0]};	// @[util.scala:466:20]
        uops_10_csr_addr = _RANDOM_135[16:5];	// @[util.scala:466:20]
        uops_10_rob_idx = _RANDOM_135[23:17];	// @[util.scala:466:20]
        uops_10_ldq_idx = _RANDOM_135[28:24];	// @[util.scala:466:20]
        uops_10_stq_idx = {_RANDOM_135[31:29], _RANDOM_136[1:0]};	// @[util.scala:466:20]
        uops_10_rxq_idx = _RANDOM_136[3:2];	// @[util.scala:466:20]
        uops_10_pdst = _RANDOM_136[10:4];	// @[util.scala:466:20]
        uops_10_prs1 = _RANDOM_136[17:11];	// @[util.scala:466:20]
        uops_10_prs2 = _RANDOM_136[24:18];	// @[util.scala:466:20]
        uops_10_prs3 = _RANDOM_136[31:25];	// @[util.scala:466:20]
        uops_10_ppred = _RANDOM_137[4:0];	// @[util.scala:466:20]
        uops_10_prs1_busy = _RANDOM_137[5];	// @[util.scala:466:20]
        uops_10_prs2_busy = _RANDOM_137[6];	// @[util.scala:466:20]
        uops_10_prs3_busy = _RANDOM_137[7];	// @[util.scala:466:20]
        uops_10_ppred_busy = _RANDOM_137[8];	// @[util.scala:466:20]
        uops_10_stale_pdst = _RANDOM_137[15:9];	// @[util.scala:466:20]
        uops_10_exception = _RANDOM_137[16];	// @[util.scala:466:20]
        uops_10_exc_cause = {_RANDOM_137[31:17], _RANDOM_138, _RANDOM_139[16:0]};	// @[util.scala:466:20]
        uops_10_bypassable = _RANDOM_139[17];	// @[util.scala:466:20]
        uops_10_mem_cmd = _RANDOM_139[22:18];	// @[util.scala:466:20]
        uops_10_mem_size = _RANDOM_139[24:23];	// @[util.scala:466:20]
        uops_10_mem_signed = _RANDOM_139[25];	// @[util.scala:466:20]
        uops_10_is_fence = _RANDOM_139[26];	// @[util.scala:466:20]
        uops_10_is_fencei = _RANDOM_139[27];	// @[util.scala:466:20]
        uops_10_is_amo = _RANDOM_139[28];	// @[util.scala:466:20]
        uops_10_uses_ldq = _RANDOM_139[29];	// @[util.scala:466:20]
        uops_10_uses_stq = _RANDOM_139[30];	// @[util.scala:466:20]
        uops_10_is_sys_pc2epc = _RANDOM_139[31];	// @[util.scala:466:20]
        uops_10_is_unique = _RANDOM_140[0];	// @[util.scala:466:20]
        uops_10_flush_on_commit = _RANDOM_140[1];	// @[util.scala:466:20]
        uops_10_ldst_is_rs1 = _RANDOM_140[2];	// @[util.scala:466:20]
        uops_10_ldst = _RANDOM_140[8:3];	// @[util.scala:466:20]
        uops_10_lrs1 = _RANDOM_140[14:9];	// @[util.scala:466:20]
        uops_10_lrs2 = _RANDOM_140[20:15];	// @[util.scala:466:20]
        uops_10_lrs3 = _RANDOM_140[26:21];	// @[util.scala:466:20]
        uops_10_ldst_val = _RANDOM_140[27];	// @[util.scala:466:20]
        uops_10_dst_rtype = _RANDOM_140[29:28];	// @[util.scala:466:20]
        uops_10_lrs1_rtype = _RANDOM_140[31:30];	// @[util.scala:466:20]
        uops_10_lrs2_rtype = _RANDOM_141[1:0];	// @[util.scala:466:20]
        uops_10_frs3_en = _RANDOM_141[2];	// @[util.scala:466:20]
        uops_10_fp_val = _RANDOM_141[3];	// @[util.scala:466:20]
        uops_10_fp_single = _RANDOM_141[4];	// @[util.scala:466:20]
        uops_10_xcpt_pf_if = _RANDOM_141[5];	// @[util.scala:466:20]
        uops_10_xcpt_ae_if = _RANDOM_141[6];	// @[util.scala:466:20]
        uops_10_xcpt_ma_if = _RANDOM_141[7];	// @[util.scala:466:20]
        uops_10_bp_debug_if = _RANDOM_141[8];	// @[util.scala:466:20]
        uops_10_bp_xcpt_if = _RANDOM_141[9];	// @[util.scala:466:20]
        uops_10_debug_fsrc = _RANDOM_141[11:10];	// @[util.scala:466:20]
        uops_10_debug_tsrc = _RANDOM_141[13:12];	// @[util.scala:466:20]
        uops_11_uopc = _RANDOM_141[20:14];	// @[util.scala:466:20]
        uops_11_inst = {_RANDOM_141[31:21], _RANDOM_142[20:0]};	// @[util.scala:466:20]
        uops_11_debug_inst = {_RANDOM_142[31:21], _RANDOM_143[20:0]};	// @[util.scala:466:20]
        uops_11_is_rvc = _RANDOM_143[21];	// @[util.scala:466:20]
        uops_11_debug_pc = {_RANDOM_143[31:22], _RANDOM_144[29:0]};	// @[util.scala:466:20]
        uops_11_iq_type = {_RANDOM_144[31:30], _RANDOM_145[0]};	// @[util.scala:466:20]
        uops_11_fu_code = _RANDOM_145[10:1];	// @[util.scala:466:20]
        uops_11_ctrl_br_type = _RANDOM_145[14:11];	// @[util.scala:466:20]
        uops_11_ctrl_op1_sel = _RANDOM_145[16:15];	// @[util.scala:466:20]
        uops_11_ctrl_op2_sel = _RANDOM_145[19:17];	// @[util.scala:466:20]
        uops_11_ctrl_imm_sel = _RANDOM_145[22:20];	// @[util.scala:466:20]
        uops_11_ctrl_op_fcn = _RANDOM_145[26:23];	// @[util.scala:466:20]
        uops_11_ctrl_fcn_dw = _RANDOM_145[27];	// @[util.scala:466:20]
        uops_11_ctrl_csr_cmd = _RANDOM_145[30:28];	// @[util.scala:466:20]
        uops_11_ctrl_is_load = _RANDOM_145[31];	// @[util.scala:466:20]
        uops_11_ctrl_is_sta = _RANDOM_146[0];	// @[util.scala:466:20]
        uops_11_ctrl_is_std = _RANDOM_146[1];	// @[util.scala:466:20]
        uops_11_iw_state = _RANDOM_146[3:2];	// @[util.scala:466:20]
        uops_11_iw_p1_poisoned = _RANDOM_146[4];	// @[util.scala:466:20]
        uops_11_iw_p2_poisoned = _RANDOM_146[5];	// @[util.scala:466:20]
        uops_11_is_br = _RANDOM_146[6];	// @[util.scala:466:20]
        uops_11_is_jalr = _RANDOM_146[7];	// @[util.scala:466:20]
        uops_11_is_jal = _RANDOM_146[8];	// @[util.scala:466:20]
        uops_11_is_sfb = _RANDOM_146[9];	// @[util.scala:466:20]
        uops_11_br_mask = _RANDOM_146[25:10];	// @[util.scala:466:20]
        uops_11_br_tag = _RANDOM_146[29:26];	// @[util.scala:466:20]
        uops_11_ftq_idx = {_RANDOM_146[31:30], _RANDOM_147[2:0]};	// @[util.scala:466:20]
        uops_11_edge_inst = _RANDOM_147[3];	// @[util.scala:466:20]
        uops_11_pc_lob = _RANDOM_147[9:4];	// @[util.scala:466:20]
        uops_11_taken = _RANDOM_147[10];	// @[util.scala:466:20]
        uops_11_imm_packed = _RANDOM_147[30:11];	// @[util.scala:466:20]
        uops_11_csr_addr = {_RANDOM_147[31], _RANDOM_148[10:0]};	// @[util.scala:466:20]
        uops_11_rob_idx = _RANDOM_148[17:11];	// @[util.scala:466:20]
        uops_11_ldq_idx = _RANDOM_148[22:18];	// @[util.scala:466:20]
        uops_11_stq_idx = _RANDOM_148[27:23];	// @[util.scala:466:20]
        uops_11_rxq_idx = _RANDOM_148[29:28];	// @[util.scala:466:20]
        uops_11_pdst = {_RANDOM_148[31:30], _RANDOM_149[4:0]};	// @[util.scala:466:20]
        uops_11_prs1 = _RANDOM_149[11:5];	// @[util.scala:466:20]
        uops_11_prs2 = _RANDOM_149[18:12];	// @[util.scala:466:20]
        uops_11_prs3 = _RANDOM_149[25:19];	// @[util.scala:466:20]
        uops_11_ppred = _RANDOM_149[30:26];	// @[util.scala:466:20]
        uops_11_prs1_busy = _RANDOM_149[31];	// @[util.scala:466:20]
        uops_11_prs2_busy = _RANDOM_150[0];	// @[util.scala:466:20]
        uops_11_prs3_busy = _RANDOM_150[1];	// @[util.scala:466:20]
        uops_11_ppred_busy = _RANDOM_150[2];	// @[util.scala:466:20]
        uops_11_stale_pdst = _RANDOM_150[9:3];	// @[util.scala:466:20]
        uops_11_exception = _RANDOM_150[10];	// @[util.scala:466:20]
        uops_11_exc_cause = {_RANDOM_150[31:11], _RANDOM_151, _RANDOM_152[10:0]};	// @[util.scala:466:20]
        uops_11_bypassable = _RANDOM_152[11];	// @[util.scala:466:20]
        uops_11_mem_cmd = _RANDOM_152[16:12];	// @[util.scala:466:20]
        uops_11_mem_size = _RANDOM_152[18:17];	// @[util.scala:466:20]
        uops_11_mem_signed = _RANDOM_152[19];	// @[util.scala:466:20]
        uops_11_is_fence = _RANDOM_152[20];	// @[util.scala:466:20]
        uops_11_is_fencei = _RANDOM_152[21];	// @[util.scala:466:20]
        uops_11_is_amo = _RANDOM_152[22];	// @[util.scala:466:20]
        uops_11_uses_ldq = _RANDOM_152[23];	// @[util.scala:466:20]
        uops_11_uses_stq = _RANDOM_152[24];	// @[util.scala:466:20]
        uops_11_is_sys_pc2epc = _RANDOM_152[25];	// @[util.scala:466:20]
        uops_11_is_unique = _RANDOM_152[26];	// @[util.scala:466:20]
        uops_11_flush_on_commit = _RANDOM_152[27];	// @[util.scala:466:20]
        uops_11_ldst_is_rs1 = _RANDOM_152[28];	// @[util.scala:466:20]
        uops_11_ldst = {_RANDOM_152[31:29], _RANDOM_153[2:0]};	// @[util.scala:466:20]
        uops_11_lrs1 = _RANDOM_153[8:3];	// @[util.scala:466:20]
        uops_11_lrs2 = _RANDOM_153[14:9];	// @[util.scala:466:20]
        uops_11_lrs3 = _RANDOM_153[20:15];	// @[util.scala:466:20]
        uops_11_ldst_val = _RANDOM_153[21];	// @[util.scala:466:20]
        uops_11_dst_rtype = _RANDOM_153[23:22];	// @[util.scala:466:20]
        uops_11_lrs1_rtype = _RANDOM_153[25:24];	// @[util.scala:466:20]
        uops_11_lrs2_rtype = _RANDOM_153[27:26];	// @[util.scala:466:20]
        uops_11_frs3_en = _RANDOM_153[28];	// @[util.scala:466:20]
        uops_11_fp_val = _RANDOM_153[29];	// @[util.scala:466:20]
        uops_11_fp_single = _RANDOM_153[30];	// @[util.scala:466:20]
        uops_11_xcpt_pf_if = _RANDOM_153[31];	// @[util.scala:466:20]
        uops_11_xcpt_ae_if = _RANDOM_154[0];	// @[util.scala:466:20]
        uops_11_xcpt_ma_if = _RANDOM_154[1];	// @[util.scala:466:20]
        uops_11_bp_debug_if = _RANDOM_154[2];	// @[util.scala:466:20]
        uops_11_bp_xcpt_if = _RANDOM_154[3];	// @[util.scala:466:20]
        uops_11_debug_fsrc = _RANDOM_154[5:4];	// @[util.scala:466:20]
        uops_11_debug_tsrc = _RANDOM_154[7:6];	// @[util.scala:466:20]
        uops_12_uopc = _RANDOM_154[14:8];	// @[util.scala:466:20]
        uops_12_inst = {_RANDOM_154[31:15], _RANDOM_155[14:0]};	// @[util.scala:466:20]
        uops_12_debug_inst = {_RANDOM_155[31:15], _RANDOM_156[14:0]};	// @[util.scala:466:20]
        uops_12_is_rvc = _RANDOM_156[15];	// @[util.scala:466:20]
        uops_12_debug_pc = {_RANDOM_156[31:16], _RANDOM_157[23:0]};	// @[util.scala:466:20]
        uops_12_iq_type = _RANDOM_157[26:24];	// @[util.scala:466:20]
        uops_12_fu_code = {_RANDOM_157[31:27], _RANDOM_158[4:0]};	// @[util.scala:466:20]
        uops_12_ctrl_br_type = _RANDOM_158[8:5];	// @[util.scala:466:20]
        uops_12_ctrl_op1_sel = _RANDOM_158[10:9];	// @[util.scala:466:20]
        uops_12_ctrl_op2_sel = _RANDOM_158[13:11];	// @[util.scala:466:20]
        uops_12_ctrl_imm_sel = _RANDOM_158[16:14];	// @[util.scala:466:20]
        uops_12_ctrl_op_fcn = _RANDOM_158[20:17];	// @[util.scala:466:20]
        uops_12_ctrl_fcn_dw = _RANDOM_158[21];	// @[util.scala:466:20]
        uops_12_ctrl_csr_cmd = _RANDOM_158[24:22];	// @[util.scala:466:20]
        uops_12_ctrl_is_load = _RANDOM_158[25];	// @[util.scala:466:20]
        uops_12_ctrl_is_sta = _RANDOM_158[26];	// @[util.scala:466:20]
        uops_12_ctrl_is_std = _RANDOM_158[27];	// @[util.scala:466:20]
        uops_12_iw_state = _RANDOM_158[29:28];	// @[util.scala:466:20]
        uops_12_iw_p1_poisoned = _RANDOM_158[30];	// @[util.scala:466:20]
        uops_12_iw_p2_poisoned = _RANDOM_158[31];	// @[util.scala:466:20]
        uops_12_is_br = _RANDOM_159[0];	// @[util.scala:466:20]
        uops_12_is_jalr = _RANDOM_159[1];	// @[util.scala:466:20]
        uops_12_is_jal = _RANDOM_159[2];	// @[util.scala:466:20]
        uops_12_is_sfb = _RANDOM_159[3];	// @[util.scala:466:20]
        uops_12_br_mask = _RANDOM_159[19:4];	// @[util.scala:466:20]
        uops_12_br_tag = _RANDOM_159[23:20];	// @[util.scala:466:20]
        uops_12_ftq_idx = _RANDOM_159[28:24];	// @[util.scala:466:20]
        uops_12_edge_inst = _RANDOM_159[29];	// @[util.scala:466:20]
        uops_12_pc_lob = {_RANDOM_159[31:30], _RANDOM_160[3:0]};	// @[util.scala:466:20]
        uops_12_taken = _RANDOM_160[4];	// @[util.scala:466:20]
        uops_12_imm_packed = _RANDOM_160[24:5];	// @[util.scala:466:20]
        uops_12_csr_addr = {_RANDOM_160[31:25], _RANDOM_161[4:0]};	// @[util.scala:466:20]
        uops_12_rob_idx = _RANDOM_161[11:5];	// @[util.scala:466:20]
        uops_12_ldq_idx = _RANDOM_161[16:12];	// @[util.scala:466:20]
        uops_12_stq_idx = _RANDOM_161[21:17];	// @[util.scala:466:20]
        uops_12_rxq_idx = _RANDOM_161[23:22];	// @[util.scala:466:20]
        uops_12_pdst = _RANDOM_161[30:24];	// @[util.scala:466:20]
        uops_12_prs1 = {_RANDOM_161[31], _RANDOM_162[5:0]};	// @[util.scala:466:20]
        uops_12_prs2 = _RANDOM_162[12:6];	// @[util.scala:466:20]
        uops_12_prs3 = _RANDOM_162[19:13];	// @[util.scala:466:20]
        uops_12_ppred = _RANDOM_162[24:20];	// @[util.scala:466:20]
        uops_12_prs1_busy = _RANDOM_162[25];	// @[util.scala:466:20]
        uops_12_prs2_busy = _RANDOM_162[26];	// @[util.scala:466:20]
        uops_12_prs3_busy = _RANDOM_162[27];	// @[util.scala:466:20]
        uops_12_ppred_busy = _RANDOM_162[28];	// @[util.scala:466:20]
        uops_12_stale_pdst = {_RANDOM_162[31:29], _RANDOM_163[3:0]};	// @[util.scala:466:20]
        uops_12_exception = _RANDOM_163[4];	// @[util.scala:466:20]
        uops_12_exc_cause = {_RANDOM_163[31:5], _RANDOM_164, _RANDOM_165[4:0]};	// @[util.scala:466:20]
        uops_12_bypassable = _RANDOM_165[5];	// @[util.scala:466:20]
        uops_12_mem_cmd = _RANDOM_165[10:6];	// @[util.scala:466:20]
        uops_12_mem_size = _RANDOM_165[12:11];	// @[util.scala:466:20]
        uops_12_mem_signed = _RANDOM_165[13];	// @[util.scala:466:20]
        uops_12_is_fence = _RANDOM_165[14];	// @[util.scala:466:20]
        uops_12_is_fencei = _RANDOM_165[15];	// @[util.scala:466:20]
        uops_12_is_amo = _RANDOM_165[16];	// @[util.scala:466:20]
        uops_12_uses_ldq = _RANDOM_165[17];	// @[util.scala:466:20]
        uops_12_uses_stq = _RANDOM_165[18];	// @[util.scala:466:20]
        uops_12_is_sys_pc2epc = _RANDOM_165[19];	// @[util.scala:466:20]
        uops_12_is_unique = _RANDOM_165[20];	// @[util.scala:466:20]
        uops_12_flush_on_commit = _RANDOM_165[21];	// @[util.scala:466:20]
        uops_12_ldst_is_rs1 = _RANDOM_165[22];	// @[util.scala:466:20]
        uops_12_ldst = _RANDOM_165[28:23];	// @[util.scala:466:20]
        uops_12_lrs1 = {_RANDOM_165[31:29], _RANDOM_166[2:0]};	// @[util.scala:466:20]
        uops_12_lrs2 = _RANDOM_166[8:3];	// @[util.scala:466:20]
        uops_12_lrs3 = _RANDOM_166[14:9];	// @[util.scala:466:20]
        uops_12_ldst_val = _RANDOM_166[15];	// @[util.scala:466:20]
        uops_12_dst_rtype = _RANDOM_166[17:16];	// @[util.scala:466:20]
        uops_12_lrs1_rtype = _RANDOM_166[19:18];	// @[util.scala:466:20]
        uops_12_lrs2_rtype = _RANDOM_166[21:20];	// @[util.scala:466:20]
        uops_12_frs3_en = _RANDOM_166[22];	// @[util.scala:466:20]
        uops_12_fp_val = _RANDOM_166[23];	// @[util.scala:466:20]
        uops_12_fp_single = _RANDOM_166[24];	// @[util.scala:466:20]
        uops_12_xcpt_pf_if = _RANDOM_166[25];	// @[util.scala:466:20]
        uops_12_xcpt_ae_if = _RANDOM_166[26];	// @[util.scala:466:20]
        uops_12_xcpt_ma_if = _RANDOM_166[27];	// @[util.scala:466:20]
        uops_12_bp_debug_if = _RANDOM_166[28];	// @[util.scala:466:20]
        uops_12_bp_xcpt_if = _RANDOM_166[29];	// @[util.scala:466:20]
        uops_12_debug_fsrc = _RANDOM_166[31:30];	// @[util.scala:466:20]
        uops_12_debug_tsrc = _RANDOM_167[1:0];	// @[util.scala:466:20]
        uops_13_uopc = _RANDOM_167[8:2];	// @[util.scala:466:20]
        uops_13_inst = {_RANDOM_167[31:9], _RANDOM_168[8:0]};	// @[util.scala:466:20]
        uops_13_debug_inst = {_RANDOM_168[31:9], _RANDOM_169[8:0]};	// @[util.scala:466:20]
        uops_13_is_rvc = _RANDOM_169[9];	// @[util.scala:466:20]
        uops_13_debug_pc = {_RANDOM_169[31:10], _RANDOM_170[17:0]};	// @[util.scala:466:20]
        uops_13_iq_type = _RANDOM_170[20:18];	// @[util.scala:466:20]
        uops_13_fu_code = _RANDOM_170[30:21];	// @[util.scala:466:20]
        uops_13_ctrl_br_type = {_RANDOM_170[31], _RANDOM_171[2:0]};	// @[util.scala:466:20]
        uops_13_ctrl_op1_sel = _RANDOM_171[4:3];	// @[util.scala:466:20]
        uops_13_ctrl_op2_sel = _RANDOM_171[7:5];	// @[util.scala:466:20]
        uops_13_ctrl_imm_sel = _RANDOM_171[10:8];	// @[util.scala:466:20]
        uops_13_ctrl_op_fcn = _RANDOM_171[14:11];	// @[util.scala:466:20]
        uops_13_ctrl_fcn_dw = _RANDOM_171[15];	// @[util.scala:466:20]
        uops_13_ctrl_csr_cmd = _RANDOM_171[18:16];	// @[util.scala:466:20]
        uops_13_ctrl_is_load = _RANDOM_171[19];	// @[util.scala:466:20]
        uops_13_ctrl_is_sta = _RANDOM_171[20];	// @[util.scala:466:20]
        uops_13_ctrl_is_std = _RANDOM_171[21];	// @[util.scala:466:20]
        uops_13_iw_state = _RANDOM_171[23:22];	// @[util.scala:466:20]
        uops_13_iw_p1_poisoned = _RANDOM_171[24];	// @[util.scala:466:20]
        uops_13_iw_p2_poisoned = _RANDOM_171[25];	// @[util.scala:466:20]
        uops_13_is_br = _RANDOM_171[26];	// @[util.scala:466:20]
        uops_13_is_jalr = _RANDOM_171[27];	// @[util.scala:466:20]
        uops_13_is_jal = _RANDOM_171[28];	// @[util.scala:466:20]
        uops_13_is_sfb = _RANDOM_171[29];	// @[util.scala:466:20]
        uops_13_br_mask = {_RANDOM_171[31:30], _RANDOM_172[13:0]};	// @[util.scala:466:20]
        uops_13_br_tag = _RANDOM_172[17:14];	// @[util.scala:466:20]
        uops_13_ftq_idx = _RANDOM_172[22:18];	// @[util.scala:466:20]
        uops_13_edge_inst = _RANDOM_172[23];	// @[util.scala:466:20]
        uops_13_pc_lob = _RANDOM_172[29:24];	// @[util.scala:466:20]
        uops_13_taken = _RANDOM_172[30];	// @[util.scala:466:20]
        uops_13_imm_packed = {_RANDOM_172[31], _RANDOM_173[18:0]};	// @[util.scala:466:20]
        uops_13_csr_addr = _RANDOM_173[30:19];	// @[util.scala:466:20]
        uops_13_rob_idx = {_RANDOM_173[31], _RANDOM_174[5:0]};	// @[util.scala:466:20]
        uops_13_ldq_idx = _RANDOM_174[10:6];	// @[util.scala:466:20]
        uops_13_stq_idx = _RANDOM_174[15:11];	// @[util.scala:466:20]
        uops_13_rxq_idx = _RANDOM_174[17:16];	// @[util.scala:466:20]
        uops_13_pdst = _RANDOM_174[24:18];	// @[util.scala:466:20]
        uops_13_prs1 = _RANDOM_174[31:25];	// @[util.scala:466:20]
        uops_13_prs2 = _RANDOM_175[6:0];	// @[util.scala:466:20]
        uops_13_prs3 = _RANDOM_175[13:7];	// @[util.scala:466:20]
        uops_13_ppred = _RANDOM_175[18:14];	// @[util.scala:466:20]
        uops_13_prs1_busy = _RANDOM_175[19];	// @[util.scala:466:20]
        uops_13_prs2_busy = _RANDOM_175[20];	// @[util.scala:466:20]
        uops_13_prs3_busy = _RANDOM_175[21];	// @[util.scala:466:20]
        uops_13_ppred_busy = _RANDOM_175[22];	// @[util.scala:466:20]
        uops_13_stale_pdst = _RANDOM_175[29:23];	// @[util.scala:466:20]
        uops_13_exception = _RANDOM_175[30];	// @[util.scala:466:20]
        uops_13_exc_cause = {_RANDOM_175[31], _RANDOM_176, _RANDOM_177[30:0]};	// @[util.scala:466:20]
        uops_13_bypassable = _RANDOM_177[31];	// @[util.scala:466:20]
        uops_13_mem_cmd = _RANDOM_178[4:0];	// @[util.scala:466:20]
        uops_13_mem_size = _RANDOM_178[6:5];	// @[util.scala:466:20]
        uops_13_mem_signed = _RANDOM_178[7];	// @[util.scala:466:20]
        uops_13_is_fence = _RANDOM_178[8];	// @[util.scala:466:20]
        uops_13_is_fencei = _RANDOM_178[9];	// @[util.scala:466:20]
        uops_13_is_amo = _RANDOM_178[10];	// @[util.scala:466:20]
        uops_13_uses_ldq = _RANDOM_178[11];	// @[util.scala:466:20]
        uops_13_uses_stq = _RANDOM_178[12];	// @[util.scala:466:20]
        uops_13_is_sys_pc2epc = _RANDOM_178[13];	// @[util.scala:466:20]
        uops_13_is_unique = _RANDOM_178[14];	// @[util.scala:466:20]
        uops_13_flush_on_commit = _RANDOM_178[15];	// @[util.scala:466:20]
        uops_13_ldst_is_rs1 = _RANDOM_178[16];	// @[util.scala:466:20]
        uops_13_ldst = _RANDOM_178[22:17];	// @[util.scala:466:20]
        uops_13_lrs1 = _RANDOM_178[28:23];	// @[util.scala:466:20]
        uops_13_lrs2 = {_RANDOM_178[31:29], _RANDOM_179[2:0]};	// @[util.scala:466:20]
        uops_13_lrs3 = _RANDOM_179[8:3];	// @[util.scala:466:20]
        uops_13_ldst_val = _RANDOM_179[9];	// @[util.scala:466:20]
        uops_13_dst_rtype = _RANDOM_179[11:10];	// @[util.scala:466:20]
        uops_13_lrs1_rtype = _RANDOM_179[13:12];	// @[util.scala:466:20]
        uops_13_lrs2_rtype = _RANDOM_179[15:14];	// @[util.scala:466:20]
        uops_13_frs3_en = _RANDOM_179[16];	// @[util.scala:466:20]
        uops_13_fp_val = _RANDOM_179[17];	// @[util.scala:466:20]
        uops_13_fp_single = _RANDOM_179[18];	// @[util.scala:466:20]
        uops_13_xcpt_pf_if = _RANDOM_179[19];	// @[util.scala:466:20]
        uops_13_xcpt_ae_if = _RANDOM_179[20];	// @[util.scala:466:20]
        uops_13_xcpt_ma_if = _RANDOM_179[21];	// @[util.scala:466:20]
        uops_13_bp_debug_if = _RANDOM_179[22];	// @[util.scala:466:20]
        uops_13_bp_xcpt_if = _RANDOM_179[23];	// @[util.scala:466:20]
        uops_13_debug_fsrc = _RANDOM_179[25:24];	// @[util.scala:466:20]
        uops_13_debug_tsrc = _RANDOM_179[27:26];	// @[util.scala:466:20]
        uops_14_uopc = {_RANDOM_179[31:28], _RANDOM_180[2:0]};	// @[util.scala:466:20]
        uops_14_inst = {_RANDOM_180[31:3], _RANDOM_181[2:0]};	// @[util.scala:466:20]
        uops_14_debug_inst = {_RANDOM_181[31:3], _RANDOM_182[2:0]};	// @[util.scala:466:20]
        uops_14_is_rvc = _RANDOM_182[3];	// @[util.scala:466:20]
        uops_14_debug_pc = {_RANDOM_182[31:4], _RANDOM_183[11:0]};	// @[util.scala:466:20]
        uops_14_iq_type = _RANDOM_183[14:12];	// @[util.scala:466:20]
        uops_14_fu_code = _RANDOM_183[24:15];	// @[util.scala:466:20]
        uops_14_ctrl_br_type = _RANDOM_183[28:25];	// @[util.scala:466:20]
        uops_14_ctrl_op1_sel = _RANDOM_183[30:29];	// @[util.scala:466:20]
        uops_14_ctrl_op2_sel = {_RANDOM_183[31], _RANDOM_184[1:0]};	// @[util.scala:466:20]
        uops_14_ctrl_imm_sel = _RANDOM_184[4:2];	// @[util.scala:466:20]
        uops_14_ctrl_op_fcn = _RANDOM_184[8:5];	// @[util.scala:466:20]
        uops_14_ctrl_fcn_dw = _RANDOM_184[9];	// @[util.scala:466:20]
        uops_14_ctrl_csr_cmd = _RANDOM_184[12:10];	// @[util.scala:466:20]
        uops_14_ctrl_is_load = _RANDOM_184[13];	// @[util.scala:466:20]
        uops_14_ctrl_is_sta = _RANDOM_184[14];	// @[util.scala:466:20]
        uops_14_ctrl_is_std = _RANDOM_184[15];	// @[util.scala:466:20]
        uops_14_iw_state = _RANDOM_184[17:16];	// @[util.scala:466:20]
        uops_14_iw_p1_poisoned = _RANDOM_184[18];	// @[util.scala:466:20]
        uops_14_iw_p2_poisoned = _RANDOM_184[19];	// @[util.scala:466:20]
        uops_14_is_br = _RANDOM_184[20];	// @[util.scala:466:20]
        uops_14_is_jalr = _RANDOM_184[21];	// @[util.scala:466:20]
        uops_14_is_jal = _RANDOM_184[22];	// @[util.scala:466:20]
        uops_14_is_sfb = _RANDOM_184[23];	// @[util.scala:466:20]
        uops_14_br_mask = {_RANDOM_184[31:24], _RANDOM_185[7:0]};	// @[util.scala:466:20]
        uops_14_br_tag = _RANDOM_185[11:8];	// @[util.scala:466:20]
        uops_14_ftq_idx = _RANDOM_185[16:12];	// @[util.scala:466:20]
        uops_14_edge_inst = _RANDOM_185[17];	// @[util.scala:466:20]
        uops_14_pc_lob = _RANDOM_185[23:18];	// @[util.scala:466:20]
        uops_14_taken = _RANDOM_185[24];	// @[util.scala:466:20]
        uops_14_imm_packed = {_RANDOM_185[31:25], _RANDOM_186[12:0]};	// @[util.scala:466:20]
        uops_14_csr_addr = _RANDOM_186[24:13];	// @[util.scala:466:20]
        uops_14_rob_idx = _RANDOM_186[31:25];	// @[util.scala:466:20]
        uops_14_ldq_idx = _RANDOM_187[4:0];	// @[util.scala:466:20]
        uops_14_stq_idx = _RANDOM_187[9:5];	// @[util.scala:466:20]
        uops_14_rxq_idx = _RANDOM_187[11:10];	// @[util.scala:466:20]
        uops_14_pdst = _RANDOM_187[18:12];	// @[util.scala:466:20]
        uops_14_prs1 = _RANDOM_187[25:19];	// @[util.scala:466:20]
        uops_14_prs2 = {_RANDOM_187[31:26], _RANDOM_188[0]};	// @[util.scala:466:20]
        uops_14_prs3 = _RANDOM_188[7:1];	// @[util.scala:466:20]
        uops_14_ppred = _RANDOM_188[12:8];	// @[util.scala:466:20]
        uops_14_prs1_busy = _RANDOM_188[13];	// @[util.scala:466:20]
        uops_14_prs2_busy = _RANDOM_188[14];	// @[util.scala:466:20]
        uops_14_prs3_busy = _RANDOM_188[15];	// @[util.scala:466:20]
        uops_14_ppred_busy = _RANDOM_188[16];	// @[util.scala:466:20]
        uops_14_stale_pdst = _RANDOM_188[23:17];	// @[util.scala:466:20]
        uops_14_exception = _RANDOM_188[24];	// @[util.scala:466:20]
        uops_14_exc_cause = {_RANDOM_188[31:25], _RANDOM_189, _RANDOM_190[24:0]};	// @[util.scala:466:20]
        uops_14_bypassable = _RANDOM_190[25];	// @[util.scala:466:20]
        uops_14_mem_cmd = _RANDOM_190[30:26];	// @[util.scala:466:20]
        uops_14_mem_size = {_RANDOM_190[31], _RANDOM_191[0]};	// @[util.scala:466:20]
        uops_14_mem_signed = _RANDOM_191[1];	// @[util.scala:466:20]
        uops_14_is_fence = _RANDOM_191[2];	// @[util.scala:466:20]
        uops_14_is_fencei = _RANDOM_191[3];	// @[util.scala:466:20]
        uops_14_is_amo = _RANDOM_191[4];	// @[util.scala:466:20]
        uops_14_uses_ldq = _RANDOM_191[5];	// @[util.scala:466:20]
        uops_14_uses_stq = _RANDOM_191[6];	// @[util.scala:466:20]
        uops_14_is_sys_pc2epc = _RANDOM_191[7];	// @[util.scala:466:20]
        uops_14_is_unique = _RANDOM_191[8];	// @[util.scala:466:20]
        uops_14_flush_on_commit = _RANDOM_191[9];	// @[util.scala:466:20]
        uops_14_ldst_is_rs1 = _RANDOM_191[10];	// @[util.scala:466:20]
        uops_14_ldst = _RANDOM_191[16:11];	// @[util.scala:466:20]
        uops_14_lrs1 = _RANDOM_191[22:17];	// @[util.scala:466:20]
        uops_14_lrs2 = _RANDOM_191[28:23];	// @[util.scala:466:20]
        uops_14_lrs3 = {_RANDOM_191[31:29], _RANDOM_192[2:0]};	// @[util.scala:466:20]
        uops_14_ldst_val = _RANDOM_192[3];	// @[util.scala:466:20]
        uops_14_dst_rtype = _RANDOM_192[5:4];	// @[util.scala:466:20]
        uops_14_lrs1_rtype = _RANDOM_192[7:6];	// @[util.scala:466:20]
        uops_14_lrs2_rtype = _RANDOM_192[9:8];	// @[util.scala:466:20]
        uops_14_frs3_en = _RANDOM_192[10];	// @[util.scala:466:20]
        uops_14_fp_val = _RANDOM_192[11];	// @[util.scala:466:20]
        uops_14_fp_single = _RANDOM_192[12];	// @[util.scala:466:20]
        uops_14_xcpt_pf_if = _RANDOM_192[13];	// @[util.scala:466:20]
        uops_14_xcpt_ae_if = _RANDOM_192[14];	// @[util.scala:466:20]
        uops_14_xcpt_ma_if = _RANDOM_192[15];	// @[util.scala:466:20]
        uops_14_bp_debug_if = _RANDOM_192[16];	// @[util.scala:466:20]
        uops_14_bp_xcpt_if = _RANDOM_192[17];	// @[util.scala:466:20]
        uops_14_debug_fsrc = _RANDOM_192[19:18];	// @[util.scala:466:20]
        uops_14_debug_tsrc = _RANDOM_192[21:20];	// @[util.scala:466:20]
        uops_15_uopc = _RANDOM_192[28:22];	// @[util.scala:466:20]
        uops_15_inst = {_RANDOM_192[31:29], _RANDOM_193[28:0]};	// @[util.scala:466:20]
        uops_15_debug_inst = {_RANDOM_193[31:29], _RANDOM_194[28:0]};	// @[util.scala:466:20]
        uops_15_is_rvc = _RANDOM_194[29];	// @[util.scala:466:20]
        uops_15_debug_pc = {_RANDOM_194[31:30], _RANDOM_195, _RANDOM_196[5:0]};	// @[util.scala:466:20]
        uops_15_iq_type = _RANDOM_196[8:6];	// @[util.scala:466:20]
        uops_15_fu_code = _RANDOM_196[18:9];	// @[util.scala:466:20]
        uops_15_ctrl_br_type = _RANDOM_196[22:19];	// @[util.scala:466:20]
        uops_15_ctrl_op1_sel = _RANDOM_196[24:23];	// @[util.scala:466:20]
        uops_15_ctrl_op2_sel = _RANDOM_196[27:25];	// @[util.scala:466:20]
        uops_15_ctrl_imm_sel = _RANDOM_196[30:28];	// @[util.scala:466:20]
        uops_15_ctrl_op_fcn = {_RANDOM_196[31], _RANDOM_197[2:0]};	// @[util.scala:466:20]
        uops_15_ctrl_fcn_dw = _RANDOM_197[3];	// @[util.scala:466:20]
        uops_15_ctrl_csr_cmd = _RANDOM_197[6:4];	// @[util.scala:466:20]
        uops_15_ctrl_is_load = _RANDOM_197[7];	// @[util.scala:466:20]
        uops_15_ctrl_is_sta = _RANDOM_197[8];	// @[util.scala:466:20]
        uops_15_ctrl_is_std = _RANDOM_197[9];	// @[util.scala:466:20]
        uops_15_iw_state = _RANDOM_197[11:10];	// @[util.scala:466:20]
        uops_15_iw_p1_poisoned = _RANDOM_197[12];	// @[util.scala:466:20]
        uops_15_iw_p2_poisoned = _RANDOM_197[13];	// @[util.scala:466:20]
        uops_15_is_br = _RANDOM_197[14];	// @[util.scala:466:20]
        uops_15_is_jalr = _RANDOM_197[15];	// @[util.scala:466:20]
        uops_15_is_jal = _RANDOM_197[16];	// @[util.scala:466:20]
        uops_15_is_sfb = _RANDOM_197[17];	// @[util.scala:466:20]
        uops_15_br_mask = {_RANDOM_197[31:18], _RANDOM_198[1:0]};	// @[util.scala:466:20]
        uops_15_br_tag = _RANDOM_198[5:2];	// @[util.scala:466:20]
        uops_15_ftq_idx = _RANDOM_198[10:6];	// @[util.scala:466:20]
        uops_15_edge_inst = _RANDOM_198[11];	// @[util.scala:466:20]
        uops_15_pc_lob = _RANDOM_198[17:12];	// @[util.scala:466:20]
        uops_15_taken = _RANDOM_198[18];	// @[util.scala:466:20]
        uops_15_imm_packed = {_RANDOM_198[31:19], _RANDOM_199[6:0]};	// @[util.scala:466:20]
        uops_15_csr_addr = _RANDOM_199[18:7];	// @[util.scala:466:20]
        uops_15_rob_idx = _RANDOM_199[25:19];	// @[util.scala:466:20]
        uops_15_ldq_idx = _RANDOM_199[30:26];	// @[util.scala:466:20]
        uops_15_stq_idx = {_RANDOM_199[31], _RANDOM_200[3:0]};	// @[util.scala:466:20]
        uops_15_rxq_idx = _RANDOM_200[5:4];	// @[util.scala:466:20]
        uops_15_pdst = _RANDOM_200[12:6];	// @[util.scala:466:20]
        uops_15_prs1 = _RANDOM_200[19:13];	// @[util.scala:466:20]
        uops_15_prs2 = _RANDOM_200[26:20];	// @[util.scala:466:20]
        uops_15_prs3 = {_RANDOM_200[31:27], _RANDOM_201[1:0]};	// @[util.scala:466:20]
        uops_15_ppred = _RANDOM_201[6:2];	// @[util.scala:466:20]
        uops_15_prs1_busy = _RANDOM_201[7];	// @[util.scala:466:20]
        uops_15_prs2_busy = _RANDOM_201[8];	// @[util.scala:466:20]
        uops_15_prs3_busy = _RANDOM_201[9];	// @[util.scala:466:20]
        uops_15_ppred_busy = _RANDOM_201[10];	// @[util.scala:466:20]
        uops_15_stale_pdst = _RANDOM_201[17:11];	// @[util.scala:466:20]
        uops_15_exception = _RANDOM_201[18];	// @[util.scala:466:20]
        uops_15_exc_cause = {_RANDOM_201[31:19], _RANDOM_202, _RANDOM_203[18:0]};	// @[util.scala:466:20]
        uops_15_bypassable = _RANDOM_203[19];	// @[util.scala:466:20]
        uops_15_mem_cmd = _RANDOM_203[24:20];	// @[util.scala:466:20]
        uops_15_mem_size = _RANDOM_203[26:25];	// @[util.scala:466:20]
        uops_15_mem_signed = _RANDOM_203[27];	// @[util.scala:466:20]
        uops_15_is_fence = _RANDOM_203[28];	// @[util.scala:466:20]
        uops_15_is_fencei = _RANDOM_203[29];	// @[util.scala:466:20]
        uops_15_is_amo = _RANDOM_203[30];	// @[util.scala:466:20]
        uops_15_uses_ldq = _RANDOM_203[31];	// @[util.scala:466:20]
        uops_15_uses_stq = _RANDOM_204[0];	// @[util.scala:466:20]
        uops_15_is_sys_pc2epc = _RANDOM_204[1];	// @[util.scala:466:20]
        uops_15_is_unique = _RANDOM_204[2];	// @[util.scala:466:20]
        uops_15_flush_on_commit = _RANDOM_204[3];	// @[util.scala:466:20]
        uops_15_ldst_is_rs1 = _RANDOM_204[4];	// @[util.scala:466:20]
        uops_15_ldst = _RANDOM_204[10:5];	// @[util.scala:466:20]
        uops_15_lrs1 = _RANDOM_204[16:11];	// @[util.scala:466:20]
        uops_15_lrs2 = _RANDOM_204[22:17];	// @[util.scala:466:20]
        uops_15_lrs3 = _RANDOM_204[28:23];	// @[util.scala:466:20]
        uops_15_ldst_val = _RANDOM_204[29];	// @[util.scala:466:20]
        uops_15_dst_rtype = _RANDOM_204[31:30];	// @[util.scala:466:20]
        uops_15_lrs1_rtype = _RANDOM_205[1:0];	// @[util.scala:466:20]
        uops_15_lrs2_rtype = _RANDOM_205[3:2];	// @[util.scala:466:20]
        uops_15_frs3_en = _RANDOM_205[4];	// @[util.scala:466:20]
        uops_15_fp_val = _RANDOM_205[5];	// @[util.scala:466:20]
        uops_15_fp_single = _RANDOM_205[6];	// @[util.scala:466:20]
        uops_15_xcpt_pf_if = _RANDOM_205[7];	// @[util.scala:466:20]
        uops_15_xcpt_ae_if = _RANDOM_205[8];	// @[util.scala:466:20]
        uops_15_xcpt_ma_if = _RANDOM_205[9];	// @[util.scala:466:20]
        uops_15_bp_debug_if = _RANDOM_205[10];	// @[util.scala:466:20]
        uops_15_bp_xcpt_if = _RANDOM_205[11];	// @[util.scala:466:20]
        uops_15_debug_fsrc = _RANDOM_205[13:12];	// @[util.scala:466:20]
        uops_15_debug_tsrc = _RANDOM_205[15:14];	// @[util.scala:466:20]
        enq_ptr_value = _RANDOM_205[19:16];	// @[Counter.scala:61:40, util.scala:466:20]
        deq_ptr_value = _RANDOM_205[23:20];	// @[Counter.scala:61:40, util.scala:466:20]
        maybe_full = _RANDOM_205[24];	// @[util.scala:466:20, :470:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_combMem_41 ram_ext (	// @[util.scala:464:20]
  ...
  assign io_deq_bits_addr = _ram_ext_R0_data[449:410];	// @[util.scala:464:20]
  assign io_deq_bits_is_hella = _ram_ext_R0_data[514];	// @[util.scala:464:20]
  assign io_deq_bits_sdq_id = _ram_ext_R0_data[550:546];	// @[util.scala:464:20]
