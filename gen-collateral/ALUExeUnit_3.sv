...
module ALUExeUnit_3(
  ...
  `ifndef SYNTHESIS	// @[execution-unit.scala:416:10]
    wire [1:0] _T_20 = {1'h0, _alu_io_resp_valid} + {1'h0, _imul_io_resp_valid};	// @[Bitwise.scala:51:90, execution-unit.scala:262:17, :284:15, :317:18]
    always @(posedge clock) begin	// @[execution-unit.scala:416:10]
      if (~reset & _T_20[1]) begin	// @[Bitwise.scala:51:90, execution-unit.scala:416:{10,58}]
