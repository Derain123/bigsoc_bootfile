  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        a_first_counter_1 = _RANDOM_9[7:0];	// @[Edges.scala:229:27]
        d_first_counter_1 = _RANDOM_9[15:8];	// @[Edges.scala:229:27]
        watchdog = {_RANDOM_9[31:16], _RANDOM_10[15:0]};	// @[Edges.scala:229:27, Monitor.scala:706:27]
        d_first_counter_2 = _RANDOM_17[15:8];	// @[Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
