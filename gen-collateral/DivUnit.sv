...
module DivUnit(
  ...
  reg  [6:0]  r_uop_rob_idx;	// @[functional-unit.scala:642:18]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_uop_rob_idx = {_RANDOM_6[31:29], _RANDOM_7[3:0]};	// @[functional-unit.scala:642:18]
        r_uop_pdst = _RANDOM_7[22:16];	// @[functional-unit.scala:642:18]
        r_uop_bypassable = _RANDOM_10[29];	// @[functional-unit.scala:642:18]
        r_uop_is_amo = _RANDOM_11[8];	// @[functional-unit.scala:642:18]
        r_uop_uses_stq = _RANDOM_11[10];	// @[functional-unit.scala:642:18]
        r_uop_dst_rtype = _RANDOM_12[9:8];	// @[functional-unit.scala:642:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
