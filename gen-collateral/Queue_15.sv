...
module Queue_15(
  ...
  wire [110:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[16:9];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_address = _ram_ext_R0_data[37:17];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[45:38];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[109:46];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[110];	// @[Decoupled.scala:273:95]
endmodule
