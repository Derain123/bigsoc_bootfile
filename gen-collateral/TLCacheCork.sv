  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        wSourceVec_5 = _RANDOM_0[11];	// @[CacheCork.scala:139:29, Edges.scala:229:27]
        wSourceVec_6 = _RANDOM_0[12];	// @[CacheCork.scala:139:29, Edges.scala:229:27]
        wSourceVec_7 = _RANDOM_0[13];	// @[CacheCork.scala:139:29, Edges.scala:229:27]
        wSourceVec_8 = _RANDOM_0[14];	// @[CacheCork.scala:139:29, Edges.scala:229:27]
        wSourceVec_9 = _RANDOM_0[15];	// @[CacheCork.scala:139:29, Edges.scala:229:27]
        dWHeld_r = _RANDOM_0[16];	// @[Edges.scala:229:27, Reg.scala:19:16]
        beatsLeft = _RANDOM_0[19:17];	// @[Arbiter.scala:88:30, Edges.scala:229:27]
        state_0 = _RANDOM_0[20];	// @[Arbiter.scala:117:26, Edges.scala:229:27]
        state_1 = _RANDOM_0[21];	// @[Arbiter.scala:117:26, Edges.scala:229:27]
        beatsLeft_1 = _RANDOM_0[24:22];	// @[Arbiter.scala:88:30, Edges.scala:229:27]
        state_1_0 = _RANDOM_0[25];	// @[Arbiter.scala:117:26, Edges.scala:229:27]
        state_1_1 = _RANDOM_0[26];	// @[Arbiter.scala:117:26, Edges.scala:229:27]
        state_1_2 = _RANDOM_0[27];	// @[Arbiter.scala:117:26, Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
