  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_uops_0_ftq_idx = _RANDOM_5[22:18];	// @[functional-unit.scala:227:23]
        r_uops_0_edge_inst = _RANDOM_5[23];	// @[functional-unit.scala:227:23]
        r_uops_0_pc_lob = _RANDOM_5[29:24];	// @[functional-unit.scala:227:23]
        r_uops_0_taken = _RANDOM_5[30];	// @[functional-unit.scala:227:23]
        r_uops_0_imm_packed = {_RANDOM_5[31], _RANDOM_6[18:0]};	// @[functional-unit.scala:227:23]
        r_uops_0_csr_addr = _RANDOM_6[30:19];	// @[functional-unit.scala:227:23]
        r_uops_0_rob_idx = {_RANDOM_6[31], _RANDOM_7[5:0]};	// @[functional-unit.scala:227:23]
        r_uops_0_ldq_idx = _RANDOM_7[10:6];	// @[functional-unit.scala:227:23]
        r_uops_0_stq_idx = _RANDOM_7[15:11];	// @[functional-unit.scala:227:23]
        r_uops_0_rxq_idx = _RANDOM_7[17:16];	// @[functional-unit.scala:227:23]
        r_uops_0_pdst = _RANDOM_7[24:18];	// @[functional-unit.scala:227:23]
        r_uops_0_prs1 = _RANDOM_7[31:25];	// @[functional-unit.scala:227:23]
        r_uops_0_prs2 = _RANDOM_8[6:0];	// @[functional-unit.scala:227:23]
        r_uops_0_prs3 = _RANDOM_8[13:7];	// @[functional-unit.scala:227:23]
        r_uops_0_ppred = _RANDOM_8[18:14];	// @[functional-unit.scala:227:23]
        r_uops_0_prs1_busy = _RANDOM_8[19];	// @[functional-unit.scala:227:23]
        r_uops_0_prs2_busy = _RANDOM_8[20];	// @[functional-unit.scala:227:23]
        r_uops_0_prs3_busy = _RANDOM_8[21];	// @[functional-unit.scala:227:23]
        r_uops_0_ppred_busy = _RANDOM_8[22];	// @[functional-unit.scala:227:23]
        r_uops_0_stale_pdst = _RANDOM_8[29:23];	// @[functional-unit.scala:227:23]
        ...
        r_uops_1_ftq_idx = _RANDOM_18[16:12];	// @[functional-unit.scala:227:23]
        r_uops_1_edge_inst = _RANDOM_18[17];	// @[functional-unit.scala:227:23]
        r_uops_1_pc_lob = _RANDOM_18[23:18];	// @[functional-unit.scala:227:23]
        r_uops_1_taken = _RANDOM_18[24];	// @[functional-unit.scala:227:23]
        r_uops_1_imm_packed = {_RANDOM_18[31:25], _RANDOM_19[12:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_csr_addr = _RANDOM_19[24:13];	// @[functional-unit.scala:227:23]
        r_uops_1_rob_idx = _RANDOM_19[31:25];	// @[functional-unit.scala:227:23]
        ...
        r_uops_1_pdst = _RANDOM_20[18:12];	// @[functional-unit.scala:227:23]
        r_uops_1_prs1 = _RANDOM_20[25:19];	// @[functional-unit.scala:227:23]
        r_uops_1_prs2 = {_RANDOM_20[31:26], _RANDOM_21[0]};	// @[functional-unit.scala:227:23]
        r_uops_1_prs3 = _RANDOM_21[7:1];	// @[functional-unit.scala:227:23]
        r_uops_1_ppred = _RANDOM_21[12:8];	// @[functional-unit.scala:227:23]
        r_uops_1_prs1_busy = _RANDOM_21[13];	// @[functional-unit.scala:227:23]
        r_uops_1_prs2_busy = _RANDOM_21[14];	// @[functional-unit.scala:227:23]
        r_uops_1_prs3_busy = _RANDOM_21[15];	// @[functional-unit.scala:227:23]
        r_uops_1_ppred_busy = _RANDOM_21[16];	// @[functional-unit.scala:227:23]
        r_uops_1_stale_pdst = _RANDOM_21[23:17];	// @[functional-unit.scala:227:23]
        r_uops_1_exception = _RANDOM_21[24];	// @[functional-unit.scala:227:23]
        r_uops_1_exc_cause = {_RANDOM_21[31:25], _RANDOM_22, _RANDOM_23[24:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_bypassable = _RANDOM_23[25];	// @[functional-unit.scala:227:23]
        r_uops_1_mem_cmd = _RANDOM_23[30:26];	// @[functional-unit.scala:227:23]
        r_uops_1_mem_size = {_RANDOM_23[31], _RANDOM_24[0]};	// @[functional-unit.scala:227:23]
        r_uops_1_mem_signed = _RANDOM_24[1];	// @[functional-unit.scala:227:23]
        r_uops_1_is_fence = _RANDOM_24[2];	// @[functional-unit.scala:227:23]
        r_uops_1_is_fencei = _RANDOM_24[3];	// @[functional-unit.scala:227:23]
        r_uops_1_is_amo = _RANDOM_24[4];	// @[functional-unit.scala:227:23]
        r_uops_1_uses_ldq = _RANDOM_24[5];	// @[functional-unit.scala:227:23]
        r_uops_1_uses_stq = _RANDOM_24[6];	// @[functional-unit.scala:227:23]
        r_uops_1_is_sys_pc2epc = _RANDOM_24[7];	// @[functional-unit.scala:227:23]
        r_uops_1_is_unique = _RANDOM_24[8];	// @[functional-unit.scala:227:23]
        r_uops_1_flush_on_commit = _RANDOM_24[9];	// @[functional-unit.scala:227:23]
        r_uops_1_ldst_is_rs1 = _RANDOM_24[10];	// @[functional-unit.scala:227:23]
        r_uops_1_ldst = _RANDOM_24[16:11];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs1 = _RANDOM_24[22:17];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs2 = _RANDOM_24[28:23];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs3 = {_RANDOM_24[31:29], _RANDOM_25[2:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_ldst_val = _RANDOM_25[3];	// @[functional-unit.scala:227:23]
        r_uops_1_dst_rtype = _RANDOM_25[5:4];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs1_rtype = _RANDOM_25[7:6];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs2_rtype = _RANDOM_25[9:8];	// @[functional-unit.scala:227:23]
        r_uops_1_frs3_en = _RANDOM_25[10];	// @[functional-unit.scala:227:23]
        r_uops_1_fp_val = _RANDOM_25[11];	// @[functional-unit.scala:227:23]
        r_uops_1_fp_single = _RANDOM_25[12];	// @[functional-unit.scala:227:23]
        r_uops_1_xcpt_pf_if = _RANDOM_25[13];	// @[functional-unit.scala:227:23]
        r_uops_1_xcpt_ae_if = _RANDOM_25[14];	// @[functional-unit.scala:227:23]
        r_uops_1_xcpt_ma_if = _RANDOM_25[15];	// @[functional-unit.scala:227:23]
        r_uops_1_bp_debug_if = _RANDOM_25[16];	// @[functional-unit.scala:227:23]
        r_uops_1_bp_xcpt_if = _RANDOM_25[17];	// @[functional-unit.scala:227:23]
        r_uops_1_debug_fsrc = _RANDOM_25[19:18];	// @[functional-unit.scala:227:23]
        r_uops_1_debug_tsrc = _RANDOM_25[21:20];	// @[functional-unit.scala:227:23]
        out_double_v = _RANDOM_25[22];	// @[Valid.scala:130:22, functional-unit.scala:227:23]
        out_double_b = _RANDOM_25[23];	// @[Reg.scala:19:16, functional-unit.scala:227:23]
        out_double_outPipe_bits = _RANDOM_25[25];	// @[Reg.scala:19:16, functional-unit.scala:227:23]
      `endif // RANDOMIZE_REG_INIT
    end // initial
