...
module BoomMSHR(
  ...
  wire [7:0]       beats1 = io_mem_grant_bits_opcode[0] ? ~(_beats1_decode_T_1[11:4]) : 8'h0;	// @[Edges.scala:106:36, :221:14, :229:27, package.scala:235:{46,71,76}]
  reg  [7:0]       counter;	// @[Edges.scala:229:27]
  wire [7:0]       counter1 = counter - 8'h1;	// @[Edges.scala:229:27, :230:28]
  wire             refill_done = (counter == 8'h1 | beats1 == 8'h0) & _T_204;	// @[Decoupled.scala:51:35, Edges.scala:221:14, :229:27, :232:{25,33,43}, :233:22]
  ...
  wire [15:0][1:0] _GEN_13 = {{2'h3}, {2'h3}, {2'h2}, {_T_287}, {_T_287}, {_T_287}, {_T_287}, {_T_287}, {2'h3}, {2'h2}, {2'h2}, {2'h1}, {2'h3}, {2'h2}, {2'h1}, {2'h0}};	// @[Cat.scala:33:92, Metadata.scala:161:16, Misc.scala:34:36, :48:20, Mux.scala:81:58]
  ...
  wire [15:0][1:0] _GEN_14 = {{2'h3}, {2'h3}, {2'h2}, {_state_T_124}, {_state_T_124}, {_state_T_124}, {_state_T_124}, {_state_T_124}, {2'h3}, {2'h2}, {2'h2}, {2'h1}, {2'h3}, {2'h2}, {2'h1}, {2'h0}};	// @[Cat.scala:33:92, Metadata.scala:161:16, Misc.scala:34:36, :48:20, Mux.scala:81:58]
  ...
  wire [15:0][1:0] _GEN_15 = {{2'h3}, {2'h3}, {2'h2}, {_T_364}, {_T_364}, {_T_364}, {_T_364}, {_T_364}, {2'h3}, {2'h2}, {2'h2}, {2'h1}, {2'h3}, {2'h2}, {2'h1}, {2'h0}};	// @[Cat.scala:33:92, Metadata.scala:161:16, Misc.scala:34:36, :48:20, Mux.scala:81:58]
  wire [1:0]       _state_T_30 = {1'h0, _state_T_3 == 4'hC};	// @[Cat.scala:33:92, Misc.scala:34:36, :48:20, mshrs.scala:109:20, package.scala:16:47]
  wire [15:0][1:0] _GEN_16 = {{2'h3}, {2'h3}, {2'h2}, {_state_T_30}, {_state_T_30}, {_state_T_30}, {_state_T_30}, {_state_T_30}, {2'h3}, {2'h2}, {2'h2}, {2'h1}, {2'h3}, {2'h2}, {2'h1}, {2'h0}};	// @[Cat.scala:33:92, Metadata.scala:161:16, Misc.scala:34:36, :48:20, Mux.scala:81:58]
  ...
  wire [15:0][1:0] _GEN_17 = {{2'h3}, {2'h3}, {2'h2}, {_T_93}, {_T_93}, {_T_93}, {_T_93}, {_T_93}, {2'h3}, {2'h2}, {2'h2}, {2'h1}, {2'h3}, {2'h2}, {2'h1}, {2'h0}};	// @[Cat.scala:33:92, Metadata.scala:161:16, Misc.scala:34:36, :48:20, Mux.scala:81:58]
  ...
  wire [15:0][1:0] _GEN_18 = {{2'h3}, {2'h3}, {2'h2}, {_T_154}, {_T_154}, {_T_154}, {_T_154}, {_T_154}, {2'h3}, {2'h2}, {2'h2}, {2'h1}, {2'h3}, {2'h2}, {2'h1}, {2'h0}};	// @[Cat.scala:33:92, Metadata.scala:161:16, Misc.scala:34:36, :48:20, Mux.scala:81:58]
  ...
  wire             _GEN_20 = _T_336 & (&dirties_cat);	// @[Cat.scala:33:92, Metadata.scala:106:42, :109:27, mshrs.scala:109:20, :133:78, :172:43, :173:21]
  ...
  always @(posedge clock) begin
    ...
    if ((|state) ? ~_GEN_12 & _T_332 & ~_GEN_21 & _T_397 | _GEN_20 : _T_397 | _GEN_20)	// @[Metadata.scala:109:27, mshrs.scala:107:22, :109:20, :133:40, :141:27, :157:26, :172:43, :173:21, :184:9, :204:30, :208:45, :211:40, :222:41, :245:45, :283:39, :291:41, :293:41, :297:40, :307:36, :319:37, :323:41, :339:39, :352:44, :362:42, :369:42, :371:38, :373:69, :375:52, :384:52, package.scala:16:47]
    ...
    if (|state) begin	// @[mshrs.scala:107:22, package.scala:16:47]
      ...
      if (_GEN_3) begin	// @[mshrs.scala:160:26, :211:40, :222:41, :245:45, :283:39, :291:41, :293:41, :297:40, :307:36, :319:37, :323:41]
        ...
        refill_ctr <= 2'h0;	// @[Metadata.scala:161:16, mshrs.scala:139:24]
    end
    else begin	// @[package.scala:16:47]
    ...
    if (_GEN_0 | ~(_T_203 & refill_done)) begin	// @[Edges.scala:233:22, mshrs.scala:138:21, :169:26, :204:30, :211:40, :222:41, :236:24, :238:21, package.scala:16:47]
    end
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[mshrs.scala:131:9]
      ...
      if (_GEN_24 & _T_203 & refill_done & ~reset & ~grant_had_data & req_needs_wb) begin	// @[Edges.scala:233:22, mshrs.scala:113:29, :141:27, :211:40, :240:{13,16}, package.scala:16:47]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_uop_mem_cmd = _RANDOM_11[7:3];	// @[mshrs.scala:109:20]
        req_addr = {_RANDOM_12[31], _RANDOM_13, _RANDOM_14[6:0]};	// @[mshrs.scala:109:20]
        req_old_meta_coh_state = _RANDOM_16[10:9];	// @[mshrs.scala:109:20]
        req_old_meta_tag = _RANDOM_16[30:11];	// @[mshrs.scala:109:20]
        req_way_en = {_RANDOM_16[31], _RANDOM_17[6:0]};	// @[mshrs.scala:109:20]
        req_needs_wb = _RANDOM_17[12];	// @[mshrs.scala:109:20, :113:29]
        new_coh_state = _RANDOM_17[14:13];	// @[mshrs.scala:109:20, :115:24]
        counter = _RANDOM_17[22:15];	// @[Edges.scala:229:27, mshrs.scala:109:20]
        grantack_valid = _RANDOM_17[23];	// @[mshrs.scala:109:20, :138:21]
        grantack_bits_sink = _RANDOM_17[27:24];	// @[mshrs.scala:109:20, :138:21]
        refill_ctr = _RANDOM_17[29:28];	// @[mshrs.scala:109:20, :139:24]
        commit_line = _RANDOM_17[30];	// @[mshrs.scala:109:20, :140:24]
        grant_had_data = _RANDOM_17[31];	// @[mshrs.scala:109:20, :141:27]
        finish_to_prefetch = _RANDOM_18[0];	// @[mshrs.scala:142:31]
        meta_hazard = _RANDOM_18[2:1];	// @[mshrs.scala:142:31, :145:28]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_mem_acquire_bits_param = {1'h0, _GEN[_grow_param_T]};	// @[Cat.scala:33:92, Edges.scala:349:15, Misc.scala:34:36, :48:20, mshrs.scala:109:20]
  assign io_mem_acquire_bits_source = {1'h0, io_id};	// @[Edges.scala:351:15, mshrs.scala:109:20]
  assign io_mem_acquire_bits_address = {req_addr[31:6], 6'h0};	// @[Cat.scala:33:92, Edges.scala:352:15, mshrs.scala:109:20]
  ...
  assign io_lb_write_valid = ~_GEN_0 & _T_203 & io_mem_grant_bits_opcode[0] & io_mem_grant_valid;	// @[Edges.scala:106:36, mshrs.scala:169:26, :204:30, :211:40, :222:41, package.scala:16:47]
  assign io_lb_write_bits_id = io_id;
  assign io_lb_write_bits_offset = beats1[1:0] & ~(counter1[1:0]);	// @[Edges.scala:221:14, :230:28, :234:{25,27}]
