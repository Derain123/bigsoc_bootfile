...
module RenameBusyTable_1(
  ...
  always @(posedge clock) begin
    if (reset)
      ...
      busy_table <= busy_table & ~(_busy_table_wb_T[95:0] & {96{io_wb_valids_0}} | _busy_table_wb_T_4[95:0] & {96{io_wb_valids_1}}) | _busy_table_next_T[95:0] & {96{io_rebusy_reqs_0}} | _busy_table_next_T_4[95:0] & {96{io_rebusy_reqs_1}} | _busy_table_next_T_8[95:0] & {96{io_rebusy_reqs_2}};	// @[Bitwise.scala:77:12, OneHot.scala:57:35, rename-busytable.scala:48:27, :50:{34,36}, :51:{48,88}, :53:39, :54:49]
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_1 = `RANDOM;
        _RANDOM_2 = `RANDOM;
        busy_table = {_RANDOM_0, _RANDOM_1, _RANDOM_2};	// @[rename-busytable.scala:48:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
