...
module Queue_73(
  ...
  wire [174:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[173:46];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[174];	// @[Decoupled.scala:273:95]
endmodule
