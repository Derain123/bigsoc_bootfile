...
module SinkC(
  ...
  output         io_bs_adr_valid,
                 io_bs_adr_bits_noop,
  output [5:0]   io_bs_adr_bits_way,
  output [3:0]   io_bs_adr_bits_set,
  ...
  wire [6:0]   _c_io_deq_bits_source;	// @[Decoupled.scala:375:21]
  ...
  reg  [3:0]   io_set_r;	// @[Reg.scala:19:16]
  wire [3:0]   _io_set_output = _c_io_deq_valid ? _c_io_deq_bits_address[9:6] : io_set_r;	// @[Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :216:28, Reg.scala:19:16, SinkC.scala:92:18]
  ...
  always @(posedge clock) begin
    ...
    if (_c_io_deq_valid) begin	// @[Decoupled.scala:375:21]
      ...
      io_set_r <= _c_io_deq_bits_address[9:6];	// @[Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :216:28, Reg.scala:19:16]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        resp_r = _RANDOM_0[2];	// @[Edges.scala:229:27, Reg.scala:19:16]
        io_set_r = _RANDOM_0[6:3];	// @[Edges.scala:229:27, Reg.scala:19:16]
        io_bs_dat_data_r = {_RANDOM_0[31:7], _RANDOM_1, _RANDOM_2, _RANDOM_3, _RANDOM_4[6:0]};	// @[Edges.scala:229:27, Reg.scala:19:16]
        bs_adr_bits_beat_r = _RANDOM_4[8:7];	// @[Reg.scala:19:16]
        lists = _RANDOM_4[10:9];	// @[Reg.scala:19:16, SinkC.scala:116:24]
        put_r = _RANDOM_4[12:11];	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_req_bits_tag = _c_io_deq_bits_address[27:10];	// @[Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :215:19]
  ...
  assign io_req_bits_set = _c_io_deq_bits_address[9:6];	// @[Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :216:28]
  ...
  assign io_resp_bits_set = _c_io_deq_bits_address[9:6];	// @[Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :216:28]
  assign io_resp_bits_tag = _c_io_deq_bits_address[27:10];	// @[Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :215:19]
