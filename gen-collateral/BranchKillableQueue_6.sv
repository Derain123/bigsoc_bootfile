...
module BranchKillableQueue_6(
  ...
  wire [891:0]     _ram_ext_R0_data;	// @[util.scala:464:20]
  ...
  wire [7:0][6:0]  _GEN_3 = {{uops_0_rob_idx}, {uops_6_rob_idx}, {uops_5_rob_idx}, {uops_4_rob_idx}, {uops_3_rob_idx}, {uops_2_rob_idx}, {uops_1_rob_idx}, {uops_0_rob_idx}};	// @[util.scala:466:20, :508:19]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uops_0_rob_idx = _RANDOM_7[10:4];	// @[util.scala:466:20]
        uops_0_stq_idx = _RANDOM_7[20:16];	// @[util.scala:466:20]
        uops_0_pdst = _RANDOM_7[29:23];	// @[util.scala:466:20]
        uops_0_is_amo = _RANDOM_11[15];	// @[util.scala:466:20]
        uops_0_uses_stq = _RANDOM_11[17];	// @[util.scala:466:20]
        uops_0_dst_rtype = _RANDOM_12[16:15];	// @[util.scala:466:20]
        uops_0_fp_val = _RANDOM_12[22];	// @[util.scala:466:20]
        uops_1_uopc = _RANDOM_13[7:1];	// @[util.scala:466:20]
        uops_1_br_mask = {_RANDOM_17[31:29], _RANDOM_18[12:0]};	// @[util.scala:466:20]
        uops_1_rob_idx = {_RANDOM_19[31:30], _RANDOM_20[4:0]};	// @[util.scala:466:20]
        uops_1_stq_idx = _RANDOM_20[14:10];	// @[util.scala:466:20]
        uops_1_pdst = _RANDOM_20[23:17];	// @[util.scala:466:20]
        uops_1_is_amo = _RANDOM_24[9];	// @[util.scala:466:20]
        uops_1_uses_stq = _RANDOM_24[11];	// @[util.scala:466:20]
        uops_1_dst_rtype = _RANDOM_25[10:9];	// @[util.scala:466:20]
        uops_1_fp_val = _RANDOM_25[16];	// @[util.scala:466:20]
        uops_2_uopc = {_RANDOM_25[31:27], _RANDOM_26[1:0]};	// @[util.scala:466:20]
        uops_2_br_mask = {_RANDOM_30[31:23], _RANDOM_31[6:0]};	// @[util.scala:466:20]
        uops_2_rob_idx = _RANDOM_32[30:24];	// @[util.scala:466:20]
        uops_2_stq_idx = _RANDOM_33[8:4];	// @[util.scala:466:20]
        uops_2_pdst = _RANDOM_33[17:11];	// @[util.scala:466:20]
        uops_2_is_amo = _RANDOM_37[3];	// @[util.scala:466:20]
        uops_2_uses_stq = _RANDOM_37[5];	// @[util.scala:466:20]
        uops_2_dst_rtype = _RANDOM_38[4:3];	// @[util.scala:466:20]
        uops_2_fp_val = _RANDOM_38[10];	// @[util.scala:466:20]
        uops_3_uopc = _RANDOM_38[27:21];	// @[util.scala:466:20]
        uops_3_br_mask = {_RANDOM_43[31:17], _RANDOM_44[0]};	// @[util.scala:466:20]
        uops_3_rob_idx = _RANDOM_45[24:18];	// @[util.scala:466:20]
        uops_3_stq_idx = {_RANDOM_45[31:30], _RANDOM_46[2:0]};	// @[util.scala:466:20]
        uops_3_pdst = _RANDOM_46[11:5];	// @[util.scala:466:20]
        uops_3_is_amo = _RANDOM_49[29];	// @[util.scala:466:20]
        uops_3_uses_stq = _RANDOM_49[31];	// @[util.scala:466:20]
        uops_3_dst_rtype = _RANDOM_50[30:29];	// @[util.scala:466:20]
        uops_3_fp_val = _RANDOM_51[4];	// @[util.scala:466:20]
        uops_4_uopc = _RANDOM_51[21:15];	// @[util.scala:466:20]
        uops_4_br_mask = _RANDOM_56[26:11];	// @[util.scala:466:20]
        uops_4_rob_idx = _RANDOM_58[18:12];	// @[util.scala:466:20]
        uops_4_stq_idx = _RANDOM_58[28:24];	// @[util.scala:466:20]
        uops_4_pdst = {_RANDOM_58[31], _RANDOM_59[5:0]};	// @[util.scala:466:20]
        uops_4_is_amo = _RANDOM_62[23];	// @[util.scala:466:20]
        uops_4_uses_stq = _RANDOM_62[25];	// @[util.scala:466:20]
        uops_4_dst_rtype = _RANDOM_63[24:23];	// @[util.scala:466:20]
        uops_4_fp_val = _RANDOM_63[30];	// @[util.scala:466:20]
        uops_5_uopc = _RANDOM_64[15:9];	// @[util.scala:466:20]
        uops_5_br_mask = _RANDOM_69[20:5];	// @[util.scala:466:20]
        uops_5_rob_idx = _RANDOM_71[12:6];	// @[util.scala:466:20]
        uops_5_stq_idx = _RANDOM_71[22:18];	// @[util.scala:466:20]
        uops_5_pdst = _RANDOM_71[31:25];	// @[util.scala:466:20]
        uops_5_is_amo = _RANDOM_75[17];	// @[util.scala:466:20]
        uops_5_uses_stq = _RANDOM_75[19];	// @[util.scala:466:20]
        uops_5_dst_rtype = _RANDOM_76[18:17];	// @[util.scala:466:20]
        uops_5_fp_val = _RANDOM_76[24];	// @[util.scala:466:20]
        uops_6_uopc = _RANDOM_77[9:3];	// @[util.scala:466:20]
        uops_6_br_mask = {_RANDOM_81[31], _RANDOM_82[14:0]};	// @[util.scala:466:20]
        uops_6_rob_idx = _RANDOM_84[6:0];	// @[util.scala:466:20]
        uops_6_stq_idx = _RANDOM_84[16:12];	// @[util.scala:466:20]
        uops_6_pdst = _RANDOM_84[25:19];	// @[util.scala:466:20]
        uops_6_is_amo = _RANDOM_88[11];	// @[util.scala:466:20]
        uops_6_uses_stq = _RANDOM_88[13];	// @[util.scala:466:20]
        uops_6_dst_rtype = _RANDOM_89[12:11];	// @[util.scala:466:20]
        uops_6_fp_val = _RANDOM_89[18];	// @[util.scala:466:20]
        enq_ptr_value = _RANDOM_89[31:29];	// @[Counter.scala:61:40, util.scala:466:20]
        deq_ptr_value = _RANDOM_90[2:0];	// @[Counter.scala:61:40]
        maybe_full = _RANDOM_90[3];	// @[Counter.scala:61:40, util.scala:470:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_combMem_45 ram_ext (	// @[util.scala:464:20]
  ...
  assign io_deq_bits_data = _io_empty_output ? io_enq_bits_data : _ram_ext_R0_data[474:410];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_predicated = ~_io_empty_output & _ram_ext_R0_data[475];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_fflags_valid = _io_empty_output ? io_enq_bits_fflags_valid : _ram_ext_R0_data[476];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_fflags_bits_uop_rob_idx = _io_empty_output ? io_enq_bits_fflags_bits_uop_rob_idx : _ram_ext_R0_data[704:698];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_fflags_bits_flags = _io_empty_output ? io_enq_bits_fflags_bits_flags : _ram_ext_R0_data[891:887];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
