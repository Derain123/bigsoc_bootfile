...
module TLMonitor_105(
  ...
  `ifndef SYNTHESIS
    ...
    wire  [8255:0]   _GEN_20 = {8242'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44, OneHot.scala:64:12]
    ...
    wire  [2063:0]   _T_697 = 2064'h0 >> _GEN_21;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [8255:0]   _c_size_lookup_T_1 = 8256'h0 >> _GEN_20;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_7 & ~reset & (|_GEN_8)) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:137:{45,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(io_in_a_bits_source < 12'h810 & _GEN_8 == 8'h0)) begin	// @[Monitor.scala:42:11, :88:31, :114:53, :115:71, Parameters.scala:57:20, :137:{45,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_source < 12'h810 & _GEN_8 == 8'h0)) begin	// @[Monitor.scala:42:11, :88:31, :122:56, :123:74, Parameters.scala:57:20, :137:{45,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_22 & ~reset & ~(io_in_d_bits_opcode == _GEN_1[io_in_a_bits_opcode] | io_in_d_bits_opcode == _GEN_0[io_in_a_bits_opcode])) begin	// @[Monitor.scala:49:11, :684:30, :685:{38,77}, :686:39]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_23 & ~reset & ~(io_in_d_bits_opcode == _GEN_1[_a_opcode_lookup_T_1[3:1]] | io_in_d_bits_opcode == _GEN_0[_a_opcode_lookup_T_1[3:1]])) begin	// @[Monitor.scala:49:11, :634:44, :684:30, :685:38, :686:39, :689:{38,72}, :690:38]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper opcode response (connected at HasChipyardPRCI.scala:41:5)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
