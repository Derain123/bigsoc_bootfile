  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cam_a_0_bits_source = _RANDOM_0[18:11];	// @[AtomicAutomata.scala:78:28, :79:24]
        ...
        beatsLeft = _RANDOM_6[4:2];	// @[Arbiter.scala:88:30, AtomicAutomata.scala:80:24]
        state_0 = _RANDOM_6[5];	// @[Arbiter.scala:117:26, AtomicAutomata.scala:80:24]
        state_1 = _RANDOM_6[6];	// @[Arbiter.scala:117:26, AtomicAutomata.scala:80:24]
        d_first_counter = _RANDOM_6[9:7];	// @[AtomicAutomata.scala:80:24, Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
