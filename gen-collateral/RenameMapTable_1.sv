...
module RenameMapTable_1(
  ...
  wire [31:0]      _GEN_32 = _remap_ldsts_oh_T[31:0] & {32{io_remap_reqs_0_valid}};	// @[Bitwise.scala:77:12, OneHot.scala:57:35, rename-maptable.scala:78:69]
  wire [63:0]      _remap_ldsts_oh_T_3 = 64'h1 << io_remap_reqs_1_ldst;	// @[OneHot.scala:57:35]
  wire [31:0]      _GEN_33 = _remap_ldsts_oh_T_3[31:0] & {32{io_remap_reqs_1_valid}};	// @[Bitwise.scala:77:12, OneHot.scala:57:35, rename-maptable.scala:78:69]
  wire [63:0]      _remap_ldsts_oh_T_6 = 64'h1 << io_remap_reqs_2_ldst;	// @[OneHot.scala:57:35]
  wire [31:0]      _GEN_34 = _remap_ldsts_oh_T_6[31:0] & {32{io_remap_reqs_2_valid}};	// @[Bitwise.scala:77:12, OneHot.scala:57:35, rename-maptable.scala:78:69]
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_GEN_34[31])	// @[rename-maptable.scala:78:69, :87:58]
        map_table_31 <= io_remap_reqs_2_pdst;	// @[rename-maptable.scala:70:26]
      else if (_GEN_33[31])	// @[rename-maptable.scala:78:69, :87:58]
        map_table_31 <= io_remap_reqs_1_pdst;	// @[rename-maptable.scala:70:26]
      else if (_GEN_32[31])	// @[rename-maptable.scala:78:69, :87:58]
    ...
    if (io_ren_br_tags_2_valid & io_ren_br_tags_2_bits == 4'h0) begin	// @[rename-maptable.scala:98:36, :99:44]
      ...
      if (_GEN_33[30])	// @[rename-maptable.scala:78:69, :87:58]
        ...
        br_snapshots_0_30 <= map_table_30;	// @[rename-maptable.scala:70:26, :71:25]
      if (_GEN_33[31])	// @[rename-maptable.scala:78:69, :87:58]
        br_snapshots_0_31 <= io_remap_reqs_1_pdst;	// @[rename-maptable.scala:71:25]
      else if (_GEN_32[31])	// @[rename-maptable.scala:78:69, :87:58]
        br_snapshots_0_31 <= io_remap_reqs_0_pdst;	// @[rename-maptable.scala:71:25]
      else	// @[rename-maptable.scala:87:58]
      ...
      if (_GEN_32[30])	// @[rename-maptable.scala:78:69, :87:58]
        ...
        br_snapshots_0_30 <= map_table_30;	// @[rename-maptable.scala:70:26, :71:25]
      if (_GEN_32[31])	// @[rename-maptable.scala:78:69, :87:58]
        br_snapshots_0_31 <= io_remap_reqs_0_pdst;	// @[rename-maptable.scala:71:25]
      else	// @[rename-maptable.scala:87:58]
        br_snapshots_0_31 <= map_table_31;	// @[rename-maptable.scala:70:26, :71:25]
    end
