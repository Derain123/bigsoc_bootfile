...
module ICache_3(
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        counter = {_RANDOM_3[31:26], _RANDOM_4[1:0]};	// @[Edges.scala:229:27]
        accruedRefillError = _RANDOM_4[2];	// @[Edges.scala:229:27, ICache.scala:420:31]
        vb_array = {_RANDOM_4[31:3], _RANDOM_5, _RANDOM_6, _RANDOM_7, _RANDOM_8, _RANDOM_9, _RANDOM_10, _RANDOM_11, _RANDOM_12[2:0]};	// @[Edges.scala:229:27, ICache.scala:440:25]
  ...
  tag_array_2 tag_array (	// @[DescribedSRAM.scala:17:26]
