...
module RenameBusyTable(
  ...
  wire [127:0] _busy_table_next_T_8 = 128'h1 << io_ren_uops_2_pdst;	// @[OneHot.scala:57:35]
  ...
  wire [127:0] _busy_table_wb_T_24 = 128'h1 << io_wb_pdsts_6;	// @[OneHot.scala:57:35]
  wire [127:0] _busy_table_wb_T_20 = 128'h1 << io_wb_pdsts_5;	// @[OneHot.scala:57:35]
  wire [127:0] _busy_table_wb_T_16 = 128'h1 << io_wb_pdsts_4;	// @[OneHot.scala:57:35]
  wire [127:0] _busy_table_wb_T_12 = 128'h1 << io_wb_pdsts_3;	// @[OneHot.scala:57:35]
  wire [127:0] _busy_table_wb_T_8 = 128'h1 << io_wb_pdsts_2;	// @[OneHot.scala:57:35]
  wire [127:0] _busy_table_wb_T_4 = 128'h1 << io_wb_pdsts_1;	// @[OneHot.scala:57:35]
  wire [127:0] _busy_table_wb_T = 128'h1 << io_wb_pdsts_0;	// @[OneHot.scala:57:35]
  always @(posedge clock) begin
    if (reset)
      busy_table <= 100'h0;	// @[rename-busytable.scala:48:27]
    else
      busy_table <= busy_table & ~(_busy_table_wb_T[99:0] & {100{io_wb_valids_0}} | _busy_table_wb_T_4[99:0] & {100{io_wb_valids_1}} | _busy_table_wb_T_8[99:0] & {100{io_wb_valids_2}} | _busy_table_wb_T_12[99:0] & {100{io_wb_valids_3}} | _busy_table_wb_T_16[99:0] & {100{io_wb_valids_4}} | _busy_table_wb_T_20[99:0] & {100{io_wb_valids_5}} | _busy_table_wb_T_24[99:0] & {100{io_wb_valids_6}}) | _busy_table_next_T[99:0] & {100{io_rebusy_reqs_0}} | _busy_table_next_T_4[99:0] & {100{io_rebusy_reqs_1}} | _busy_table_next_T_8[99:0] & {100{io_rebusy_reqs_2}};	// @[Bitwise.scala:77:12, OneHot.scala:57:35, rename-busytable.scala:48:27, :50:{34,36}, :51:{48,88}, :53:39, :54:49]
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_2 = `RANDOM;
        _RANDOM_3 = `RANDOM;
        busy_table = {_RANDOM_0, _RANDOM_1, _RANDOM_2, _RANDOM_3[3:0]};	// @[rename-busytable.scala:48:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
