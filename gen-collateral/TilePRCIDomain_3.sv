...
module TilePRCIDomain_3(
  ...
  input  [3:0]   auto_tile_reset_domain_tile_hartid_in,
  ...
  wire [2:0]   _buffer_auto_in_b_bits_source;	// @[Buffer.scala:69:28]
  ...
  wire [2:0]   _tile_reset_domain_tile_auto_buffer_out_a_bits_source;	// @[HasTiles.scala:251:53]
  wire [31:0]  _tile_reset_domain_tile_auto_buffer_out_a_bits_address;	// @[HasTiles.scala:251:53]
  wire [15:0]  _tile_reset_domain_tile_auto_buffer_out_a_bits_mask;	// @[HasTiles.scala:251:53]
  wire [127:0] _tile_reset_domain_tile_auto_buffer_out_a_bits_data;	// @[HasTiles.scala:251:53]
  wire         _tile_reset_domain_tile_auto_buffer_out_a_bits_corrupt;	// @[HasTiles.scala:251:53]
  ...
  wire [2:0]   _tile_reset_domain_tile_auto_buffer_out_c_bits_source;	// @[HasTiles.scala:251:53]
  wire [31:0]  _tile_reset_domain_tile_auto_buffer_out_c_bits_address;	// @[HasTiles.scala:251:53]
  wire [127:0] _tile_reset_domain_tile_auto_buffer_out_c_bits_data;	// @[HasTiles.scala:251:53]
  wire         _tile_reset_domain_tile_auto_buffer_out_c_bits_corrupt;	// @[HasTiles.scala:251:53]
  ...
  wire [3:0]   _tile_reset_domain_tile_auto_buffer_out_e_bits_sink;	// @[HasTiles.scala:251:53]
  ...
  RocketTile tile_reset_domain_tile (	// @[HasTiles.scala:251:53]
    ...
    .auto_buffer_out_a_bits_corrupt (_tile_reset_domain_tile_auto_buffer_out_a_bits_corrupt),
    ...
    .auto_buffer_out_c_bits_corrupt (_tile_reset_domain_tile_auto_buffer_out_c_bits_corrupt),
  ...
  TLBuffer_27 buffer (	// @[Buffer.scala:69:28]
    .clock                   (auto_tap_clock_in_clock),
    .reset                   (auto_tap_clock_in_reset),
    ...
    .auto_in_a_bits_corrupt  (_tile_reset_domain_tile_auto_buffer_out_a_bits_corrupt),	// @[HasTiles.scala:251:53]
    ...
    .auto_in_c_bits_corrupt  (_tile_reset_domain_tile_auto_buffer_out_c_bits_corrupt),	// @[HasTiles.scala:251:53]
