...
module Frontend(
  ...
  ICache_3 icache (	// @[Frontend.scala:65:26]
    .clock                          (clock),
    .reset                          (reset),
  ...
  TLB_4 tlb (	// @[Frontend.scala:100:19]
    .clock                         (clock),
    .reset                         (reset),
