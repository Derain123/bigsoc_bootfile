...
module SourceD(
  ...
  input  [5:0]   io_req_bits_offset,
                 io_req_bits_put,
  input  [3:0]   io_req_bits_set,
                 io_req_bits_sink,
  input  [5:0]   io_req_bits_way,
  ...
  input  [3:0]   io_evict_req_set,
  input  [5:0]   io_evict_req_way,
  input  [3:0]   io_grant_req_set,
  input  [5:0]   io_grant_req_way,
  output         io_req_ready,
                 io_d_valid,
  ...
  output         io_rel_pop_bits_last,
                 io_bs_radr_valid,
  output [5:0]   io_bs_radr_bits_way,
  output [3:0]   io_bs_radr_bits_set,
  output [1:0]   io_bs_radr_bits_beat,
                 io_bs_radr_bits_mask,
  output         io_bs_wadr_valid,
  output [5:0]   io_bs_wadr_bits_way,
  output [3:0]   io_bs_wadr_bits_set,
  ...
  wire [3:0]      s1_req_set = busy ? s1_req_reg_set : io_req_bits_set;	// @[Reg.scala:19:16, SourceD.scala:84:21, :88:19]
  wire [5:0]      s1_req_way = busy ? s1_req_reg_way : io_req_bits_way;	// @[Reg.scala:19:16, SourceD.scala:84:21, :88:19]
  ...
  reg  [6:0]      s3_req_source;	// @[Reg.scala:19:16]
  reg  [5:0]      s3_req_offset;	// @[Reg.scala:19:16]
  reg  [3:0]      s3_req_set;	// @[Reg.scala:19:16]
  reg  [3:0]      s3_req_sink;	// @[Reg.scala:19:16]
  reg  [5:0]      s3_req_way;	// @[Reg.scala:19:16]
  ...
  reg  [3:0]      s4_req_set;	// @[Reg.scala:19:16]
  reg  [5:0]      s4_req_way;	// @[Reg.scala:19:16]
  ...
  reg  [3:0]      s5_req_set;	// @[Reg.scala:19:16]
  reg  [5:0]      s5_req_way;	// @[Reg.scala:19:16]
  ...
  reg  [3:0]      s6_req_set;	// @[Reg.scala:19:16]
  reg  [5:0]      s6_req_way;	// @[Reg.scala:19:16]
  ...
  wire [3:0]      pre_s3_req_set = s3_latch ? s2_req_set : s3_req_set;	// @[Reg.scala:19:16, SourceD.scala:177:18, :315:24]
  wire [5:0]      pre_s3_req_way = s3_latch ? s2_req_way : s3_req_way;	// @[Reg.scala:19:16, SourceD.scala:177:18, :315:24]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_reg_source = _RANDOM_0[23:17];	// @[Reg.scala:19:16, SourceD.scala:84:21]
        s1_req_reg_offset = _RANDOM_1[15:10];	// @[Reg.scala:19:16]
        s1_req_reg_put = _RANDOM_1[21:16];	// @[Reg.scala:19:16]
        s1_req_reg_set = _RANDOM_1[25:22];	// @[Reg.scala:19:16]
        s1_req_reg_sink = _RANDOM_1[29:26];	// @[Reg.scala:19:16]
        s1_req_reg_way = {_RANDOM_1[31:30], _RANDOM_2[3:0]};	// @[Reg.scala:19:16]
        s1_req_reg_bad = _RANDOM_2[4];	// @[Reg.scala:19:16]
        s1_latch_bypass = _RANDOM_2[5];	// @[Reg.scala:19:16, SourceD.scala:90:32]
        s1_bypass_r = _RANDOM_2[7:6];	// @[Reg.scala:19:16]
        queue_io_enq_valid_REG = _RANDOM_2[8];	// @[Reg.scala:19:16, SourceD.scala:121:40]
        queue_io_enq_valid_REG_1 = _RANDOM_2[9];	// @[Reg.scala:19:16, SourceD.scala:121:32]
        s2_full = _RANDOM_2[10];	// @[Reg.scala:19:16, SourceD.scala:147:24]
        s2_valid_pb = _RANDOM_2[11];	// @[Reg.scala:19:16, SourceD.scala:148:28]
        s2_beat = _RANDOM_2[13:12];	// @[Reg.scala:19:16]
        s2_bypass = _RANDOM_2[15:14];	// @[Reg.scala:19:16]
        s2_req_prio_0 = _RANDOM_2[16];	// @[Reg.scala:19:16]
        s2_req_prio_2 = _RANDOM_2[18];	// @[Reg.scala:19:16]
        s2_req_opcode = _RANDOM_2[22:20];	// @[Reg.scala:19:16]
        s2_req_param = _RANDOM_2[25:23];	// @[Reg.scala:19:16]
        s2_req_size = _RANDOM_2[28:26];	// @[Reg.scala:19:16]
        s2_req_source = {_RANDOM_2[31:29], _RANDOM_3[3:0]};	// @[Reg.scala:19:16]
        s2_req_offset = _RANDOM_3[27:22];	// @[Reg.scala:19:16]
        s2_req_put = {_RANDOM_3[31:28], _RANDOM_4[1:0]};	// @[Reg.scala:19:16]
        s2_req_set = _RANDOM_4[5:2];	// @[Reg.scala:19:16]
        s2_req_sink = _RANDOM_4[9:6];	// @[Reg.scala:19:16]
        s2_req_way = _RANDOM_4[15:10];	// @[Reg.scala:19:16]
        s2_req_bad = _RANDOM_4[16];	// @[Reg.scala:19:16]
        s2_last = _RANDOM_4[17];	// @[Reg.scala:19:16]
        s2_need_r = _RANDOM_4[18];	// @[Reg.scala:19:16]
        s2_need_pb = _RANDOM_4[19];	// @[Reg.scala:19:16]
        s2_retires = _RANDOM_4[20];	// @[Reg.scala:19:16]
        s2_need_d = _RANDOM_4[21];	// @[Reg.scala:19:16]
        s2_pdata_r_data = {_RANDOM_4[31:22], _RANDOM_5, _RANDOM_6, _RANDOM_7, _RANDOM_8[21:0]};	// @[Reg.scala:19:16]
        s2_pdata_r_mask = {_RANDOM_8[31:22], _RANDOM_9[5:0]};	// @[Reg.scala:19:16]
        s2_pdata_r_corrupt = _RANDOM_9[6];	// @[Reg.scala:19:16]
        s3_full = _RANDOM_9[7];	// @[Reg.scala:19:16, SourceD.scala:190:24]
        s3_valid_d = _RANDOM_9[8];	// @[Reg.scala:19:16, SourceD.scala:191:27]
        s3_beat = _RANDOM_9[10:9];	// @[Reg.scala:19:16]
        s3_bypass = _RANDOM_9[12:11];	// @[Reg.scala:19:16]
        s3_req_prio_0 = _RANDOM_9[13];	// @[Reg.scala:19:16]
        s3_req_prio_2 = _RANDOM_9[15];	// @[Reg.scala:19:16]
        s3_req_opcode = _RANDOM_9[19:17];	// @[Reg.scala:19:16]
        s3_req_param = _RANDOM_9[22:20];	// @[Reg.scala:19:16]
        s3_req_size = _RANDOM_9[25:23];	// @[Reg.scala:19:16]
        s3_req_source = {_RANDOM_9[31:26], _RANDOM_10[0]};	// @[Reg.scala:19:16]
        s3_req_offset = _RANDOM_10[24:19];	// @[Reg.scala:19:16]
        s3_req_set = {_RANDOM_10[31], _RANDOM_11[2:0]};	// @[Reg.scala:19:16]
        s3_req_sink = _RANDOM_11[6:3];	// @[Reg.scala:19:16]
        s3_req_way = _RANDOM_11[12:7];	// @[Reg.scala:19:16]
        s3_req_bad = _RANDOM_11[13];	// @[Reg.scala:19:16]
        s3_pdata_data = {_RANDOM_11[31:15], _RANDOM_12, _RANDOM_13, _RANDOM_14, _RANDOM_15[14:0]};	// @[Reg.scala:19:16]
        s3_pdata_mask = _RANDOM_15[30:15];	// @[Reg.scala:19:16]
        s3_pdata_corrupt = _RANDOM_15[31];	// @[Reg.scala:19:16]
        s3_need_bs = _RANDOM_16[0];	// @[Reg.scala:19:16]
        s3_retires = _RANDOM_16[1];	// @[Reg.scala:19:16]
        s3_need_r = _RANDOM_16[2];	// @[Reg.scala:19:16]
        s4_full = _RANDOM_16[3];	// @[Reg.scala:19:16, SourceD.scala:248:24]
        s4_beat = _RANDOM_16[5:4];	// @[Reg.scala:19:16]
        s4_need_bs = _RANDOM_16[7];	// @[Reg.scala:19:16]
        s4_need_pb = _RANDOM_16[8];	// @[Reg.scala:19:16]
        s4_req_prio_2 = _RANDOM_16[11];	// @[Reg.scala:19:16]
        s4_req_param = _RANDOM_16[18:16];	// @[Reg.scala:19:16]
        s4_req_size = _RANDOM_16[21:19];	// @[Reg.scala:19:16]
        s4_req_offset = _RANDOM_17[20:15];	// @[Reg.scala:19:16]
        s4_req_set = _RANDOM_17[30:27];	// @[Reg.scala:19:16]
        s4_req_way = _RANDOM_18[8:3];	// @[Reg.scala:19:16]
        s4_adjusted_opcode = _RANDOM_18[12:10];	// @[Reg.scala:19:16]
        s4_pdata_data = {_RANDOM_18[31:13], _RANDOM_19, _RANDOM_20, _RANDOM_21, _RANDOM_22[12:0]};	// @[Reg.scala:19:16]
        s4_pdata_mask = _RANDOM_22[28:13];	// @[Reg.scala:19:16]
        s4_pdata_corrupt = _RANDOM_22[29];	// @[Reg.scala:19:16]
        s4_rdata = {_RANDOM_22[31:30], _RANDOM_23, _RANDOM_24, _RANDOM_25, _RANDOM_26[29:0]};	// @[Reg.scala:19:16]
        s5_req_size = _RANDOM_27[10:8];	// @[Reg.scala:19:16]
        s5_req_offset = _RANDOM_28[9:4];	// @[Reg.scala:19:16]
        s5_req_set = _RANDOM_28[19:16];	// @[Reg.scala:19:16]
        s5_req_way = _RANDOM_28[29:24];	// @[Reg.scala:19:16]
        s5_beat = {_RANDOM_28[31], _RANDOM_29[0]};	// @[Reg.scala:19:16]
        s5_dat = {_RANDOM_29[31:1], _RANDOM_30, _RANDOM_31, _RANDOM_32, _RANDOM_33[0]};	// @[Reg.scala:19:16]
        s6_req_size = _RANDOM_33[13:11];	// @[Reg.scala:19:16]
        s6_req_offset = _RANDOM_34[12:7];	// @[Reg.scala:19:16]
        s6_req_set = _RANDOM_34[22:19];	// @[Reg.scala:19:16]
        s6_req_way = {_RANDOM_34[31:27], _RANDOM_35[0]};	// @[Reg.scala:19:16]
        s6_beat = _RANDOM_35[3:2];	// @[Reg.scala:19:16]
        s6_dat = {_RANDOM_35[31:4], _RANDOM_36, _RANDOM_37, _RANDOM_38, _RANDOM_39[3:0]};	// @[Reg.scala:19:16]
        s7_dat = {_RANDOM_39[31:4], _RANDOM_40, _RANDOM_41, _RANDOM_42, _RANDOM_43[3:0]};	// @[Reg.scala:19:16]
        s3_bypass_data_REG = _RANDOM_43[5:4];	// @[Reg.scala:19:16, SourceD.scala:337:19]
        s3_bypass_data_REG_1 = {_RANDOM_43[31:6], _RANDOM_44, _RANDOM_45, _RANDOM_46, _RANDOM_47[5:0]};	// @[Reg.scala:19:16, SourceD.scala:337:66]
      `endif // RANDOMIZE_REG_INIT
    end // initial
