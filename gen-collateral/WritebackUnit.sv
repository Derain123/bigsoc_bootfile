...
module WritebackUnit(
  ...
  output [10:0]  io_data_req_bits_addr,
  ...
  reg  [20:0] req_tag;	// @[NBDcache.scala:469:16]
  reg  [4:0]  req_idx;	// @[NBDcache.scala:469:16]
  reg  [1:0]  req_source;	// @[NBDcache.scala:469:16]
  reg  [2:0]  req_param;	// @[NBDcache.scala:469:16]
  reg  [7:0]  req_way_en;	// @[NBDcache.scala:469:16]
  ...
  reg  [2:0]  data_req_cnt;	// @[NBDcache.scala:473:29]
  wire        _io_data_req_valid_output = active & ~(data_req_cnt[2]);	// @[NBDcache.scala:470:23, :473:29, :493:32, :505:{21,37}]
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin
      ...
      data_req_cnt <= 3'h0;	// @[NBDcache.scala:473:29]
    end
    else begin
      active <= _T_6 | (active & r2_data_req_fired & ~r1_data_req_fired ? ~(data_req_cnt[2]) | ~io_release_ready : active);	// @[Decoupled.scala:51:35, NBDcache.scala:470:23, :471:34, :472:34, :473:29, :477:17, :484:30, :486:12, :491:{12,32}, :493:{16,32,49}, :497:22, :498:12]
      ...
      if (_T_6)	// @[Decoupled.scala:51:35]
        ...
        if (_GEN)	// @[NBDcache.scala:480:50, :484:30, :486:31, :487:27]
          data_req_cnt <= data_req_cnt - {1'h0, r1_data_req_fired ? 2'h2 : 2'h1};	// @[NBDcache.scala:469:16, :471:34, :473:29, :489:{38,49}]
        else if (_T_3)	// @[NBDcache.scala:480:28]
          data_req_cnt <= data_req_cnt + 3'h1;	// @[NBDcache.scala:473:29, :482:36]
      end
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        _RANDOM_1 = `RANDOM;
        req_tag = _RANDOM_0[20:0];	// @[NBDcache.scala:469:16]
        req_idx = _RANDOM_0[25:21];	// @[NBDcache.scala:469:16]
        req_source = _RANDOM_0[27:26];	// @[NBDcache.scala:469:16]
        req_param = _RANDOM_0[30:28];	// @[NBDcache.scala:469:16]
        req_way_en = {_RANDOM_0[31], _RANDOM_1[6:0]};	// @[NBDcache.scala:469:16]
        req_voluntary = _RANDOM_1[7];	// @[NBDcache.scala:469:16]
        active = _RANDOM_1[8];	// @[NBDcache.scala:469:16, :470:23]
        r1_data_req_fired = _RANDOM_1[9];	// @[NBDcache.scala:469:16, :471:34]
        r2_data_req_fired = _RANDOM_1[10];	// @[NBDcache.scala:469:16, :472:34]
        data_req_cnt = _RANDOM_1[13:11];	// @[NBDcache.scala:469:16, :473:29]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_data_req_bits_addr = {req_idx, data_req_cnt[1:0], 4'h0};	// @[NBDcache.scala:469:16, :473:29, :516:56, :517:43]
