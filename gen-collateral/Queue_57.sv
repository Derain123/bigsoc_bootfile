...
module Queue_57(
  ...
  wire [176:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[175:48];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[176];	// @[Decoupled.scala:273:95]
endmodule
