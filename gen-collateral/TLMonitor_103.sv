...
module TLMonitor_103(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (a_first_done ? _a_set_T[2063:0] : 2064'h0)) & ~(d_first_done ? _d_clr_T[2063:0] : 2064'h0);	// @[Decoupled.scala:51:35, Monitor.scala:611:27, :623:34, :652:72, :653:28, :661:34, :675:91, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (a_first_done ? _a_opcodes_set_T_1[8255:0] : 8256'h0)) & ~(d_first_done ? _d_opcodes_clr_T_5[8255:0] : 8256'h0);	// @[Decoupled.scala:51:35, Monitor.scala:613:35, :627:33, :652:72, :656:{28,54}, :665:33, :675:91, :677:{21,76}, :703:{43,60,62}, :725:35]
      inflight_sizes <= (inflight_sizes | (a_first_done ? _a_sizes_set_T_1[8255:0] : 8256'h0)) & ~(d_first_done ? _d_sizes_clr_T_5[8255:0] : 8256'h0);	// @[Decoupled.scala:51:35, Monitor.scala:615:33, :629:31, :652:72, :657:{28,52}, :667:31, :675:91, :678:{21,74}, :704:{39,54,56}, :725:35]
  ...
  `ifndef SYNTHESIS
    ...
    wire  [8255:0]   _GEN_14 = {8242'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44, OneHot.scala:64:12]
    wire  [8255:0]   _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_14;	// @[Monitor.scala:613:35, :634:44]
    ...
    wire  [2063:0]   _T_593 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [2063:0]   _T_612 = inflight >> io_in_d_bits_source;	// @[Monitor.scala:611:27, :682:25]
    wire  [8255:0]   _a_size_lookup_T_1 = inflight_sizes >> _GEN_14;	// @[Monitor.scala:615:33, :634:44, :638:40]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (io_in_d_valid & ~reset & io_in_d_bits_source > 12'h80F) begin	// @[Monitor.scala:49:11, Parameters.scala:57:20]
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inflight_opcodes =
          {_RANDOM_66[31:12],
           ...
           _RANDOM_322,
           _RANDOM_323,
           _RANDOM_324[11:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes =
          {_RANDOM_324[31:12],
           _RANDOM_325,
           _RANDOM_326,
           ...
           _RANDOM_580,
           _RANDOM_581,
           _RANDOM_582[11:0]};	// @[Monitor.scala:613:35, :615:33]
        watchdog = {_RANDOM_582[31:14], _RANDOM_583[13:0]};	// @[Monitor.scala:615:33, :706:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
