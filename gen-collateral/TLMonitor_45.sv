...
module TLMonitor_45(
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_28 = _T_2312 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    ...
    wire  [128:0]    _T_2313 = inflight >> _GEN_27;	// @[Monitor.scala:611:27, :682:25]
    ...
    wire  [128:0]    _T_2399 = 129'h0 >> _GEN_27;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~((io_in_a_bits_source[7:3] == 5'h4 & io_in_a_bits_source[2:0] < 3'h5 & _T_633 | io_in_a_bits_source[7:3] == 5'h2 & io_in_a_bits_source[2:0] < 3'h5 & _T_633 | ~(|(io_in_a_bits_source[7:3])) & io_in_a_bits_source[2:0] < 3'h5 & _T_633 | io_in_a_bits_source[7:1] == 7'h3C & _T_633 | io_in_a_bits_source[7:1] == 7'h38 & _T_633 | io_in_a_bits_source[7:1] == 7'h34 & _T_633 | io_in_a_bits_source[7:1] == 7'h30 & _T_633 | io_in_a_bits_source[7:1] == 7'h2C & _T_633 | io_in_a_bits_source[7:1] == 7'h28 & _T_633 | io_in_a_bits_source[7:1] == 7'h24 & _T_633 | io_in_a_bits_source[7:1] == 7'h20 & _T_633) & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :81:54, :83:78, Mux.scala:27:73, Parameters.scala:46:9, :52:64, :54:{10,32}, :57:20, :91:48, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~_T_1081) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :92:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~((io_in_a_bits_source[7:4] == 4'h3 | io_in_a_bits_source[7:3] == 5'h4 & io_in_a_bits_source[2:0] < 3'h5 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | io_in_a_bits_source[7:3] == 5'h2 & io_in_a_bits_source[2:0] < 3'h5 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | ~(|(io_in_a_bits_source[7:3])) & io_in_a_bits_source[2:0] < 3'h5 | _source_ok_WIRE_8 | _source_ok_WIRE_9 | io_in_a_bits_source[7:1] == 7'h3C | _source_ok_WIRE_11 | _source_ok_WIRE_12 | io_in_a_bits_source[7:1] == 7'h38 | _source_ok_WIRE_14 | _source_ok_WIRE_15 | io_in_a_bits_source[7:1] == 7'h34 | _source_ok_WIRE_17 | _source_ok_WIRE_18 | io_in_a_bits_source[7:1] == 7'h30 | _source_ok_WIRE_20 | _source_ok_WIRE_21 | io_in_a_bits_source[7:1] == 7'h2C | _source_ok_WIRE_23 | _source_ok_WIRE_24 | io_in_a_bits_source[7:1] == 7'h28 | _source_ok_WIRE_26 | _source_ok_WIRE_27 | io_in_a_bits_source[7:1] == 7'h24 | _source_ok_WIRE_29 | _source_ok_WIRE_30 | io_in_a_bits_source[7:1] == 7'h20 | _source_ok_WIRE_32 | _source_ok_WIRE_33 | _source_ok_WIRE_34) & io_in_a_bits_size != 3'h7 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :92:25, :114:53, :115:71, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:{31,65}, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~((io_in_a_bits_source[7:4] == 4'h3 | io_in_a_bits_source[7:3] == 5'h4 & io_in_a_bits_source[2:0] < 3'h5 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | io_in_a_bits_source[7:3] == 5'h2 & io_in_a_bits_source[2:0] < 3'h5 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | ~(|(io_in_a_bits_source[7:3])) & io_in_a_bits_source[2:0] < 3'h5 | _source_ok_WIRE_8 | _source_ok_WIRE_9 | io_in_a_bits_source[7:1] == 7'h3C | _source_ok_WIRE_11 | _source_ok_WIRE_12 | io_in_a_bits_source[7:1] == 7'h38 | _source_ok_WIRE_14 | _source_ok_WIRE_15 | io_in_a_bits_source[7:1] == 7'h34 | _source_ok_WIRE_17 | _source_ok_WIRE_18 | io_in_a_bits_source[7:1] == 7'h30 | _source_ok_WIRE_20 | _source_ok_WIRE_21 | io_in_a_bits_source[7:1] == 7'h2C | _source_ok_WIRE_23 | _source_ok_WIRE_24 | io_in_a_bits_source[7:1] == 7'h28 | _source_ok_WIRE_26 | _source_ok_WIRE_27 | io_in_a_bits_source[7:1] == 7'h24 | _source_ok_WIRE_29 | _source_ok_WIRE_30 | io_in_a_bits_source[7:1] == 7'h20 | _source_ok_WIRE_32 | _source_ok_WIRE_33 | _source_ok_WIRE_34) & io_in_a_bits_size != 3'h7 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :92:25, :122:56, :123:74, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:{31,65}, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        address = {_RANDOM_0[31:20], _RANDOM_1[13:0]};	// @[Edges.scala:229:27, Monitor.scala:388:22]
        d_first_counter = _RANDOM_1[16:14];	// @[Edges.scala:229:27, Monitor.scala:388:22]
        ...
        source_1 = {_RANDOM_1[31:25], _RANDOM_2[0]};	// @[Monitor.scala:388:22, :538:22]
        sink = _RANDOM_2[1];	// @[Monitor.scala:538:22, :539:22]
        denied = _RANDOM_2[2];	// @[Monitor.scala:538:22, :540:22]
        inflight = {_RANDOM_2[31:3], _RANDOM_3, _RANDOM_4, _RANDOM_5, _RANDOM_6[3:0]};	// @[Monitor.scala:538:22, :611:27]
        inflight_opcodes = {_RANDOM_6[31:4], _RANDOM_7, _RANDOM_8, _RANDOM_9, _RANDOM_10, _RANDOM_11, _RANDOM_12, _RANDOM_13, _RANDOM_14, _RANDOM_15, _RANDOM_16, _RANDOM_17, _RANDOM_18, _RANDOM_19, _RANDOM_20, _RANDOM_21, _RANDOM_22[7:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes = {_RANDOM_22[31:8], _RANDOM_23, _RANDOM_24, _RANDOM_25, _RANDOM_26, _RANDOM_27, _RANDOM_28, _RANDOM_29, _RANDOM_30, _RANDOM_31, _RANDOM_32, _RANDOM_33, _RANDOM_34, _RANDOM_35, _RANDOM_36, _RANDOM_37, _RANDOM_38[11:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = _RANDOM_38[14:12];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_38[17:15];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_38[31:18], _RANDOM_39[17:0]};	// @[Monitor.scala:615:33, :706:27]
        d_first_counter_2 = {_RANDOM_75[31:30], _RANDOM_76[0]};	// @[Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
