  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        doneAW = _RANDOM_0[3];	// @[Edges.scala:229:27, ToAXI4.scala:164:30]
        r_holds_d = _RANDOM_0[4];	// @[Edges.scala:229:27, ToAXI4.scala:209:30]
        b_delay = _RANDOM_0[7:5];	// @[Edges.scala:229:27, ToAXI4.scala:212:24]
        r_first = _RANDOM_0[8];	// @[Edges.scala:229:27, ToAXI4.scala:227:28]
        r_denied_r = _RANDOM_0[9];	// @[Edges.scala:229:27, Reg.scala:19:16]
        count_1 = _RANDOM_0[10];	// @[Edges.scala:229:27, ToAXI4.scala:257:28]
        count_2 = _RANDOM_0[12];	// @[Edges.scala:229:27, ToAXI4.scala:257:28]
        count_3 = _RANDOM_0[14];	// @[Edges.scala:229:27, ToAXI4.scala:257:28]
        count_4 = _RANDOM_0[16];	// @[Edges.scala:229:27, ToAXI4.scala:257:28]
        count_5 = _RANDOM_0[18];	// @[Edges.scala:229:27, ToAXI4.scala:257:28]
        count_6 = _RANDOM_0[20];	// @[Edges.scala:229:27, ToAXI4.scala:257:28]
        count_7 = _RANDOM_0[22];	// @[Edges.scala:229:27, ToAXI4.scala:257:28]
        count_8 = _RANDOM_0[24];	// @[Edges.scala:229:27, ToAXI4.scala:257:28]
        count_9 = _RANDOM_0[26];	// @[Edges.scala:229:27, ToAXI4.scala:257:28]
        count_10 = _RANDOM_0[28];	// @[Edges.scala:229:27, ToAXI4.scala:257:28]
        count_11 = _RANDOM_0[30];	// @[Edges.scala:229:27, ToAXI4.scala:257:28]
