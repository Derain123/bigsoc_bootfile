...
module BranchKillableQueue_5(
  ...
  wire [7:0][6:0]  _GEN_3 = {{uops_0_rob_idx}, {uops_0_rob_idx}, {uops_0_rob_idx}, {uops_4_rob_idx}, {uops_3_rob_idx}, {uops_2_rob_idx}, {uops_1_rob_idx}, {uops_0_rob_idx}};	// @[util.scala:466:20, :508:19]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uops_0_rob_idx = _RANDOM_7[8:2];	// @[util.scala:466:20]
        uops_0_stq_idx = _RANDOM_7[18:14];	// @[util.scala:466:20]
        uops_0_pdst = _RANDOM_7[27:21];	// @[util.scala:466:20]
        ...
        uops_1_rob_idx = {_RANDOM_19[31:28], _RANDOM_20[2:0]};	// @[util.scala:466:20]
        uops_1_stq_idx = _RANDOM_20[12:8];	// @[util.scala:466:20]
        uops_1_pdst = _RANDOM_20[21:15];	// @[util.scala:466:20]
        uops_1_is_amo = _RANDOM_24[7];	// @[util.scala:466:20]
        uops_1_uses_stq = _RANDOM_24[9];	// @[util.scala:466:20]
        uops_1_dst_rtype = _RANDOM_25[8:7];	// @[util.scala:466:20]
        uops_1_fp_val = _RANDOM_25[14];	// @[util.scala:466:20]
        uops_2_uopc = _RANDOM_25[31:25];	// @[util.scala:466:20]
        uops_2_br_mask = {_RANDOM_30[31:21], _RANDOM_31[4:0]};	// @[util.scala:466:20]
        uops_2_rob_idx = _RANDOM_32[28:22];	// @[util.scala:466:20]
        uops_2_stq_idx = _RANDOM_33[6:2];	// @[util.scala:466:20]
        uops_2_pdst = _RANDOM_33[15:9];	// @[util.scala:466:20]
        uops_2_is_amo = _RANDOM_37[1];	// @[util.scala:466:20]
        uops_2_uses_stq = _RANDOM_37[3];	// @[util.scala:466:20]
        uops_2_dst_rtype = _RANDOM_38[2:1];	// @[util.scala:466:20]
        uops_2_fp_val = _RANDOM_38[8];	// @[util.scala:466:20]
        uops_3_uopc = _RANDOM_38[25:19];	// @[util.scala:466:20]
        uops_3_br_mask = _RANDOM_43[30:15];	// @[util.scala:466:20]
        uops_3_rob_idx = _RANDOM_45[22:16];	// @[util.scala:466:20]
        uops_3_stq_idx = {_RANDOM_45[31:28], _RANDOM_46[0]};	// @[util.scala:466:20]
        uops_3_pdst = _RANDOM_46[9:3];	// @[util.scala:466:20]
        uops_3_is_amo = _RANDOM_49[27];	// @[util.scala:466:20]
        uops_3_uses_stq = _RANDOM_49[29];	// @[util.scala:466:20]
        uops_3_dst_rtype = _RANDOM_50[28:27];	// @[util.scala:466:20]
        uops_3_fp_val = _RANDOM_51[2];	// @[util.scala:466:20]
        uops_4_uopc = _RANDOM_51[19:13];	// @[util.scala:466:20]
        uops_4_br_mask = _RANDOM_56[24:9];	// @[util.scala:466:20]
        uops_4_rob_idx = _RANDOM_58[16:10];	// @[util.scala:466:20]
        uops_4_stq_idx = _RANDOM_58[26:22];	// @[util.scala:466:20]
        uops_4_pdst = {_RANDOM_58[31:29], _RANDOM_59[3:0]};	// @[util.scala:466:20]
        uops_4_is_amo = _RANDOM_62[21];	// @[util.scala:466:20]
        uops_4_uses_stq = _RANDOM_62[23];	// @[util.scala:466:20]
        uops_4_dst_rtype = _RANDOM_63[22:21];	// @[util.scala:466:20]
        uops_4_fp_val = _RANDOM_63[28];	// @[util.scala:466:20]
        enq_ptr_value = _RANDOM_64[9:7];	// @[Counter.scala:61:40]
        deq_ptr_value = _RANDOM_64[12:10];	// @[Counter.scala:61:40]
        maybe_full = _RANDOM_64[13];	// @[Counter.scala:61:40, util.scala:470:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_combMem_44 ram_ext (	// @[util.scala:464:20]
