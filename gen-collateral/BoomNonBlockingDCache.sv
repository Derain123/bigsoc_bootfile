...
module BoomNonBlockingDCache(
  ...
  wire [6:0]       _mshrs_io_replay_bits_uop_rob_idx;	// @[dcache.scala:434:21]
  ...
  wire [2:0]       _prober_io_rep_bits_source;	// @[dcache.scala:433:22]
  ...
  reg  [6:0]       s1_req_0_uop_rob_idx;	// @[dcache.scala:601:32]
  ...
  reg  [6:0]       s2_req_0_uop_rob_idx;	// @[dcache.scala:633:25]
  ...
  wire             s2_hit_0 = _T_45 & mshrs_io_req_0_bits_old_meta_meta_coh_state == _GEN_0[_s2_new_hit_state_T] & ~_mshrs_io_block_hit_0 | _T_67 | _T_23;	// @[Cat.scala:33:92, Metadata.scala:46:46, Misc.scala:34:36, :48:20, Mux.scala:27:73, dcache.scala:434:21, :650:{47,114,117,141}, package.scala:16:47]
  ...
  wire             _wb_io_mem_grant_T_1 = auto_out_d_bits_source == 3'h4;	// @[ReadyValidCancel.scala:68:19, dcache.scala:790:30]
  ...
  reg  [7:0]       io_lsu_perf_acquire_counter;	// @[Edges.scala:229:27]
  ...
  wire [7:0]       cache_resp_0_bits_data_zeroed_2 = s2_sc ? 8'h0 : s2_req_0_addr[0] ? cache_resp_0_bits_data_shifted_1[15:8] : cache_resp_0_bits_data_shifted_1[7:0];	// @[AMOALU.scala:40:{24,29,37,55}, :42:23, Arbiter.scala:112:73, Edges.scala:221:14, dcache.scala:633:25, :665:47]
  ...
  always @(posedge clock) begin
    if (_T_7) begin	// @[Decoupled.scala:51:35]
      ...
      if (_GEN_1) begin	// @[dcache.scala:584:21, :585:21, :587:21]
        ...
        s1_req_0_uop_rob_idx <= 7'h0;	// @[dcache.scala:569:27, :601:32]
      ...
      if (wb_fire) begin	// @[dcache.scala:532:38]
        s1_req_0_addr <= {8'h0, _wb_io_meta_read_bits_tag, _wb_io_data_req_bits_addr};	// @[Arbiter.scala:112:73, Edges.scala:221:14, dcache.scala:432:18, :536:22, :601:32]
        s1_type <= 3'h2;	// @[dcache.scala:590:21, :616:32]
      end
      else if (prober_fire) begin	// @[Decoupled.scala:51:35]
        s1_req_0_addr <= {8'h0, _prober_io_meta_read_bits_tag, _prober_io_meta_read_bits_idx, 6'h0};	// @[Arbiter.scala:112:73, Edges.scala:221:14, dcache.scala:433:22, :557:26, :574:{43,74}, :601:32]
        s1_type <= 3'h1;	// @[dcache.scala:591:21, :616:32]
      end
      else if (_s0_type_T_1) begin	// @[Decoupled.scala:51:35]
        s1_req_0_addr <= {8'h0, _mshrs_io_meta_read_bits_tag, _mshrs_io_meta_read_bits_idx, 6'h0};	// @[Arbiter.scala:112:73, Edges.scala:221:14, dcache.scala:434:21, :521:29, :574:{43,74}, :601:32]
    ...
    if (reset) begin
      ...
      debug_sc_fail_cnt <= 8'h0;	// @[Arbiter.scala:112:73, Edges.scala:221:14, dcache.scala:659:35]
      ...
      io_lsu_perf_acquire_counter <= 8'h0;	// @[Arbiter.scala:112:73, Edges.scala:221:14, :229:27]
    end
    else begin
      ...
      if (idle & auto_out_c_ready) begin	// @[Arbiter.scala:89:28, :90:24]
        ...
        beatsLeft <= beatsLeft - {7'h0, auto_out_c_ready & out_2_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, ReadyValidCancel.scala:49:33, dcache.scala:569:27]
      ...
      if (_io_lsu_perf_acquire_T) begin	// @[Decoupled.scala:51:35]
        if (io_lsu_perf_acquire_counter == 8'h0) begin	// @[Arbiter.scala:112:73, Edges.scala:221:14, :229:27, :231:25]
          if (_mshrs_io_mem_acquire_bits_opcode[2])	// @[Edges.scala:92:37, dcache.scala:434:21]
            io_lsu_perf_acquire_counter <= 8'h0;	// @[Arbiter.scala:112:73, Edges.scala:221:14, :229:27]
          else	// @[Edges.scala:92:37]
            io_lsu_perf_acquire_counter <= ~(_io_lsu_perf_acquire_beats1_decode_T_1[11:4]);	// @[Edges.scala:229:27, package.scala:235:{46,71,76}]
        end
        else	// @[Edges.scala:231:25]
          io_lsu_perf_acquire_counter <= io_lsu_perf_acquire_counter - 8'h1;	// @[Edges.scala:229:27, :230:28]
      end
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_0_uop_ftq_idx = _RANDOM_5[20:16];	// @[dcache.scala:601:32]
        s1_req_0_uop_edge_inst = _RANDOM_5[21];	// @[dcache.scala:601:32]
        s1_req_0_uop_pc_lob = _RANDOM_5[27:22];	// @[dcache.scala:601:32]
        s1_req_0_uop_taken = _RANDOM_5[28];	// @[dcache.scala:601:32]
        s1_req_0_uop_imm_packed = {_RANDOM_5[31:29], _RANDOM_6[16:0]};	// @[dcache.scala:601:32]
        s1_req_0_uop_csr_addr = _RANDOM_6[28:17];	// @[dcache.scala:601:32]
        s1_req_0_uop_rob_idx = {_RANDOM_6[31:29], _RANDOM_7[3:0]};	// @[dcache.scala:601:32]
        s1_req_0_uop_ldq_idx = _RANDOM_7[8:4];	// @[dcache.scala:601:32]
        s1_req_0_uop_stq_idx = _RANDOM_7[13:9];	// @[dcache.scala:601:32]
        s1_req_0_uop_rxq_idx = _RANDOM_7[15:14];	// @[dcache.scala:601:32]
        s1_req_0_uop_pdst = _RANDOM_7[22:16];	// @[dcache.scala:601:32]
        s1_req_0_uop_prs1 = _RANDOM_7[29:23];	// @[dcache.scala:601:32]
        s1_req_0_uop_prs2 = {_RANDOM_7[31:30], _RANDOM_8[4:0]};	// @[dcache.scala:601:32]
        s1_req_0_uop_prs3 = _RANDOM_8[11:5];	// @[dcache.scala:601:32]
        s1_req_0_uop_ppred = _RANDOM_8[16:12];	// @[dcache.scala:601:32]
        s1_req_0_uop_prs1_busy = _RANDOM_8[17];	// @[dcache.scala:601:32]
        s1_req_0_uop_prs2_busy = _RANDOM_8[18];	// @[dcache.scala:601:32]
        s1_req_0_uop_prs3_busy = _RANDOM_8[19];	// @[dcache.scala:601:32]
        s1_req_0_uop_ppred_busy = _RANDOM_8[20];	// @[dcache.scala:601:32]
        s1_req_0_uop_stale_pdst = _RANDOM_8[27:21];	// @[dcache.scala:601:32]
        s1_req_0_uop_exception = _RANDOM_8[28];	// @[dcache.scala:601:32]
        s1_req_0_uop_exc_cause = {_RANDOM_8[31:29], _RANDOM_9, _RANDOM_10[28:0]};	// @[dcache.scala:601:32]
        s1_req_0_uop_bypassable = _RANDOM_10[29];	// @[dcache.scala:601:32]
        s1_req_0_uop_mem_cmd = {_RANDOM_10[31:30], _RANDOM_11[2:0]};	// @[dcache.scala:601:32]
        s1_req_0_uop_mem_size = _RANDOM_11[4:3];	// @[dcache.scala:601:32]
        s1_req_0_uop_mem_signed = _RANDOM_11[5];	// @[dcache.scala:601:32]
        s1_req_0_uop_is_fence = _RANDOM_11[6];	// @[dcache.scala:601:32]
        s1_req_0_uop_is_fencei = _RANDOM_11[7];	// @[dcache.scala:601:32]
        s1_req_0_uop_is_amo = _RANDOM_11[8];	// @[dcache.scala:601:32]
        s1_req_0_uop_uses_ldq = _RANDOM_11[9];	// @[dcache.scala:601:32]
        s1_req_0_uop_uses_stq = _RANDOM_11[10];	// @[dcache.scala:601:32]
        s1_req_0_uop_is_sys_pc2epc = _RANDOM_11[11];	// @[dcache.scala:601:32]
        s1_req_0_uop_is_unique = _RANDOM_11[12];	// @[dcache.scala:601:32]
        s1_req_0_uop_flush_on_commit = _RANDOM_11[13];	// @[dcache.scala:601:32]
        s1_req_0_uop_ldst_is_rs1 = _RANDOM_11[14];	// @[dcache.scala:601:32]
        s1_req_0_uop_ldst = _RANDOM_11[20:15];	// @[dcache.scala:601:32]
        s1_req_0_uop_lrs1 = _RANDOM_11[26:21];	// @[dcache.scala:601:32]
        s1_req_0_uop_lrs2 = {_RANDOM_11[31:27], _RANDOM_12[0]};	// @[dcache.scala:601:32]
        s1_req_0_uop_lrs3 = _RANDOM_12[6:1];	// @[dcache.scala:601:32]
        s1_req_0_uop_ldst_val = _RANDOM_12[7];	// @[dcache.scala:601:32]
        s1_req_0_uop_dst_rtype = _RANDOM_12[9:8];	// @[dcache.scala:601:32]
        s1_req_0_uop_lrs1_rtype = _RANDOM_12[11:10];	// @[dcache.scala:601:32]
        s1_req_0_uop_lrs2_rtype = _RANDOM_12[13:12];	// @[dcache.scala:601:32]
        s1_req_0_uop_frs3_en = _RANDOM_12[14];	// @[dcache.scala:601:32]
        s1_req_0_uop_fp_val = _RANDOM_12[15];	// @[dcache.scala:601:32]
        s1_req_0_uop_fp_single = _RANDOM_12[16];	// @[dcache.scala:601:32]
        s1_req_0_uop_xcpt_pf_if = _RANDOM_12[17];	// @[dcache.scala:601:32]
        s1_req_0_uop_xcpt_ae_if = _RANDOM_12[18];	// @[dcache.scala:601:32]
        s1_req_0_uop_xcpt_ma_if = _RANDOM_12[19];	// @[dcache.scala:601:32]
        s1_req_0_uop_bp_debug_if = _RANDOM_12[20];	// @[dcache.scala:601:32]
        s1_req_0_uop_bp_xcpt_if = _RANDOM_12[21];	// @[dcache.scala:601:32]
        s1_req_0_uop_debug_fsrc = _RANDOM_12[23:22];	// @[dcache.scala:601:32]
        s1_req_0_uop_debug_tsrc = _RANDOM_12[25:24];	// @[dcache.scala:601:32]
        s1_req_0_addr = {_RANDOM_12[31:26], _RANDOM_13, _RANDOM_14[1:0]};	// @[dcache.scala:601:32]
        s1_req_0_data = {_RANDOM_14[31:2], _RANDOM_15, _RANDOM_16[1:0]};	// @[dcache.scala:601:32]
        s1_req_0_is_hella = _RANDOM_16[2];	// @[dcache.scala:601:32]
        s1_valid_REG = _RANDOM_16[3];	// @[dcache.scala:601:32, :606:25]
        REG = _RANDOM_16[4];	// @[dcache.scala:601:32, :612:43]
        REG_1 = _RANDOM_16[5];	// @[dcache.scala:601:32, :612:72]
        s1_send_resp_or_nack_0 = _RANDOM_16[6];	// @[dcache.scala:601:32, :615:37]
        s1_type = _RANDOM_16[9:7];	// @[dcache.scala:601:32, :616:32]
        s1_mshr_meta_read_way_en = _RANDOM_16[17:10];	// @[dcache.scala:601:32, :618:41]
        s1_replay_way_en = _RANDOM_16[25:18];	// @[dcache.scala:601:32, :619:41]
        s1_wb_way_en = {_RANDOM_16[31:26], _RANDOM_17[1:0]};	// @[dcache.scala:601:32, :620:41]
        s2_req_0_uop_uopc = _RANDOM_17[8:2];	// @[dcache.scala:620:41, :633:25]
        s2_req_0_uop_inst = {_RANDOM_17[31:9], _RANDOM_18[8:0]};	// @[dcache.scala:620:41, :633:25]
        s2_req_0_uop_debug_inst = {_RANDOM_18[31:9], _RANDOM_19[8:0]};	// @[dcache.scala:633:25]
        s2_req_0_uop_is_rvc = _RANDOM_19[9];	// @[dcache.scala:633:25]
        s2_req_0_uop_debug_pc = {_RANDOM_19[31:10], _RANDOM_20[17:0]};	// @[dcache.scala:633:25]
        s2_req_0_uop_iq_type = _RANDOM_20[20:18];	// @[dcache.scala:633:25]
        s2_req_0_uop_fu_code = _RANDOM_20[30:21];	// @[dcache.scala:633:25]
        s2_req_0_uop_ctrl_br_type = {_RANDOM_20[31], _RANDOM_21[2:0]};	// @[dcache.scala:633:25]
        s2_req_0_uop_ctrl_op1_sel = _RANDOM_21[4:3];	// @[dcache.scala:633:25]
        s2_req_0_uop_ctrl_op2_sel = _RANDOM_21[7:5];	// @[dcache.scala:633:25]
        s2_req_0_uop_ctrl_imm_sel = _RANDOM_21[10:8];	// @[dcache.scala:633:25]
        s2_req_0_uop_ctrl_op_fcn = _RANDOM_21[14:11];	// @[dcache.scala:633:25]
        s2_req_0_uop_ctrl_fcn_dw = _RANDOM_21[15];	// @[dcache.scala:633:25]
        s2_req_0_uop_ctrl_csr_cmd = _RANDOM_21[18:16];	// @[dcache.scala:633:25]
        s2_req_0_uop_ctrl_is_load = _RANDOM_21[19];	// @[dcache.scala:633:25]
        s2_req_0_uop_ctrl_is_sta = _RANDOM_21[20];	// @[dcache.scala:633:25]
        s2_req_0_uop_ctrl_is_std = _RANDOM_21[21];	// @[dcache.scala:633:25]
        s2_req_0_uop_iw_state = _RANDOM_21[23:22];	// @[dcache.scala:633:25]
        s2_req_0_uop_iw_p1_poisoned = _RANDOM_21[24];	// @[dcache.scala:633:25]
        s2_req_0_uop_iw_p2_poisoned = _RANDOM_21[25];	// @[dcache.scala:633:25]
        s2_req_0_uop_is_br = _RANDOM_21[26];	// @[dcache.scala:633:25]
        s2_req_0_uop_is_jalr = _RANDOM_21[27];	// @[dcache.scala:633:25]
        s2_req_0_uop_is_jal = _RANDOM_21[28];	// @[dcache.scala:633:25]
        s2_req_0_uop_is_sfb = _RANDOM_21[29];	// @[dcache.scala:633:25]
        s2_req_0_uop_br_mask = {_RANDOM_21[31:30], _RANDOM_22[13:0]};	// @[dcache.scala:633:25]
        s2_req_0_uop_br_tag = _RANDOM_22[17:14];	// @[dcache.scala:633:25]
        s2_req_0_uop_ftq_idx = _RANDOM_22[22:18];	// @[dcache.scala:633:25]
        s2_req_0_uop_edge_inst = _RANDOM_22[23];	// @[dcache.scala:633:25]
        s2_req_0_uop_pc_lob = _RANDOM_22[29:24];	// @[dcache.scala:633:25]
        s2_req_0_uop_taken = _RANDOM_22[30];	// @[dcache.scala:633:25]
        s2_req_0_uop_imm_packed = {_RANDOM_22[31], _RANDOM_23[18:0]};	// @[dcache.scala:633:25]
        s2_req_0_uop_csr_addr = _RANDOM_23[30:19];	// @[dcache.scala:633:25]
        s2_req_0_uop_rob_idx = {_RANDOM_23[31], _RANDOM_24[5:0]};	// @[dcache.scala:633:25]
        ...
        s2_req_0_uop_pdst = _RANDOM_24[24:18];	// @[dcache.scala:633:25]
        s2_req_0_uop_prs1 = _RANDOM_24[31:25];	// @[dcache.scala:633:25]
        s2_req_0_uop_prs2 = _RANDOM_25[6:0];	// @[dcache.scala:633:25]
        s2_req_0_uop_prs3 = _RANDOM_25[13:7];	// @[dcache.scala:633:25]
        s2_req_0_uop_ppred = _RANDOM_25[18:14];	// @[dcache.scala:633:25]
        s2_req_0_uop_prs1_busy = _RANDOM_25[19];	// @[dcache.scala:633:25]
        s2_req_0_uop_prs2_busy = _RANDOM_25[20];	// @[dcache.scala:633:25]
        s2_req_0_uop_prs3_busy = _RANDOM_25[21];	// @[dcache.scala:633:25]
        s2_req_0_uop_ppred_busy = _RANDOM_25[22];	// @[dcache.scala:633:25]
        s2_req_0_uop_stale_pdst = _RANDOM_25[29:23];	// @[dcache.scala:633:25]
        s2_req_0_uop_exception = _RANDOM_25[30];	// @[dcache.scala:633:25]
        s2_req_0_uop_exc_cause = {_RANDOM_25[31], _RANDOM_26, _RANDOM_27[30:0]};	// @[dcache.scala:633:25]
        s2_req_0_uop_bypassable = _RANDOM_27[31];	// @[dcache.scala:633:25]
        s2_req_0_uop_mem_cmd = _RANDOM_28[4:0];	// @[dcache.scala:633:25]
        s2_req_0_uop_mem_size = _RANDOM_28[6:5];	// @[dcache.scala:633:25]
        s2_req_0_uop_mem_signed = _RANDOM_28[7];	// @[dcache.scala:633:25]
        s2_req_0_uop_is_fence = _RANDOM_28[8];	// @[dcache.scala:633:25]
        s2_req_0_uop_is_fencei = _RANDOM_28[9];	// @[dcache.scala:633:25]
        s2_req_0_uop_is_amo = _RANDOM_28[10];	// @[dcache.scala:633:25]
        s2_req_0_uop_uses_ldq = _RANDOM_28[11];	// @[dcache.scala:633:25]
        s2_req_0_uop_uses_stq = _RANDOM_28[12];	// @[dcache.scala:633:25]
        s2_req_0_uop_is_sys_pc2epc = _RANDOM_28[13];	// @[dcache.scala:633:25]
        s2_req_0_uop_is_unique = _RANDOM_28[14];	// @[dcache.scala:633:25]
        s2_req_0_uop_flush_on_commit = _RANDOM_28[15];	// @[dcache.scala:633:25]
        s2_req_0_uop_ldst_is_rs1 = _RANDOM_28[16];	// @[dcache.scala:633:25]
        s2_req_0_uop_ldst = _RANDOM_28[22:17];	// @[dcache.scala:633:25]
        s2_req_0_uop_lrs1 = _RANDOM_28[28:23];	// @[dcache.scala:633:25]
        s2_req_0_uop_lrs2 = {_RANDOM_28[31:29], _RANDOM_29[2:0]};	// @[dcache.scala:633:25]
        s2_req_0_uop_lrs3 = _RANDOM_29[8:3];	// @[dcache.scala:633:25]
        s2_req_0_uop_ldst_val = _RANDOM_29[9];	// @[dcache.scala:633:25]
        s2_req_0_uop_dst_rtype = _RANDOM_29[11:10];	// @[dcache.scala:633:25]
        s2_req_0_uop_lrs1_rtype = _RANDOM_29[13:12];	// @[dcache.scala:633:25]
        s2_req_0_uop_lrs2_rtype = _RANDOM_29[15:14];	// @[dcache.scala:633:25]
        s2_req_0_uop_frs3_en = _RANDOM_29[16];	// @[dcache.scala:633:25]
        s2_req_0_uop_fp_val = _RANDOM_29[17];	// @[dcache.scala:633:25]
        s2_req_0_uop_fp_single = _RANDOM_29[18];	// @[dcache.scala:633:25]
        s2_req_0_uop_xcpt_pf_if = _RANDOM_29[19];	// @[dcache.scala:633:25]
        s2_req_0_uop_xcpt_ae_if = _RANDOM_29[20];	// @[dcache.scala:633:25]
        s2_req_0_uop_xcpt_ma_if = _RANDOM_29[21];	// @[dcache.scala:633:25]
        s2_req_0_uop_bp_debug_if = _RANDOM_29[22];	// @[dcache.scala:633:25]
        s2_req_0_uop_bp_xcpt_if = _RANDOM_29[23];	// @[dcache.scala:633:25]
        s2_req_0_uop_debug_fsrc = _RANDOM_29[25:24];	// @[dcache.scala:633:25]
        s2_req_0_uop_debug_tsrc = _RANDOM_29[27:26];	// @[dcache.scala:633:25]
        s2_req_0_addr = {_RANDOM_29[31:28], _RANDOM_30, _RANDOM_31[3:0]};	// @[dcache.scala:633:25]
        s2_req_0_data = {_RANDOM_31[31:4], _RANDOM_32, _RANDOM_33[3:0]};	// @[dcache.scala:633:25]
        s2_req_0_is_hella = _RANDOM_33[4];	// @[dcache.scala:633:25]
        s2_type = _RANDOM_33[7:5];	// @[dcache.scala:633:25, :634:25]
        s2_valid_REG = _RANDOM_33[8];	// @[dcache.scala:633:25, :636:26]
        s2_tag_match_way_0 = _RANDOM_33[16:9];	// @[dcache.scala:633:25, :644:33]
        s2_hit_state_REG_state = _RANDOM_33[18:17];	// @[dcache.scala:633:25, :646:93]
        s2_hit_state_REG_1_state = _RANDOM_33[20:19];	// @[dcache.scala:633:25, :646:93]
        s2_hit_state_REG_2_state = _RANDOM_33[22:21];	// @[dcache.scala:633:25, :646:93]
        s2_hit_state_REG_3_state = _RANDOM_33[24:23];	// @[dcache.scala:633:25, :646:93]
        s2_hit_state_REG_4_state = _RANDOM_33[26:25];	// @[dcache.scala:633:25, :646:93]
        s2_hit_state_REG_5_state = _RANDOM_33[28:27];	// @[dcache.scala:633:25, :646:93]
        s2_hit_state_REG_6_state = _RANDOM_33[30:29];	// @[dcache.scala:633:25, :646:93]
        s2_hit_state_REG_7_state = {_RANDOM_33[31], _RANDOM_34[0]};	// @[dcache.scala:633:25, :646:93]
        s2_wb_idx_matches_0 = _RANDOM_34[1];	// @[dcache.scala:646:93, :655:34]
        debug_sc_fail_addr = {_RANDOM_34[31:2], _RANDOM_35[9:0]};	// @[dcache.scala:646:93, :658:35]
        debug_sc_fail_cnt = _RANDOM_35[17:10];	// @[dcache.scala:658:35, :659:35]
        lrsc_count = _RANDOM_35[24:18];	// @[dcache.scala:658:35, :661:27]
        lrsc_addr = {_RANDOM_35[31:25], _RANDOM_36[26:0]};	// @[dcache.scala:658:35, :663:23]
        s2_lr_REG = _RANDOM_36[27];	// @[dcache.scala:663:23, :664:59]
        s2_sc_REG = _RANDOM_36[28];	// @[dcache.scala:663:23, :665:59]
        s2_replaced_way_en_REG = _RANDOM_36[31:29];	// @[dcache.scala:663:23, :719:44]
        s2_repl_meta_REG_coh_state = _RANDOM_37[1:0];	// @[dcache.scala:720:88]
        s2_repl_meta_REG_tag = _RANDOM_37[21:2];	// @[dcache.scala:720:88]
        s2_repl_meta_REG_1_coh_state = _RANDOM_37[23:22];	// @[dcache.scala:720:88]
        s2_repl_meta_REG_1_tag = {_RANDOM_37[31:24], _RANDOM_38[11:0]};	// @[dcache.scala:720:88]
        s2_repl_meta_REG_2_coh_state = _RANDOM_38[13:12];	// @[dcache.scala:720:88]
        s2_repl_meta_REG_2_tag = {_RANDOM_38[31:14], _RANDOM_39[1:0]};	// @[dcache.scala:720:88]
        s2_repl_meta_REG_3_coh_state = _RANDOM_39[3:2];	// @[dcache.scala:720:88]
        s2_repl_meta_REG_3_tag = _RANDOM_39[23:4];	// @[dcache.scala:720:88]
        s2_repl_meta_REG_4_coh_state = _RANDOM_39[25:24];	// @[dcache.scala:720:88]
        s2_repl_meta_REG_4_tag = {_RANDOM_39[31:26], _RANDOM_40[13:0]};	// @[dcache.scala:720:88]
        s2_repl_meta_REG_5_coh_state = _RANDOM_40[15:14];	// @[dcache.scala:720:88]
        s2_repl_meta_REG_5_tag = {_RANDOM_40[31:16], _RANDOM_41[3:0]};	// @[dcache.scala:720:88]
        s2_repl_meta_REG_6_coh_state = _RANDOM_41[5:4];	// @[dcache.scala:720:88]
        s2_repl_meta_REG_6_tag = _RANDOM_41[25:6];	// @[dcache.scala:720:88]
        s2_repl_meta_REG_7_coh_state = _RANDOM_41[27:26];	// @[dcache.scala:720:88]
        s2_repl_meta_REG_7_tag = {_RANDOM_41[31:28], _RANDOM_42[15:0]};	// @[dcache.scala:720:88]
        s2_nack_hit_0 = _RANDOM_42[16];	// @[dcache.scala:720:88, :723:31]
        s2_send_resp_REG = _RANDOM_42[17];	// @[dcache.scala:720:88, :734:44]
        s2_send_nack_REG = _RANDOM_42[18];	// @[dcache.scala:720:88, :736:44]
        mshrs_io_meta_resp_bits_REG_0_coh_state = _RANDOM_42[20:19];	// @[dcache.scala:720:88, :774:70]
        mshrs_io_meta_resp_bits_REG_1_coh_state = _RANDOM_43[10:9];	// @[dcache.scala:774:70]
        mshrs_io_meta_resp_bits_REG_2_coh_state = {_RANDOM_43[31], _RANDOM_44[0]};	// @[dcache.scala:774:70]
        mshrs_io_meta_resp_bits_REG_3_coh_state = _RANDOM_44[22:21];	// @[dcache.scala:774:70]
        mshrs_io_meta_resp_bits_REG_4_coh_state = _RANDOM_45[12:11];	// @[dcache.scala:774:70]
        mshrs_io_meta_resp_bits_REG_5_coh_state = _RANDOM_46[2:1];	// @[dcache.scala:774:70]
        mshrs_io_meta_resp_bits_REG_6_coh_state = _RANDOM_46[24:23];	// @[dcache.scala:774:70]
        mshrs_io_meta_resp_bits_REG_7_coh_state = _RANDOM_47[14:13];	// @[dcache.scala:774:70]
        beatsLeft = _RANDOM_48[10:3];	// @[Arbiter.scala:88:30]
        state_0 = _RANDOM_48[11];	// @[Arbiter.scala:88:30, :117:26]
        state_1 = _RANDOM_48[12];	// @[Arbiter.scala:88:30, :117:26]
        io_lsu_perf_acquire_counter = _RANDOM_48[28:21];	// @[Arbiter.scala:88:30, Edges.scala:229:27]
        s3_req_addr = {_RANDOM_61[31:23], _RANDOM_62[30:0]};	// @[dcache.scala:871:25]
        s3_req_data = {_RANDOM_62[31], _RANDOM_63, _RANDOM_64[30:0]};	// @[dcache.scala:871:25]
        s3_valid = _RANDOM_65[0];	// @[dcache.scala:872:25]
        s4_req_addr = {_RANDOM_77[31:27], _RANDOM_78, _RANDOM_79[2:0]};	// @[dcache.scala:881:25]
        s4_req_data = {_RANDOM_79[31:3], _RANDOM_80, _RANDOM_81[2:0]};	// @[dcache.scala:881:25]
        s4_valid = _RANDOM_81[4];	// @[dcache.scala:881:25, :882:25]
        s5_req_addr = {_RANDOM_93[31], _RANDOM_94, _RANDOM_95[6:0]};	// @[dcache.scala:883:25]
        s5_req_data = {_RANDOM_95[31:7], _RANDOM_96, _RANDOM_97[6:0]};	// @[dcache.scala:883:25]
        s5_valid = _RANDOM_97[8];	// @[dcache.scala:883:25, :884:25]
        s3_way = _RANDOM_97[16:9];	// @[dcache.scala:883:25, :905:25]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_out_c_bits_opcode = (muxStateEarly_0 ? _wb_io_release_bits_opcode : 3'h0) | {muxStateEarly_1, 2'h0};	// @[Arbiter.scala:118:30, Mux.scala:27:73, dcache.scala:432:18, :569:27]
  ...
  assign auto_out_c_bits_size = (muxStateEarly_0 ? 4'h6 : 4'h0) | (muxStateEarly_1 ? _prober_io_rep_bits_size : 4'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73, ReadyValidCancel.scala:68:19, dcache.scala:433:22, :569:27]
  assign auto_out_c_bits_source = {muxStateEarly_0, 2'h0} | (muxStateEarly_1 ? _prober_io_rep_bits_source : 3'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73, dcache.scala:433:22, :569:27]
  ...
  assign auto_out_c_bits_data = muxStateEarly_0 ? _wb_io_release_bits_data : 128'h0;	// @[Arbiter.scala:118:30, Mux.scala:27:73, ReadyValidCancel.scala:68:19, dcache.scala:432:18]
  ...
  assign io_lsu_perf_acquire = (io_lsu_perf_acquire_counter == 8'h1 | (_mshrs_io_mem_acquire_bits_opcode[2] ? 8'h0 : ~(_io_lsu_perf_acquire_beats1_decode_T_1[11:4])) == 8'h0) & _io_lsu_perf_acquire_T;	// @[Arbiter.scala:112:73, Decoupled.scala:51:35, Edges.scala:92:37, :221:14, :229:27, :232:{25,33,43}, :233:22, dcache.scala:434:21, :700:28, package.scala:235:{46,71,76}]
endmodule
